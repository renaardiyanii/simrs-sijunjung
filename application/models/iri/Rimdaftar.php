...
class Rimdaftar extends CI_Model {
	...
	public function get_irna_antrian_all(){
		$data=$this->db->query(
			"SELECT a.noreservasi,a.no_cm,a.no_register_asal,a.tglreserv,b.nama,b.no_hp,c.nmruang,a.kelas,a.infeksi,a.prioritas,a.tglrencanamasuk,a.tppri, d.tgl_keluar, (select cara_bayar from daftar_ulang_irj where daftar_ulang_irj.no_register = a.no_register_asal) as cara_bayar
					FROM
					    irna_antrian AS a
					        INNER JOIN
