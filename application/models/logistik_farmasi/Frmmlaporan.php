...
/////////////////////////////////////////////////
    ...
    public function get_penerimaan_obat_by_faktur($supplier="semua", $jenis="semua", $jenis_obat ="semua",$tgl_awal=null, $tgl_akhir=null)
	{
		if ($supplier != "semua") {
    ...
    public function get_penerimaan_obat($supplier="semua", $jenis="semua", $jenis_obat="semua", $tgl_awal=null, $tgl_akhir=null)
	{
		if ($supplier != "semua") {
			$this->db->where('id_pemasok', $supplier);
		}
		...
		return $this->db->get_where('v_penerimaan_obat_supplier',['tanggal_terima >=' => $tgl_awal, 'tanggal_terima <=' => $tgl_akhir]);
		//return $this->db->select('*, count(no_faktur) as "row"')->from('v_penerimaan_obat_supplier')->where(['tanggal_terima >=' => $tgl_awal, 'tanggal_terima <=' => $tgl_akhir])->group_by('no_faktur')->get();
	}
