...
function set_total(val){
   ...
   var dibayar_tunai = total - diskon + denda ; 
                     ...
                     <form target="_blank" action="<?php echo site_url('iri/ricstatus/kalkulasi_harga'); ?>" method="post">
                        <table class="table-sm table-striped" style="font-size:15">
                           ...
                           <!--      <tr>
                                 <th>Dibayar Tunai</th>
                                 <td>:&nbsp;</td>
                                 <td><input type="number" name="dibayar_tunai" id="dibayar_tunai"  value="<?= $grand_total ?>" class="form-control" onchange="set_total(this.value)" value="0"></td>
                              </tr> --> 

                              <tr>
                                 <th>Potongan</th>
                                 <td>:&nbsp;</td>
                                 <td><input type="number" name="diskon" id="diskon" class="form-control"  value="0"></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <th>Dibayar Tunai</th>
                                 <td>:&nbsp;</td>
                                 <td><input type="number" name="dibayar_tunai" id="dibayar_tunai" value="<?= $grand_total ?>" class="form-control" value="0"></td>
                              </tr> 
                              <!-- <tr>
