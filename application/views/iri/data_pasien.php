						...
						<div class="form-group row">
							...
							<div class="col-sm-12">
								...
								<?php 
									if($row->status_ok>='1'){
										if($row->ok=='0'){
										echo '<input type="checkbox" id="okCheckbox"  class="flat-red" name="okCheckbox"  value="1"><label for="labCheckbox"> Operasi | '.$row->status_ok.' Done</label>';
										} else {
								...
								<?php 
									if($row->status_obat>='1'){
										...
										echo '<input type="checkbox" id="obatCheckbox"  class="flat-red" name="obatCheckbox"  value="1"><label for="obatCheckbox"> Obat | '.$row->status_obat.' Done</label>';
											...
											echo ' | <a href="'.base_url('farmasi/frmcdaftar/permintaan_obat').'/'.$data_pasien[0]['no_ipd'].'" target="_blank"> Progress</a></label>';
										}
									}
									else { 
										if($row->obat=='0'){
