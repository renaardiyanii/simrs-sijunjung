						  ...
						  <thead>
							<tr>
						  	...
						  	foreach ($list_keluar_ird as $r) { 
						  		$total = $total + $r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_ok'] ;
						  		$total_bayar_tunai = $total_bayar_tunai + $r['tunai'];
						  	...
						  	<tr>
						  		...
						  		$total_diskon = $total_diskon + $diskon;
						  		?>
						  		<td align="right">Rp. <?php echo number_format($r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] +  $r['vtot_ok'],0);?></td>
						  		<td align="right">Rp. <?php echo number_format($diskon,0);?></td>
						  		<td align="right">Rp. <?php echo number_format($r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_ok'] - $diskon,0);?></td>
						  		<td align="right">Rp. <?php echo number_format($r['tunai'],0);?></td>
						  	...
						  	foreach ($list_keluar_irj as $r) { 
						  		$total = $total + $r['vtot'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_fisio'] + $r['vtot_pa'] + $r['vtot_ok'];
						  	...
						  	<tr>
						  		...
						  		$total_diskon = $total_diskon + $diskon;
						  		?>
						  		<td align="right"><?php echo number_format($r['vtot']+$r['vtot_pa'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_fisio']+ $r['vtot_ok'],0);?></td>
						  		<td align="right"><?php echo number_format($diskon,0);?></td>
						  		<td align="right"><?php echo number_format($r['vtot']+$r['vtot_pa'] + $r['vtot_rad'] + $r['vtot_lab'] + $r['vtot_obat'] + $r['vtot_fisio'] + $r['vtot_ok']  - $diskon,0);?></td>
						  		<td align="right"><?php echo number_format($r['tunai'],0);
						  		// + $r['vtot_lab_lunas']+$r['vtot_pa_lunas']+$r['vtot_obat_lunas']+$r['vtot_fisio_lunas'],0); ?></td>
