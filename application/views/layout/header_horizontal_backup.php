...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?php echo site_url('assets/horizontal/css/colors/green-dark.css'); ?>" id="theme" rel="stylesheet">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo site_url('user/logout'); ?>"><i class="fa fa-power-off"></i> Logouts</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
