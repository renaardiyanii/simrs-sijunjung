                                ...
                                <a class="nav-link dropdown-toggle text-muted text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-bell"></i>
                                    <div class="notify">
                                        ...
                                        ?>
                                            ...
                                            <span style="position: absolute; top: -14px; font-size: 9px; right: 0.5px;" id="tnotif-nav" class="badge badge-pill badge-danger"><?php echo generate_tot_notif() ?></span>
                                        <?php } ?>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right mailbox scale-up" style="background-color: #8fc0d3;">
                                    <ul>
                                        <li>
                                            <div class="drop-title text-white"><span class="fa fa-bell-o"></span> Notifications</div>
                                        </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right scale-up">
                                    <ul class="dropdown-user">
                                        ...
                                        <li><a href="<?php echo site_url('user/profile'); ?>"><i class="ti-user"></i> Profile</a></li>
