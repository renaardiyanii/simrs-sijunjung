...
<html lang="en">
  ...
  <head>
    ...
    <!-- Favicon icon -->
    <!-- <link rel="icon" type="image/png" sizes="16x16" href="<?php echo site_url('assets/images/sriwijaya.ico'); ?>"> -->
    ...
    <!-- <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" /> -->
    <!-- MDB -->
    <link rel="stylesheet" href="<?php echo site_url('/assets/mdb2/css/mdb.min.css'); ?>" />    
