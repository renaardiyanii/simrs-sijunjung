              ...
              <div class="table-responsive">
                <table class="display nowrap table table-hover table-bordered dataTable" id="example" style="font-size: 14px; border: 2px solid black;" >
                    <thead style="border: 2px solid black; font-weight: bold;">
                            ...
                            <td style="border: 2px solid black; vertical-align: middle;"><center>NO</center></td>
                            <td style="border: 2px solid black; vertical-align: middle;"><center>POLIKLINIK</center></td>
                            <td style="border: 2px solid black; vertical-align: middle;"><center>BPJS</td</center></td>
                            <td style="border: 2px solid black; vertical-align: middle;"><center>KERJA SAMA</center></td>
                            <td style="border: 2px solid black; vertical-align: middle;"><center>UMUM</center></td>
                            <td style="border: 2px solid black; vertical-align: middle;"><center>TOTAL</center></td>
                        </tr>
