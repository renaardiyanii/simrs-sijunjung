...
class Ricstatus extends Secure_area {
	...
	public function kalkulasi_harga()
	{
		...
		$login_data = $this->load->get_var("user_info");
		if($pasien[0]['carabayar']=='BPJS'){
			$cek_no_kwitansi = $this->rimpasien->get_no_kwitansi_bpjs();

			$kwitansi['no_registrasi']=$no_ipd;
			if ($cek_no_kwitansi) {
				$no_kwitansi=substr($cek_no_kwitansi->row()->no_kwitansi, 5)  + 1;
				$kwitansi['no_kwitansi']='BP-'.date('y').sprintf("%06d", $no_kwitansi);
			}else{
				$kwitansi['no_kwitansi']='BP-'.date('y').'000001';
			}
			$kwitansi['jenis_kwitansi']='BPJS RI';
			...
			if ($cek_no_kwitansi) {
				$no_kwitansi=substr($cek_no_kwitansi->row()->no_kwitansi, 5)  + 1;
				$kwitansi['no_kwitansi']='RI-'.date('y').sprintf("%05d", $no_kwitansi);
			}else{
		...
		$data_pasien_iri['lunas'] = 1;
		if($pasien[0]['carabayar'] == "KERJASAMA"){
			$data_pasien_iri['lunas'] = 0;
		}
	...
	//	print_r($pasien);die();
		...
		// $konten = $this->string_data_pasien($pasien,'','','');
	...
	//	if($pasien[0]['carabayar']=='BPJS'){
		...
		$grand_total_string = "	
            ...
            <tr>
				<th colspan=\"".$span."\"><p><b>Biaya Adminstrasi</b></p></th>
				<th align=\"right\" colspan=\"".$span1."\"><p>".number_format($fixs_adm,0)."</p></th>
			</tr>
			<tr>
				<th colspan=\"".$span."\"><p><b>Potongan</b></p></th>
		...
		<table>
			<tr>
				<td></td>
				<td></td>
				<td align=\"center\">Palembang, $tgl</td>
			</tr>
			<tr>
	...
	private function string_data_pasien_sementara($pasien,$grand_total,$penerima,$jenis_pembayaran){
		...
		$konten = $konten."<style type=\"text/css\">
					...
					<table style=\"padding-top:2px;\">
						...
						<tr>
							<td colspan=\"3\" ><font size=\"11\" align=\"center\"><u><b>KWITANSI SEMENTARA RAWAT INAP NO ".$pasien[0]['no_ipd']."</b></u></font></td>
						</tr>			
							<tr>
								<td></td>
								<td></td>
	...
	private function string_data_pasien_faktur($pasien,$grand_total,$penerima,$jenis_pembayaran,$no_kwitansi=''){
		...
		$konten = $konten."<style type=\"text/css\">
					...
					<table style=\"padding-top:2px;\">
						...
						<tr>
							<td colspan=\"3\" ><font size=\"12\" align=\"center\"><u><b>Kwitansi RAWAT INAP NO ".$pasien[0]['no_ipd']."</b></u></font></td>
						</tr>			
							<tr>
								<td></td>
								<td></td>
