					...
					<div class="inline">
						<div class="row">
							<div class="form-inline">
								<form action="<?php echo base_url();?>piutang/cperusahaan/cetak_kwitansi_irj" method="post" accept-charset="utf-8">
								<div class="col-lg-12">
					...
					<table id="tabel_kwitansi" class="display table table-hover table-bordered table-striped" cellspacing="0" width="100%">
						...
						?>
							<tr>
							  ...
							  <td>
									<a href="<?php echo site_url('piutang/cperusahaan/get_list_pasien_ct_kw/'.$row->id_kontraktor.'/'.$date1.'/'.$date2); ?>" class="btn btn-default btn-sm" target = "_blank"><i class="fa fa-book"></i>Detail</a>
							  </td>
							</tr>
						<?php
							}
