	...
	<div class="row">				
		<div class="card" style="width:97%;margin:0 auto">
			...
			<div class="container-fluid">
					<div class="inline">
						<div class="row">
							<div class="form-inline">
								<form action="<?php echo base_url();?>piutang/cperusahaan" method="post" accept-charset="utf-8">
								<div class="col-lg-12">
				...
				<?php 
				if($date1 != '' && $date2 != ''){ ?>
				<center><h3 class="card-title">Daftar Tagihan Ikatan Kerjasama Tanggal <?= $date1?> s/d <?= $date2 ?></h3></center>
				<?php }
				?>
					...
					<table id="tabel_kwitansi" class="display table table-hover table-bordered table-striped" cellspacing="0" width="100%">
						...
						?>
							<tr>
							  ...
							  <td>
									<a href="<?php echo site_url('piutang/cperusahaan/get_list_pasien/'.$row->id_kontraktor.'/'.$date1.'/'.$date2); ?>" class="btn btn-default btn-sm" target = "_blank"><i class="fa fa-book"></i>Detail</a>
							  </td>
							</tr>
						<?php
							}
