					...
					<table id="tabel_kwitansi" class="display table table-hover table-bordered table-striped" cellspacing="0" width="100%">
						...
						?>
							<tr>
							  ...
							  <td>
									<a href="<?php echo site_url('piutang/cperusahaan/cetak_kw_irj/'.$row->no_register.'/'.$id_kontraktor); ?>" class="btn btn-default btn-sm" target="_blank"><i class="fa fa-book"></i>Cetak</a>
							  </td>
							</tr>
						<?php
