...
function populateDataObat(){
	...
	jQuery.each( vjson, function( i, val ) {
		vjson2[i] = {"id_obat": vjson[i][0], "satuank":vjson[i][2], "qty_req":vjson[i][3],"nm_obat":vjson[i][1]} ;  
	});
        ...
        <div class="card-block">
			...
			<div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
					<input type="datetime-local" value="<?= date('Y-m-d H:i') ?>" class="form-control" name="tgl_amprah" id="tgl_amprah" required>
                     
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-1"></div>
                  	<p class="col-sm-3 form-control-label" id="lidgudang">Gudang yang Meminta Amprah</p>
                   	<div class="col-sm-6">
	                    ...
	                    <?php
	                      foreach($select_gudang0 as $row){
						    ...
						    // echo '<option value="'.$select_gudang0->id_gudang.'">'.$select_gudang0->nama_gudang.'</option>';
	                    ?>
	                    </select>  
                 	</div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-1"></div>
                    <p class="col-sm-3 form-control-label">Gudang yang Mendistribusi</p>
                    <div class="col-sm-6">
