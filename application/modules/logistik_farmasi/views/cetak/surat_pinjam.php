...
?>
   ...
   <body class="A4" >
       ...
       <table width="100%">
            <tr>
                <td align="center"><b>SURAT PEMINJAMAN OBAT</b></td>
            </tr>
        </table>
        <p>
            Yang bertanda tangan dibawah ini Kepala Instalasi Farmasi RS. OTAK DR.Drs.M.Hatta Bukittinggi
            dengan ini mengajukan permohonan peminjaman obat kepada instalasi Farmasi <?php echo isset($identitas_pinjam->tujuan)?$identitas_pinjam->tujuan:'' ?> Berupa :
        </p>
       
            <table width="100%" class="me">
            <tr>
                <td   align="center" class="me"><b>NO</b></td>
                <td  align="center" class="me"><b>Nama Obat</b></td>
                <td   align="center" class="me"><b>Jumlah</b></td>
            </tr>

            <!-- foreach disini -->
            <?php 
            foreach($data_detail_pinjam as $value){
            ?>
            <tr>
                <td align="center" class="me"><?= $no++; ?></td>
                <td  class="me"><?= $value->nm_obat; ?></td>
                <td align="center" class="me"><?= $value->jml ?></td>
            </tr>
          ...
          <table border="0" width="100%">
                    <tr>
                      ...
                      <td width="40%"></td>
                      <td width="30%" align="center">Bukittinggi, <?php echo isset($identitas_pinjam->tgl_pinjam)?date('d-m-Y',strtotime($identitas_pinjam->tgl_pinjam)):'' ?></td>
                    </tr>

                    <tr>
                      <td width="30%" align="center">Yang Menyerahkan</td>
                      <td width="40%"></td>
