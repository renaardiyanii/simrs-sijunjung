...
$(function() {
	...
	table = $('#example').DataTable({
		ajax: "<?php echo site_url(); ?>logistik_farmasi/Frmcamprah/get_amprah_list_dsitribusi",
		columns: [
			{ data: "id_amprah" },
			{ data: "tgl_amprah" },
			{ data: "gd_dituju" },
	...
	$('#btnCari').click(function(){
		$.ajax({
			url: '<?php echo site_url(); ?>logistik_farmasi/Frmcamprah/get_amprah_list_dsitribusi',
			type: 'POST',
