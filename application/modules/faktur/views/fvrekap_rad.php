...
//---------------------------------------------------------
	...
	function cek(no_kwitansi,no_rad){
		$('#myModal').modal("show");
		...
		<div class="col-sm-12">
			<div class="card card-outline-success">
				<div class="card-header">
					<h3 class="text-white" align="center">Rekap Faktur Kwitansi Radiologi</h3>
				</div>
							...
							<tr>
							  <!-- <td><?php echo $i++;?></td> -->
							   ...
							   <td>
								...
								<?php //if($roleid==35 or $roleid==1){ ?>
							     <button class="btn btn-primary btn-xs" onclick="cek('<?php echo $row->no_kwitansi ?>','<?php echo $row->no_rad;?>')">Batal Kwitansi</button>
							     <?php
							    // }
							     ?>		
									...
									<a href="<?php echo site_url('rad/radckwitansi/cetak_kwitansi_kt/'.$row->no_rad); ?>" target="_blank"class="btn btn-info btn-xs" style="width:63px; margin:2px;">Cetak ulang</a>
							  </td>
							</tr>
						<?php
							}
        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('faktur/fcrekap/cencel_rad/') ?>" method="post" id="keterangan">
	                    <div class="modal-body">
	                    	<div class="form-group">
	                        	<label>No Kwitansi</label>
	                        	<input type="text" name="no_kwitansi" readonly="" class="form-control" id="no_kwitansi">
								<input type="hidden" name="no_rad" readonly="" class="form-control" id="no_rad">
	                        </div>
	                      <!--   <div class="form-group">
	                        	<label>No lab</label>
