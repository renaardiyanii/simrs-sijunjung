...
//---------------------------------------------------------
	...
	function cek(no_kwitansi,no_lab){
		$('#myModal').modal("show");
		$('#no_kwitansi').val(no_kwitansi);
		$('#no_lab').val(no_lab);
	}

	function cek_double(no_kwitansi,no_lab){
						...
						?>
							<tr>
							  <!-- <td><?php echo $i++;?></td> -->
							   ...
							   <td>
                                  <!--   <?php if($roleid==35 or $roleid == 1 or $roleid == 1013){ ?>
								...
								<?php if($roleid==35 or $roleid==1 or $roleid == 1013){ ?>
							     <button class="btn btn-primary btn-xs" onclick="cek('<?php echo $row->no_kwitansi ?>','<?php echo $row->no_lab ?>')">Batal Kwitansi</button>
							     <?php
							     }
							     ?>		
                                <?php //if($roleid==35 or $roleid==1 or $roleid == 1013){ ?>
							     ...
							     ?>		
									...
									<a href="<?php echo site_url('lab/labckwitansi/cetak_kwitansi_kt/'.$row->no_lab); ?>" target="_blank"class="btn bg-orange btn-sm" style="width:63px; margin:2px;">Faktur</a>
							  </td>
							</tr>
						<?php
							}
        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('faktur/fcrekap/cencel_lab/') ?>" method="post" id="keterangan">
	                    <div class="modal-body">
	                    	<div class="form-group">
	                        	<label>No Kwitansi</label>
	                        	<input type="text" name="no_kwitansi" readonly="" class="form-control" id="no_kwitansi">
								<input type="hidden" name="no_lab" readonly="" class="form-control" id="no_lab">
	                        </div>
	                      <!--   <div class="form-group">
	                        	<label>No lab</label>
           ...
           <div id="myModaldouble" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Silahkan Isi Keterangan</h4>
                    ...
                    <form action="<?= base_url('faktur/fcrekap/cencel_lab_double/') ?>" method="post" id="keterangan">
	                    <div class="modal-body">
	                    	<div class="form-group">
	                        	<label>No Kwitansi</label>
