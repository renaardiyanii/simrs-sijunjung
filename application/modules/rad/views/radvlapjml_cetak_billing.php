	...
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			<div class="card-block">
                <?php echo form_open('rad/radclaporan/lap_berdasarkan_cetak_billing');?>
                    <div class="row p-t-0">		
                        <div class="col-md-2">
        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan Jumlah Pasien Berdasarkan Cetak Billing <?php echo $tipe;?><b> <?php echo $judul;?></b></h4></div>					
                                ...
                                <tbody id="tbodyexample">
                                    ...
                                    foreach($pasien as $row) { ?>
                                       <tr>
                                            ...
                                            <td><?php echo date("d-m-Y", strtotime($row->tgl_cetak_billing));?></td>
                                       </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                    ...
                    <a href="<?php echo base_url('rad/radclaporan/excel_lap_berdasarkan_cetak_billing/'.$tipe.'/'.$date); ?>" class="btn btn-danger" target="_blank">Excel</a>				
				</div>
			</div>
		</div>	 	
	</div>	 	
