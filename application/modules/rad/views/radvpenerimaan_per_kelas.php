        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan Penerimaan Setiap Kelas</h4></div>					
                            ...
                            <table id="example" style="width:100%;" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="6">VIP</th>
                                            <th colspan="6">HCU</th>
                                            <th colspan="6">Kelas I</th>
                                            <th colspan="6">Kelas II</th>
                                            <th colspan="6">Kelas III</th>
                                            <th colspan="6">ICU</th>
                                        </tr>
                                        <tr>
...
function down_excel(){
    ...
    window.open('<?php echo site_url('rad/Radclaporan/excel_lap_penerimaan_per_kelas');?>/'+date+'/'+tampil, '_blank');

}

function get_bln(){
    $('#example').DataTable();
    // var date = document.getElementById('date_picker_months')[0];
    // var date = document.getElementById('modality')[0];
    var modal = $('#modality').val();
    var date = $('#date_picker_months').val();
    var url = "<?php echo site_url();?>rad/radclaporan/lap_penerimaan_per_kelas_mod/"+date+"/"+modal;
            ...
            if(data.data.length>0){
                data.data.map((e)=>{
                    ...
                    <tr>
                        ...
                        <td>${e.sat_umum_vip}</td>
                        <td>${e.total_umum_vip}</td>
                        <td>${e.jml_bpjs_vip}</td>
                        <td>${e.sat_bpjs_vip}</td>
                        <td>${e.total_bpjs_vip}</td>
                        <td>${e.jml_umum_hcu}</td>
                        <td>${e.sat_umum_hcu}</td>
                        <td>${e.total_umum_hcu}</td>
                        <td>${e.jml_bpjs_hcu}</td>
                        <td>${e.sat_bpjs_hcu}</td>
                        <td>${e.total_bpjs_hcu}</td>
                        <td>${e.jml_umum_1}</td>
                        <td>${e.sat_umum_1}</td>
                        <td>${e.total_umum_1}</td>
                        <td>${e.jml_bpjs_1}</td>
                        <td>${e.sat_bpjs_1}</td>
                        <td>${e.total_bpjs_1}</td>
                        <td>${e.jml_umum_2}</td>
                        <td>${e.sat_umum_2}</td>
                        <td>${e.total_umum_2}</td>
                        <td>${e.jml_bpjs_2}</td>
                        <td>${e.sat_bpjs_2}</td>
                        <td>${e.total_bpjs_2}</td>
                        <td>${e.jml_umum_3}</td>
                        <td>${e.sat_umum_3}</td>
                        <td>${e.total_umum_3}</td>
                        <td>${e.jml_bpjs_3}</td>
                        <td>${e.sat_bpjs_3}</td>
                        <td>${e.total_bpjs_3}</td>
                        <td>${e.jml_umum_icu}</td>
                        <td>${e.sat_umum_icu}</td>
                        <td>${e.total_umum_icu}</td>
                        <td>${e.jml_bpjs_icu}</td>
                        <td>${e.sat_bpjs_icu}</td>
                        <td>${e.total_bpjs_icu}</td>
                    </tr>
                    `;
                });
