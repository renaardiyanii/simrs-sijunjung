...
<script src="<?php echo site_url(); ?>assets/plugins/Chart.js/Chart.js"></script>
          ...
          <div class="col-sm-12">
            <div class="form-inline">
              <div class="form-group">
                <input type="number" min="<?php echo date('Y')-100 ?>" id="date_picker_years1" class="form-control" placeholder="Tahun" name="date_picker_years1">
                <input type="number" min="<?php echo date('Y')-100 ?>" id="date_picker_years2" class="form-control" placeholder="Tahun" name="date_picker_years2">
...
<script type='text/javascript'>
  ...
  function pilih_poli() {
    ...
    var tgl_akhir=document.getElementById("date_picker_years2").value;
    var tgl_awal=document.getElementById("date_picker_years1").value;
    ...
    if(tgl_awal!="" && tgl_akhir!=""){
      ...
      $.ajax({
        type:'POST',
        dataType: 'json',
        url:"<?php echo base_url('rad/radclaporan/get_data_pertumbuhan_expert')?>",
        data: {
          tgl_akhir : tgl_akhir,
          tgl_awal : tgl_awal
          //id_poli : id_poli
