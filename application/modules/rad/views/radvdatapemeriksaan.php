...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <img class="navbar-brand" src="<?php echo base_url('assets/images/rssn-header5.png'); ?>" width="400" alt="">
...
<div class="card m-5">
  ...
  <div class="card-body">
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= date('d-m-Y',strtotime($data_pasien->tgl_lahir)) ?>" readonly>
        </div>
    </div>

    <div class="row mb-3">
        <label for="alamat" class="col col-form-label">Kelas :</label>
        <div class="col">
            <input type="text" readonly class="form-control" id="alamat" value="<?= $data_pasien->kelas ?>">
        </div>
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?= date('d-m-Y',strtotime($data_pasien->jadwal_rad)) ?>">
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="alamat" value="<?= $data_pasien->dokter ?>">
        </div>
        <label for="alamat" class="col col-form-label">Jenis Pemeriksaan :</label>
        <div class="col">
            <input type="text" readonly class="form-control" id="alamat" value="<?= $data_pasien->jenis_tindakan ?>">
        </div>

        <label for="nama" class="col col-form-label">Modality</label>
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?= $data_pasien->modality ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">Accession Number : </label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= $data_pasien->accesion_number ?>" readonly>
        </div>
    </div>
