    ...
    <body class="A4">
        <div class="A4 sheet  padding-fix-10mm">
            ...
            <p style = "font-weight:bold; font-size: 14px; text-align: center;">
                FAKTUR RADIOLOGI No. RAD_<?= $no_rad ?>
            </p>
					<table border="0" width="100%">
						...
						<td><b>Asal Pasien</b></td>
							<td> : </td>
							<td colspan ="4"><?= isset($data_pasien->ruang)?$data_pasien->ruang:'' ?></td>
						</tr>
						<tr>
							<td><b>Terbilang</b></td>
							<td> : </td>
					...
					foreach($data_pemeriksaan as $row){
						...
						<tr>
						  	...
						  	<td><p><?= number_format( $row->biaya_rad, 2 , ',' , '.' )?></p></td>
						  	<td><p><?= $row->qty ?></p></td>
						  	<td><p><?= $vtot ?></P></td>
						</tr>
                        <?php } ?>
