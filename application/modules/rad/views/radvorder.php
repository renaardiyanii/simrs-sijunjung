...
$(document).ready(function(){
	...
	function tindak2(waktu_masuk,no_register){
		if(waktu_masuk==''){
			swal({
	         title: "Tindak Pasien",
	...
	//$.ajax({
    	...
    	return openUrl('<?php echo site_url('rad/radcdaftar/list_tindakan_order'); ?>/' + no_register);
	// 	},
		...
		<div class="card card-outline-info">
			<div class="card-block">
				<div class="row p-t-0">
					...
					<div class="col-md-4">
					<?php echo form_open('rad/radcdaftar/order_by_date');?>
					...
					<div class="col-md-4">
					<?php echo form_open('rad/radcdaftar/order_by_no');?>
        ...
        <div class="card">
            <div class="card-block">
				<!-- <ul class="nav nav-tabs customtab" role="tablist">
					<li class="nav-item text-center"><a class="nav-link active" href="#rj_tab" data-toggle="tab" role="tab"><span class="hidden-xs-down">Rawat Jalan/IGD/Ranap</span></a></li>
					<li class="nav-item text-center"><a class="nav-link" href="#pl_tab" data-toggle="tab" role="tab"><span class="hidden-xs-down">Pasien Luar</span></a></li>						
				</ul> -->
				<!-- <div class="tab-content"><br> -->
						...
						<div class="table-responsive m-t-40">
							<table id="example" class="table display table-bordered table-striped">
								...
								<tbody>
									...
									?>
										<tr>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>">
												<button onclick="tindak('<?php echo $row->no_register; ?>')" class="btn btn-primary">Tindak <i class="ti-pencil"></i></button>
												<a href="<?php echo base_url().'rad/radcdaftar/batal_kunjung/'.$row->no_register; ?>" class="btn text-white btn-xs"  style="background-color: red;">Batal Kunjungan <i class="ti-trash"></i></a>
												<?php if(substr($row->no_register,0,2) == 'PL') { ?>
											...
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo date('d-m-Y | H:i:s',strtotime($row->jadwal_rad));?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->no_medrec;?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->no_register;?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->nama;?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->kelas;?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->idrg;?></td>
											<td class="<?= $row->cetak_rad == 0 ? 'bebas' : 1; ?>"><?php echo $row->bed;?></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>	
					...
					<!-- </div> -->
					<!-- <div class="tab-pane" id="pl_tab" role="tabpanel">
						<div class="table-responsive m-t-40">
							<table id="example_pl" class="table display table-bordered table-striped">
								<thead>
									<tr>
										<th>Aksi</th>
										<th>Tanggal Kunjungan</th>
