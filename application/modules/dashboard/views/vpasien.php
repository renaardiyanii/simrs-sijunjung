        ...
        complete: function(data,status) {
          ...
          if(status=='success'){
            ...
            for(i=0;i<3;i++){
              carabayar = data.responseJSON[i].cara_bayar.toUpperCase();;
              if(carabayar=="UMUM"){
              document.getElementById("umum").innerHTML = addCommas(data.responseJSON[i].jumlah);
              document.getElementById("pendumum").innerHTML = "Rp " + addCommas(data.responseJSON[i].total);
              } else if(carabayar=="BPJS"){
              document.getElementById("bpjs").innerHTML = addCommas(data.responseJSON[i].jumlah);
              document.getElementById("pendbpjs").innerHTML = "Rp " + addCommas(data.responseJSON[i].total);
              //$("#pendbpjs").number(data.responseJSON[i].total,2);
              } else if(carabayar=="DIJAMIN"){
              document.getElementById("perusahaan").innerHTML = addCommas(data.responseJSON[i].jumlah);
              document.getElementById("pendperusahaan").innerHTML = "Rp " + addCommas(data.responseJSON[i].total);
              }
            }
