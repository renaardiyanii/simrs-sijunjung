    ...
    <div class="col-lg-12 col-md-12">
        <div class="card card-outline-info">
            <div class="card-block">
                <div class="row p-t-0">
                    <div class="col-md-6">
					<?php echo form_open('utdrs/utdcdaftar');?>
						...
						<tbody>
							...
							<tr>
							  	<td>
									...
									<a href="<?php echo site_url('utdrs/utdcdaftar/pemeriksaan_utdrs/'.$no_register); ?>" class="btn btn-primary">Tindak <i class="ti-pencil"></i></a>
							  	</td>
