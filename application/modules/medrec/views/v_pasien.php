	                	...
	                	<div id="accordion" class="nav-accordion" role="tablist" aria-multiselectable="true">   
	                                	...
	                                	<div class="row">
											...
											<div class="col-sm-6">
													...
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<input disabled type="text" class="form-control" value="<?php echo $data_pasien->nama_ibu;?>" name="nm_ibu_istri">
														</div>
													</div>
											</div><!-- end div col-sm-6-->
										</div><!-- row -->
													...
													<?php
														foreach ($kunj_inap as $row) {
															echo "<tr>
																	...
																	<td><a href='" . site_url('iri/ricstatus/index/' . $row->no_ipd) . "' class='btn btn-primary btn-sm' style='width:85px;' target='_blank'>View Details</a></td>
													...
													<?php
														...
														foreach ($data_lab as $row) {
															...
															echo "<tr>
																	...
																	<td>".$row->qty."</td>
																	<td><a href='" . site_url('lab/labcpengisianhasil/cetak_hasil_lab/' . $row->no_lab) . "' class='btn btn-primary btn-sm' style='width:85px;' target='_blank'>Hasil</a></td>
																</tr>";
														}
													?>
												</tbody>
	                    	...
	                    	<div class="card card-outline-info">
	                        	<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_diagnosis" aria-expanded="false" aria-controls="collapse_diagnosis">
		                            <div class="card-header" role="tab">
		                                <h5 class="mb-0 text-white">Data Radiologi<span class="label label-warning p-t-5 pull-right"><?php echo $count_data_rad.' Kunjungan ';?></span></h5> 
													...
													<?php
														...
														foreach ($data_rad as $row) {
															...
															echo "<tr>
																	...
																	<td>".$row->jenis_tindakan."</td>
																	<td>".$row->qty."</td>
																	<td><a href='" . site_url('rad/Radcpengisianhasil/cetak_hasil_rad_tindakan/' . $row->id_pemeriksaan_rad.'/'.$row->no_rad) . "' class='btn btn-primary btn-sm' style='width:85px;' target='_blank'>Hasil</a></td>
																</tr>";
														}
													?>
												</tbody>
