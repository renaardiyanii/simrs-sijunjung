		...
		<div class="inner">
			<div class="container-fluid text-center"><br/>
				<div class="form-inline">
					...
					<input type="date" style="width:450; display:none" class="form-control" id="cari_tgl" name="cari_tgl" placeholder="Pencarian Tgl Lahir">
							...
							<tbody>
								...
								if ($data_pasien!="") {
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('medrec/el_record/pasien/'.$row->no_cm.'/'.$row->no_medrec); ?>" class="btn btn-danger btn-xs" style='width:85px;'>Rekam Medik</a>
										</td>
									</tr>
									<?php } 
									}
