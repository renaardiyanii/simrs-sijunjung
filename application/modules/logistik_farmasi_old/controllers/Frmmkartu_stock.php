<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  function get_data_stock($awal, $akhir,$id_gudang){
          ...
          case when keterangan in ('Pembelian Obat','Adjusment_Tambah','Hapus Pembelian') then a.pembelian+a.adjustment+a.retur_pembelian else 0 end as masuk, a.alasan_ajustmen,
