    ...
    function get_amprah_list($url=null){		
		...
		if(sizeof($_POST)==0) {
			...
			foreach ($hasil as $value) {
				...
				//if ($value->status != 1)
					$row2['aksi'] = '<center>
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#detailModal" data-id="'.$value->id_amprah.'">Detail</button> <a href="'.base_url('logistik_farmasi/'.$url.'/cetak_faktur_amprah/'.$value->id_amprah).'" class="btn btn-primary btn-sm">Print</a>
								</center>';
				// else
