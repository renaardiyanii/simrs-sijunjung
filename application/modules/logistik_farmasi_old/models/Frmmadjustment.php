  ...
  function get($id_obat) {
   ...
   VALUES (0, '".$data1['id_obat']."', '".$data1['batch_no']."', '".date('Y-m-d H:i:s')."','".$data1['username']."', 'Adjustment', '".$data1['id_gudang']."', '".$data1['qty']."', '".$data1['qty_adjustment']."', '".$data1['qty_real']."')");
    ...
    function data_gudang($id_inventory){
      return $this->db->query("SELECT b.id_inventory, b.id_gudang, a.nm_obat, a.id_obat, b.batch_no , b.qty, TO_CHAR(b.expire_date,'YYYY-MM-dd') as expire_date from master_obat as a, gudang_inventory as b where a.id_obat = b.id_obat and b.id_inventory ='$id_inventory'");
    }
