<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class Frmmstok extends CI_Model{
   ...
   function get_receivings($no_faktur) {
    ...
    function cek_obat_to_gudang($id_obat,$batch_no){
       return $this->db->query("SELECT * FROM gudang_inventory where id_obat = '$id_obat' and batch_no = '$batch_no' ");
    }
    ...
    function get_all_obat_by_kelompok($kel,$role){
      if($role == ''){
        ...
        o.min_stock,o.jenis_obat,kel.nm_kelompok as kelompok,subkel.bentuk_sediaan as subkelompok
          ...
          and o.kelompok = '$kel'
          and g.deleted = '0'
           and CURRENT_DATE <= g.expire_date        
          ORDER BY o.nm_obat");
