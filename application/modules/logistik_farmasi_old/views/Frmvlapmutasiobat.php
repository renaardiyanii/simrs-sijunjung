    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="card-block">
            <div class="table-responsive col-sm-12">
                <table class=" datatable table  table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $val->batch_no ?></td>
                            <td><?= $val->nm_obat ?></td>
                            <td><?= $val->satuan_kecil ?></td>
                            <td><?= $val->hargabeli?></td>
                            <td><?= $val->stok_awal ?></td>
                            <td><?= $val->masuk_gd ?></td>
                            <td><?= $val->masuk_mutasi ?></td>
                            <td><?= $val->total_masuk ?></td>
                            <td><?= $val->keluar_gd ?></td>
                            <td><?= $val->keluar_pemakaian ?></td>
                            <td><?= $val->expire_date ?></td>
                            <td><?= $val->total_keluar ?></td>
                            <td><?= $val->sisa ?></td>
                            <?php 
                            $total_harga = $val->hargabeli*$val->sisa;
                            ?>
                            <td><?= $total_harga ?></td>
                ...
                <a href="<?php echo site_url('logistik_farmasi/Frmclaporan/download_lap_mutasi_obat/'.$bulan_old.'/'.$tgl_awal.'/'.$tgl_akhir.'/'.$idgudang.'/'.$kelompok);?>">
