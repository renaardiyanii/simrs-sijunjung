	...
	<div class="modal-content">
        ...
        <form id="frmCari" class="form-horizontal" >
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="date" class="form-control datepicker" name="tgl_faktur" id="tgl_faktur" required="">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2">
                    <input type="date" class="form-control" name="jatuh_tempo" id="jatuh_tempo" required="" placeholder="Tgl Jatuh Tempo">
                </div>
            </div>
            <div class="form-group row">
			...
			<td width="100%" valign="top">
				...
				<table id="tableBeli" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0" width="100%">
					...
					<tr>
                        ...
                        <th width="10%"><p align="center">Satuan</p></th>
                        <th><p align="center">Harga Beli</p></th>
		...
		<div class="modal-footer">
			...
			<input type="hidden" name="id_po" id="id_po">
				<button id="bt_selesai" name="bt_selesai" class="btn btn-primary" type="submit">Simpan & Selesai</button>
            <?php echo form_close();?>    
		</div>
		</div>
        </div>
