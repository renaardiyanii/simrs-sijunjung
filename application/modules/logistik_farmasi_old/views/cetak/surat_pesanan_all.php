                    ...
                    <table class="table-font-size2" border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="margin-left:50px"><?= $info_po->company_name ?></span><br>
                                <span style="margin-left:50px">___________________</span>
            ...
            <div class="content">
                ...
                <table width= "100%" class="me"  >
                    ...
                    <tr>
                        ...
                        <td width="15%" class="me"><?= $value->satuanb ?></td>
                        <td width="15%" class="me"><?= $value->qty ?></td>
                        <td width="15%" class="me"><?php ?></td>
                    </tr>
                <?php } ?>
                </table>
                <img width="80px" src="<?= isset($info_po->ttd)?$info_po->ttd:'' ?>" alt="">
                ...
                <table border="0" width="100%">
                    ...
                    <tr>
                      <td width="30%" align="center"></td>
                      <td width="40%"></td>
                      <td width="30%" align="center"><br/><br/><br/><br/><br/>(<?= $info_po->name ?>)</td>
                    </tr>
                </table>
            </div>
