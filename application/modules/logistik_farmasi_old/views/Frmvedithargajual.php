        ...
        function save() {
            ...
            var batch_no = $('#batch_no').val();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'text',
                    url: "<?php echo base_url('logistik_farmasi/Frmcstok/update_harga_jual')?>",
                    data: {
                ...
                <div class="card-block">
                    <div class="modal-body">
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                <p class="col-sm-4 form-control-label">Harga Jual</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="hargajual" name="hargajual"  value="<?=$detail->hargajual?>">
                                </div>
                            </div>
                            <div class="form-group row">
