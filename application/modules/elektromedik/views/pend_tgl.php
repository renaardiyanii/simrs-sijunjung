...
<div class="form-inline" align="right">
	<div class="form-group">
		<a id="btnExcel" name="btnExcel" class="btn btn-primary" href="<?php echo site_url('elektromedik/Emclaporan/export_excel/'.$tampil_per.'/'.$tgl);?>">Download Excel</a>
		<a id="btnCetak" name="btnCetak" class="btn btn-primary" target="_blank" href="<?php echo site_url('elektromedik/Emclaporan/lap_keu/'.$tampil_per.'/'.$tgl);?>">Cetak</a>
	</div>
</div>
