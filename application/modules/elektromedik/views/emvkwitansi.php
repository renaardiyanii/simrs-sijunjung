	...
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			<div class="card-block">
				<div class="row p-t-0">
					<div class="col-md-6">
					<?php echo form_open('elektromedik/emckwitansi/kwitansi_by_date');?>
					...
					<div class="col-md-6">
					<?php echo form_open('elektromedik/emckwitansi/kwitansi_by_no');?>
					...
					<table id="example" class="table display table-bordered table-striped" cellspacing="0" width="100%">
						...
						<tbody>
							<?php
								...
								foreach($daftar_em as $row){
									$no_em=$row->no_em;
							?>
							<tr>
							  <td>
									<a href="<?php echo site_url('elektromedik/emckwitansi/kwitansi_pasien/'.$no_em); ?>" class="btn btn-primary"><i class="fa fa-book"></i> Bayar</a>
							  </td>
