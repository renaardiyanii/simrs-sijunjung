...
<script type='text/javascript'>
	...
	function download(){	
		...
		swal({
		  title: "Download?",
		  text: "Download Laporan Keuangan Elektromedik!",
		  type: "warning",
		...
		function(isConfirm){
		 ...
		 //    $.ajax({
			// 	type:'POST',
			// 	dataType: 'json',
			// 	url:"<?php echo base_url('elektromedik/emclaporan/download_keuangan')?>",
			// 	data: {
		 ...
		 //    swal("Download", "Sukses", "success");
			...
			// });
			swal("Download", "Sukses", "success");
			window.open("<?php echo base_url('elektromedik/emclaporan/download_keuangan')?>/"+startDate+"/"+endDate);
		  } else {
	...
	<div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
				<h4 class="m-b-0 text-white">Laporan Keuangan Elektromedik</h4>
			</div>
			<div class="card-block">
                <div class="row p-t-0">
                    <div class="col-md-6">
					<?php echo form_open('elektromedik/emclaporan/data_pendapatan');?>
