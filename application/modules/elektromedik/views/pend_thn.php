...
<div class="form-inline" align="right">
	<div class="form-group">
		<a id="btnExcel" name="btnExcel" class="btn btn-primary" href="<?php echo site_url('elektromedik/Emclaporan/export_excel/'.$tampil_per.'/'.$thn.'/'.$jenis_bayar);?>">Download Excel</a>
		<a target="_blank" id="btnCetak" name="btnCetak" class="btn btn-primary" href="<?php echo site_url('elektromedik/Emclaporan/lap_keu/'.$tampil_per.'/'.$thn.'/'.$jenis_bayar);?>">Cetak</a>
	</div>
</div>
<?php	} else {
	echo $message_nodata;
