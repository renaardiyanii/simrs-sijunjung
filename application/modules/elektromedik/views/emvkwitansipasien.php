...
<div class="row">
    <div class="col-md-12">
        <div class="card card-block printableArea">
            <h3><b>INVOICE</b> <span class="pull-right">#<?php echo $no_em; ?></span></h3>
            <hr>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <tbody>
								...
								?>
									<tr>
	                                    ...
	                                    <td class="text-right"> <?php echo number_format( $row->biaya_em, 2 , ',' , '.' ); ?> </td>
                ...
                <div class="col-md-12">
                    ...
                    <hr>
					<?php
						//echo form_open('elektromedik/emckwitansi/st_cetak_kwitansi_kt',array('target'=>'_blank'));
					?>
					...
					<input type="hidden" class="form-control" name="no_em" id="no_em" value="<?php echo $no_em ?>">
	...
	function submitPembayaran()
{
	...
	$.ajax({  
		url:"<?= base_url() ?>/elektromedik/emckwitansi/st_cetak_kwitansi_kt",                         
		method:"POST",  
		data:data,   
		...
		{ 
			...
			function () {
				window.open('<?php echo base_url() ?>'+'elektromedik/emckwitansi/cetak_kwitansi_kt/'+'<?= $no_em ?>','_blank');
				// window.location.href = '<?php echo base_url() ?>'+"elektromedik/emckwitansi/kwitansi";
	...
	function cetak(){
		...
		var myWindow = window.open("<?php echo base_url('elektromedik/emckwitansi/cetak_kwitansi_kt')?>/"+no_em+"/"+penyetor+"/", "", "width=200,height=100");
		myWindow.focus();
	}
	...
	function showswal() {
		...
		function () {
			window.location.href = base+"elektromedik/emckwitansi/kwitansi";
		});
	}
