...
<body class="A4">
	<div class="A4 sheet  padding-fix-10mm">
		...
		<p align="center" style="font-size:14px"><b>
				BUKTI PEMBAYARAN - KWITANSI LUNAS BIAYA ELEKTROMEDIK<br />
				No. DIA_<?= $no_em ?>
			</b></p>
		<table width="100%" border="0">
			...
			<tr>
				<td><b>Tgl Reg</b></td>
				<td> : </td>
				<td><?= isset($data_pasien->tgl) ? date("d-m-Y", strtotime($data_pasien->tgl)) : '' ?></td>
				<td><b>Umur</b></td>
				<td> : </td>
			...
			<tr>
				...
				<td> : </td>
				<td><?= isset($no_kwitansi->no_kwitansi) ? $no_kwitansi->no_kwitansi : '' ?></td>
			</tr>
		...
		<!-- <table id="data" width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td style="font-size:11px"> : </td>
                                <td style="font-size:11px"> <?= $no_kwitansi->no_kwitansi ?> </td>
                            </tr>
                </table><br> -->
		...
		<table border="1" style="padding:2px;font-size:11px" width="100%">
			<tr>
				...
				<th width="65%">
					<p align="center"><b>Nama Pemeriksaan</b></p>
				</th>
				<th width="10%">
					<p align="center"><b>Banyak</b></p>
				</th>
				<th width="20%">
			...
			?>
				<tr>
					...
					<td>
						<p style="font-size:11px"><?= $row->jenis_tindakan ?></p>
					</td>
					<td>
						<p align="center" style="font-size:11px"><?= $row->qty ?></p>
					</td>
					<td>
						<p align="right" style="font-size:11px"><?= $vtot ?></P>
					</td>
				</tr>
				<?php $i++; ?>
			<?php } ?>
			...
			<?php if (substr($data_pasien->no_register, 0, 2) == 'PL') { ?>
				<tr>
					...
					<td style="font-size:11px">
						<p><?= $data_adm->nmtindakan ?></p>
					</td>
					<td style="font-size:11px">
						<p align="center"></p>
					</td>
					<td style="font-size:11px">
						<p align="right"><?= $data_adm->total_tarif ?></P>
					</td>
				</tr>
			...
			if ($cash != 0 && $noncash != 0) { ?>
				<tr>
					<th colspan="2">
						<p align="left"><b> Tunai</b></p>
					</th>
					<th>
						<p align="center"><b></b></p>
					</th>
					<th>
						<p align="right"><?= number_format($cash, 2, ',', '.') ?></p>
					</th>
				</tr>

				<tr>
					<th colspan="2">
						<p align="left"><b> Non tunai</b></p>
					</th>
					<th>
						<p align="center"><b></b></p>
					</th>
					<th>
						<p align="right"><?= number_format($noncash, 2, ',', '.') ?></p>
					</th>
				</tr>
			<?php }
			...
			<tr>
				<th colspan="2">
					<p align="left"><b> Diagnostik</b></p>
				</th>
				<th>
					<p align="center"><b><?= $i - 1 ?></b></p>
				</th>
				<th>
					<p align="right"><?= number_format($jumlah_vtot, 2, ',', '.') ?></p>
				</th>
			</tr>
			<?php //if($diskon!=0){ 
			?>
			<!-- <tr>
                                    ...
                                    <th><p align="right"><?php //echo number_format( $diskon, 2 , ',' , '.' )
																													?></p></th>
                                </tr> -->
			<?php $jumlah_vtot = $jumlah_vtot; ?>
			<!-- <tr>
                                    <th colspan="3"><p align="right"><b>Total Bayar</b></p></th>
                                    <th><p align="right"><?php //echo number_format( $jumlah_vtot, 2 , ',' , '.' )
																													?></p></th>
                                </tr> -->
			<?php  //} 
			?>
