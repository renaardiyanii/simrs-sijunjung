    ...
    <body class="A4">
        <div class="A4 sheet  padding-fix-10mm">
            ...
            <p align="center" style="font-size:14px"><b>
					DETAIL TAGIHAN BIAYA ELEKTROMEDIK<br/>
					No. DIA_<?= $no_em ?>
			</b></p>
            <table width="100%" border="0">	
                ...
                <table border="1" style="padding:2px;font-size:11px" width="100%">
				    ...
				    <?php } ?>
                         ...
                         <tr>
							<th colspan="2"><p align="left"><b> Diagnostik</b></p></th>
                        ...
                        <?php //if($diskon!=0){ ?>
                                <!-- <tr>
                                    ...
                                    <th><p align="right"><?php //echo number_format( $diskon, 2 , ',' , '.' )?></p></th>
                                </tr> -->
                            <?php $jumlah_vtot=$jumlah_vtot; ?>
                                <!-- <tr>
                                    <th colspan="3"><p align="right"><b>Total Bayar</b></p></th>
                                    <th><p align="right"><?php //echo number_format( $jumlah_vtot, 2 , ',' , '.' )?></p></th>
                                </tr> -->
                     <?php  //} ?>
