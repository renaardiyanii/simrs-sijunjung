...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        ...
        $('#cari_obat').autocomplete({
            ...
            select: function (event, ui) {
                ...
                $('#idobat').val('' + ui.item.idobat);
                $('#idtindakan').val(ui.item.id_inventory);
        ...
        $('#cari_obat2').autocomplete({
            ...
            source : function( request, response ) {
                $.ajax({
                    url: '<?php echo site_url('farmasi/Frmcdaftar/cari_data_obat_racik')?>',
                    dataType: "json",
                    data: {
                        term: request.term,
        ...
        $("#id_obat_new").change(function(){
                console.log($('#id_obat_new').val());
                if ($('#id_obat_new').val() != ''){
                    $.ajax({
                        dataType: "json",
                        data: {id: $('#id_obat_new').val() },
                        type: "POST",
                        url: "<?php echo site_url(); ?>farmasi/Frmcdaftar/get_biaya_obat_luar",
                        success: function( data ) {
                            console.log(data)
                            $('#edit_biaya_farmasi_luar').val(data.hargajual);
                            set_total_luar();
    ...
    function edit_obat_farmasi_racik(data,id_resep_dokter,data_racikan){
        let racikan = [];
        data_racikan.map((e)=>{
            if(e.id_resep_dokter == data.id_resep_dokter){
                racikan.push(e);
            }
        });
        // console.log(data);
        ...
        racikan.map((e,index)=>{
            html+=`
                <li class="nav-item">
                    <a class="nav-link" id="${index}-tab" data-toggle="tab" href="#tab-${index}" role="tab" aria-controls="tab-${index}">${e.nama_obat.slice(0,3)+'..'}</a>
                </li>
            `;
        });
        html +='</ul><div class="tab-content" id="myTabContent">';
        racikan.map((e,ind)=>{
            html+= `<div class="tab-pane fade mt-4" id="tab-${ind}" role="tabpanel" aria-labelledby="${ind}-tab">
            `;
            html+=`
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="id_obat[]" value="${e.item_obat}"
                            readonly>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="nama_obat-${e.item_obat}" value="${e.nama_obat}" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <div class="col-sm-6">
                        <select id="obatsubtitusi-${ind}" name="cari_obat_sub-${e.item_obat}" class="form-control" width="100%" onchange="ajaxdokterkonsul3(this.value)">
                            <option value="">Obat substitusi tidak tersedia</option>
                        </select>
                        <input type="hidden" name="nm_sub-${e.item_obat}" id="idtindakansub">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select id="pilihbatch-${e.item_obat}" name="id_inventory-${e.item_obat}" class="form-control" width="100%" onchange="ajaxbiayaobatracik(this.value,${e.item_obat})">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="biaya_obat-${e.item_obat}"
                            id="biaya_obat-${e.item_obat}">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-1"></div>
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" style="width: 100%" name="signa-${e.item_obat}" id="edit_signa_farmasi" >
                            ${data.signa?`<option value="${data.signa}" selected>${data.signa}</option>`:``}
                            <option value="">-Pilih Signa-</option>
                            `;
                <?php
                    foreach ($satuan_signa as $row) {
                    
                    echo 'html+=`<option value="'.$row->signa.'">'.$row->signa.'</option>`;';
                    }
                ?>
                html+=`
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" style="width: 100%" name="qtx-${e.item_obat}" id="edit_qtx_farmasi" >
                        ${data.qtx?`<option value="${data.qtx}" selected>${data.qtx}</option>`:''}
                            <option value="">-Pilih Qtx-</option>`;
                <?php
                    foreach ($qtx as $row) {
                        echo 'html+=`<option value="'.$row->qtx.'">'.$row->qtx.'</option>`;';
                    }
                ?>
                html+=`</select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" style="width: 100%" name="Satuan_obat-${e.item_obat}" id="edit_satuan_farmasi-${e.item_obat}" >
                            ${e.satuan?`<option value="${e.satuan}" selected>${e.satuan}</option>`:``}
                            <option value="">-Pilih Satuan-</option>`;
                <?php
                    foreach ($satuan as $row) {
                    echo 'html+=`<option value="'.$row->nm_satuan.'">'.$row->nm_satuan.'</option>`;';
                    }
                ?>
                html+=`</select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" style="width: 100%" name="cara_pakai-${e.item_obat}" id="edit_cara_pakai_farmasi" >
                            ${data.cara_pakai?`<option value="${data.cara_pakai}" selected>${data.cara_pakai}</option>`:''}
                            <option value="">-Pilih Cara Pakai-</option>`;
                            <?php
                                foreach ($cara_pakai as $row) {
                                    echo 'html+=`<option value="'.$row->cara_pakai.'">'.$row->cara_pakai.'</option>`;';
                                }
                            ?>
                    html+=`
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control calculatorquantity" name="qty-${e.item_obat}" id="qty-${e.item_obat}"
                            onkeyup="set_total_new_racikan(this.value,${e.item_obat})" value="${e.qty}">
                        <input type="hidden" name="no_register-${e.item_obat}" id="edit_no_register_far">
                        <input type="hidden" name="id_resep_dokter-${e.item_obat}" id="edit_id_resep_dokter_far" value="${e.id_resep_dokter}">
                        <input type="hidden" class="form-control" value="<?php echo $kelas_pasien; ?>"
                            name="kelas-${e.item_obat}">
                        <input type="hidden" class="form-control" value="<?php echo $cara_bayar; ?>"
                        name="cara_bayar-${e.item_obat}" id="cara_bayar">
                        <input type="hidden" class="form-control" value="<?php echo $idrg; ?>" name="idrg-${e.item_obat}">
                        <input type="hidden" class="form-control" value="<?php echo $bed; ?>" name="bed-${e.item_obat}">
                        <input type="hidden" class="form-control" value="<?php echo $user_info->username; ?>"
                            name="xuser-${e.item_obat}">
                        <input type="hidden" name="no_medrec-${e.item_obat}" value="<?php echo $no_cm;?>">
                        <input type="hidden" name="obat_luar-${e.item_obat}" id="obat_luar">
                        <input type="hidden" name="id_obat_racikan-${e.item_obat}" value="${e.id_obat_racikan}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="vtot-${e.item_obat}"
                            id="vtot-${e.item_obat}" min="0">
                    </div>
                </div>
            
            `;
            html+=`</div>`;
            get_data_obat_sub(e.item_obat,e.id_obat_racikan,'obatsubtitusi-'+ind);
            
        })                
        html +=`<input type="hidden" name="resep_dokter" value='${JSON.stringify(data)}'> </div>`;
        $("#isiModalEditObatRacikan").html(html);
        $(".calculatorquantity").keypress(function(e){
            if (e.which == 13) {
                let id = this.id;
                let value = this.value;
                let arrayKali = value.split('*');
                // let arrayBagi = [];
                // arrayKali.map((e)=>{
                    // arrayBagi.push(e.split('/'));
                // })
                // console.log(arrayKali);
                let itunganKali = 0;
                let pembagianHasil = 0;
                arrayKali.map((e)=>{
                    if(!e.includes('/')){
                        itunganKali = e;
                    }else{
                        let pembagian = e.split('/');
                       
                        pembagian.map((v,index)=>{
                            if(index == 0){
                                pembagianHasil = itunganKali * v;
                            }else{
                                pembagianHasil = pembagianHasil / v;
                            }
                        })
                    }
                });
                // console.log(pembagianHasil);
                this.value = pembagianHasil;
            }
        })
    }

    function get_data_obat_sub(id_obat,id_resep_dokter,id_subtitusi) {
        $.ajax({
            method:"POST",
            data:{
                id_resep_dokter,
            ...
            url: "<?php echo base_url('farmasi/Frmcdaftar/get_data_edit_obat_farmasi_racikan/')?>",
            success: function (data) {
                ...
                if(data.sub.length){
                    ...
                    $('#'+id_subtitusi).html(html2);
                }
                let ex = '';
                if(data.resep.length){
                    $('#pilihbatch-'+id_obat).empty();
                    ex+= '<option value="" selected>Pilih Batch</option>';
                    data.resep.map((i)=>{
                        ex+= `
                        <option value="${i.id_inventory}">${'(batch -'+i.batch_no+','+i.expire_date+','+i.stock+')'}</option>
                        `;
                    })
                    $('#pilihbatch-'+id_obat).html(ex);
                }
    ...
    function edit_obat_farmasi(id_resep_dokter,id_obat,json='') {
        if(json != ''){
            $("#obat_luar").val(json.obat_luar);
        }
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url('farmasi/Frmcdaftar/get_data_edit_obat_farmasi')?>",
            data: {
                id_resep_dokter: id_resep_dokter,
                id_obat: id_obat
            },
            success: function (data) {
                $('#edit_no_register_far').val(data.resep[0].no_register);
                $('#edit_id_obat_farmasi').val(data.resep[0].id_obat);
                $('#edit_id_obat_farmasi_hidden').val(data.resep[0].id_obat);
                $('#edit_nama_obat_farmasi').val(data.resep[0].nm_obat);
                 $('#edit_biaya_obat').val(data.resep[0].hargajual);
                $('#edit_qty_farmasi').val(data.resep[0].qty);
                $('#edit_qty_farmasi_hidden').val(data.resep[0].qty);
                $('#edit_id_resep_dokter_far').val(data.resep[0].id_resep_dokter);
                $('#edit_signa_farmasi').val(data.resep[0].kali_harian).change();
                $('#edit_qtx_farmasi').val(data.resep[0].qtx).change();
                $('#edit_satuan_farmasi').val(data.resep[0].satuan).change();
                $('#edit_cara_pakai_farmasi').val(data.resep[0].cara_pakai).change();
                let html = '';
                if(data.resep.length){
                    $('#pilihbatch').empty();
    ...
    function edit_obat_farmasi_luar(id_resep_dokter,nm_obat) {
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url('farmasi/Frmcdaftar/get_data_edit_obat_farmasi_luar')?>",
            data: {
                id_resep_dokter: id_resep_dokter,
                nm_obat: nm_obat
            },
            success: function (data) {
                ...
                $('#edit_no_register_far_luar').val(data.resep[0].no_register);
                $('#edit_nama_obat_farmasi_luar').val(data.resep[0].nm_obat);
                $('#edit_qty_farmasi_luar').val(data.resep[0].qty);
                $('#edit_qty_farmasi_luar_hidden').val(data.resep[0].qty);
                $('#edit_id_resep_dokter_far_luar').val(data.resep[0].id_resep_dokter);
                $('#edit_signa_farmasi_luar').val(data.resep[0].kali_harian).change();
                $('#edit_qtx_farmasi_luar').val(data.resep[0].qtx).change();
                $('#edit_satuan_farmasi_luar').val(data.resep[0].satuan).change();
                $('#edit_cara_pakai_farmasi_luar').val(data.resep[0].cara_pakai).change();
    ...
    function ajaxbiayaobatracik(id,value)
    {
        let idobat = $('#pilihbatch-'+value).val();
        $.ajax({
            url: '<?= base_url('farmasi/Frmcdaftar/get_biaya_obat/') ?>'+idobat,
            beforeSend: function() {
            },
            success: function(data) {
                $('#biaya_obat-'+value).val(data.hargajual);
                set_total_harga_racikan(value);

            },
            error: function(xhr) { // if error occured
                $('#obatsubtitusiracik').empty();
                let html = '<option>Silahkan Kontak Admin IT</option>';
                $('#obatsubtitusiracik').html(html)
            },
            complete: function() {
    ...
    function ajaxhistoryNew(no_medrec)
    {
        ajaxku = buatajax();
        var url="<?php echo site_url('farmasi/Frmcdaftar/data_obat_history_lastrecord'); ?>";
        url=url+"/"+ no_medrec; // added @aldi
    ...
    function edit_obat_racikan_farmasi(id_racikan,id_obat) {
        console.log(id_racikan);
        console.log(id_obat);
        $.ajax({
            type: 'POST',
            dataType: 'json',
            ...
            success: function (data) {
                $('#edit_no_register_racikan_far').val(data.racik[0].no_register);
                $('#edit_id_obat_racikan_far').val(data.racik[0].item_obat);
                $('#edit_id_obat_racikan_far_hidden').val(data.racik[0].id_obat_racikan);
                $('#edit_nama_obat_racikan_far').val(data.racik[0].nm_obat);
                // $('#edit_biaya_obat_racikan').val(data[0].hargajual);
                $('#edit_qty_racikan_far').val(data.racik[0].qty);
                $('#edit_qty_racikan_far_hidden').val(data.racik[0].qty);
                $('#edit_dosis_obat_racikan_far').val(data.racik[0].dosis);
                // $('#edit_satuan_obat_racikan').val(data[0].satuan);
                $('#edit_id_resep_pasien_racikan').val(id_racikan);

                let html = '';
                if(data.resep.length){
                    $('#pilihbatchracik').empty();
                    html+= '<option value="" selected>Pilih Batch</option>';
                    data.resep.map((i)=>{
                        html+= `
                        <option value="${i.id_inventory}">${'(batch -'+i.batch_no+','+i.expire_date+','+i.stock+')'}</option>
    ...
    function set_total_harga_racikan(id='') {
        if(id!=''){
            let harga = $('#biaya_obat-'+id).val();
            let qty = $('#qty-'+id).val();
            let total_akhir = harga * qty;
            $('#vtot-'+id).val(total_akhir);
            return;
        }
    ...
    function ajaxracik(id)
    {
        let idobat = $('#obatsubtitusiracik').val();
        console.log(idobat);
        $.ajax({
            url: '<?= base_url('iri/Rictindakan/data_obat_sub3/') ?>'+idobat,
            beforeSend: function() {
               ...
               let html = '';
                if(data.length){
                    ...
                    data.map((i)=>{
                        ...
                        `;
                        console.log(i)
                        $('#idtindakansubracik').val(i.nm_obat);
                    })
    ...
    function set_total_new_racikan(val,id){
        var cara_bayar = "<?php echo $cara_bayar; ?>";
        if (cara_bayar == "BPJS") {
            var total = ($("#biaya_obat-"+id).val() * parseInt(val));
        } else {
            var total = ($("#biaya_obat-"+id).val() * parseInt(val));
        }

        // var total_akhir = total * parseFloat(margin);
        $('#vtot'+'-'+id).val(total.toFixed(0));
    }
    ...
    function set_total_new() {
        ...
        if (cara_bayar == "BPJS") {
            var total = ($("#edit_biaya_obat").val() * $("#edit_qty_farmasi").val());
        } else {
            var total = ($("#edit_biaya_obat").val() * $("#edit_qty_farmasi").val());
    ...
    function set_total_luar() {
       
       var harga = parseFloat($('#edit_biaya_farmasi_luar').val());
       var qty = $("#edit_qty_farmasi_luar").val();

       var total = harga * qty;

       $("#edit_total_akhir_luar").val(total.toFixed(0));
       console.log(total);
   }
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php if($pengkondisian_poli == 'BJ00' && $pelayan == 'DOKTER')  { ?>
            ...
            <button type="button" class="btn btn-success box-title" data-toggle="modal" data-target="#paketobat">Paket Obat</button>
                        ...
                        <?php echo form_open('farmasi/Frmcdaftar/insert_permintaan_old'); ?>
                            <table id="obat_neuro" class=" table display table-hover table-bordered table-striped" style="width: 100%;">
                                ...
                                <?php foreach ($data_obat_poli as $key) { ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="jumlah_obat[]" id="<?php echo $key->id_obat; ?>" value="<?php echo $key->id_obat; ?>">
                                            <label for="<?php echo $key->id_obat; ?>"></label>
                                        </td>
                                        <td><label><?= $key->nm_obat ?></label></td>
                                        <td>
                                            <select class="form-control " name="signa-<?php echo $key->id_obat; ?>" id="signa-<?php echo $key->id_obat; ?>" style="width: 20%;">
                                                <option value="">-Signa-</option>
                                                <?php foreach ($satuan_signa as $row) { ?>
                                                    <option value="<?=$row->signa?>"><?=$row->signa?></option>
                                                <?php } ?>
                                            </select>
                                            <select class="form-control " name="qtx-<?php echo $key->id_obat; ?>" id="qtx-<?php echo $key->id_obat; ?>" style="width: 11%;">
                                                <option value="">-Qtx-</option>
                                                <?php foreach ($qtx as $row) { ?>
                                                    <option value="<?=$row->qtx?>"><?=$row->qtx?></option>
                                                <?php } ?>
                                            </select>
                                            <select class="form-control " name="satuan-<?php echo $key->id_obat; ?>" id="satuan-<?php echo $key->id_obat; ?>" style="width: 24%;">
                                                <option value="">-Satuan-</option>
                                                <?php foreach ($satuan as $row) { ?>
                                                    <option value="<?=$row->nm_satuan?>"><?=$row->nm_satuan?></option>
                                                <?php } ?>
                                            </select>
                                            <select class="form-control " name="cara_pakai-<?php echo $key->id_obat; ?>" id="cara_pakai-<?php echo $key->id_obat; ?>" style="width: 23%;">
                                                <option value="">-Cara Pakai-</option>
                                                <?php foreach ($cara_pakai as $row) { ?>
                                        ...
                                        <td>
                                            <input type="hidden" name="id_obat[]" id="id_obat" value="<?php echo $key->id_obat; ?>">
                                            <input type="number" min="1" name="qty-<?php echo $key->id_obat; ?>" id="qty" placeholder="Qty" class="form-control" style="width: 80%;">
                                        </td>
                                    </tr>
                                <?php } ?>
        ...
        <?php }else{ ?>
            <button type="button" class="btn btn-warning box-title" data-toggle="modal" data-target="#obatHistory" onclick="ajaxhistoryNew('<?= $no_medrec ?>')">Obat History</button>
            <button type="button" class="btn btn-success box-title" data-toggle="modal" data-target="#paketobat">Paket Obat</button>
            <br><br>
                ...
                <div class="tab-content">
                    ...
                    <div id="obat" class="tab-pane <?php echo $tab_obat; ?>" role="tabpanel">
                        <div class="panel panel-info">
                            <div class="panel-body">
                                <form action="<?php echo base_url('farmasi/Frmcdaftar/insert_permintaan_dokter'); ?>" method="post">
                                <?php //echo form_open('farmasi/Frmcdaftar/insert_permintaan'); ?>
                                    ...
                                    <!-- <input type="hidden" class="form-control" name="idtindakan" id="idtindakan"> -->
                                    <input type="hidden" class="form-control" name="biaya_obat" id="biaya_obat">
                                    <input type="hidden" class="form-control" name="biaya_obat_hide" id="biaya_obat_hide">

                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="reset" class="btn btn-danger">Reset</button>
                                            <button type="submit" class="btn btn-primary"  id="btn-order">Simpan</button>
                                        </div>
                                    </div>
                                <?php //echo form_close(); ?>
                                </form>
                    ...
                    <div id="racikan" class="tab-pane <?php echo $tab_racik; ?>" role="tabpanel">
                        ...
                        <?php if ($pelayan == 'DOKTER' or $pelayan == 'PERAWAT') { ?>
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="number" step="0.05" class="form-control" name="dosis_racikan" id="dosis_racikan" required>
                                        </div>
                                    ...
                                    <table class="display nowrap table table-hover table-bordered table-striped"
                                        ...
                                        foreach ($data_tindakan_racikan as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <?php $v = (int)$row->hargajual * $row->qty;
                                                $vtot1 = $vtot1 + $v;
                                                ?>
                                ...
                                <?php echo form_open_multipart('farmasi/Frmcdaftar/insert_racikan_selesai'); ?>
                                    <div class="col-sm-12">
                                        ...
                                        <p class="col-sm-2 form-control-label" id="lbl_signa">Signa</p>
                                        <div class="col-sm-4">
                                            <input type="text" name="signa_all_racik" id="" class="form-control">
                                        </div>
        ...
        <?php } ?>
            ...
            <div class="col-lg-12 col-sm-12">
               ...
               <!-- untuk resep dokter -->
                    <div class="table-responsive">
                        <table id="tabel_tindakan" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($data_tindakan_pasien_dokter as $row) {
                                    ...
                                    $total_harg = $row->qty * $row->harga;
                                    $total += $total_harg;
                                    
                                    if($row->id_inventory != null){
                                        $cek_qty = $this->Frmmdaftar->check_qty_stock($row->id_inventory)->row();
                                        $cek_qty = $cek_qty->qty??'';
                                        // $cek_qty = $this->Frmmdaftar->check_qty_stock($row->id_inventory)->row()->qty;
                                        // if($cek_qty){
                                        //     $qty = $cek_qty->
                                        // }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row->racikan == '1') { ?>
                                                        ...
                                                        <a href="<?php echo site_url("farmasi/Frmcdaftar/hapus_data_obat_racik_new/".$pelayan."/". $row->no_register . "/" . $row->id_resep_dokter. "/". $row->qty."/".$row->nm_obat); ?>"class="btn btn-danger btn-xs">Hapus</a>
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModalFarmasiRacikan" onclick='edit_obat_farmasi_racik(<?= json_encode($row) ?>,<?php echo $row->id_resep_dokter;?>,<?= json_encode($data_tindakan_racik) ?>)'>Detail Obat</button>

                                                
                                                <?php } else { ?>
                                                    <a href="<?php echo site_url("farmasi/Frmcdaftar/hapus_data_obat_dokter/".$pelayan."/". $row->no_register . "/" . $row->id_resep_dokter); ?>"
                                                    class="btn btn-danger btn-xs">Hapus</a>
                                                    <?php if ($pelayan == 'DOKTER') { ?>
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModal" onclick="edit_obat(<?php echo $row->id_resep_dokter; ?>)">Edit</button>
                                                    <?php }else { ?>
                                                        <?php if($row->id_obat == null){ ?>
                                                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModalFarmasiLuar" onclick="edit_obat_farmasi_luar(<?php echo $row->id_resep_dokter;?>)">Detail Obat Luar</button>
                                                        <?php }else{ ?>
                                                            <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModalFarmasi" onclick='edit_obat_farmasi(<?php echo $row->id_resep_dokter;?>,<?php echo $row->id_obat;?>,<?= json_encode($row) ?>)'>Detail Obat</button>
                                                        <?php   } ?>
                                                    <?php } ?>
                                            ...
                                            <td><?php echo $total_harg; ?></td>
                                        </tr>

                                     <?php //} else { ?>
                                        <!-- <tr>
                                            <td><span style="color:red"><?php echo $i++ ?></span></td>
                                            <td>
                                                <?php if ($row->racikan == '1') { ?>
                                                    
                                                    
                                                        <a href="<?php echo site_url("farmasi/Frmcdaftar/hapus_data_obat_racik/".$pelayan."/". $row->no_register . "/" . $row->id_resep_dokter. "/". $row->qty."/".$row->nm_obat); ?>"class="btn btn-danger btn-xs">Hapus</a>
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModalFarmasiRacikan" onclick='edit_obat_farmasi_racik(<?= json_encode($row) ?>,<?php echo $row->id_resep_dokter;?>,<?= json_encode($data_tindakan_racik) ?>)'>Detail Obat</button>
                                            ...
                                            <td><span style="color:red"><?php echo date('d-m-Y',strtotime($row->tgl_kunjungan)); ?></span></td>
                                            <td><span style="color:red">
                                                <?php
                                                echo  $row->nm_obat;
                                                if ($row->racikan == '1') {
                                            ...
                                            <td><span style="color:red"><?php echo $row->signa; ?></span></td>
                                            <td><span style="color:red"><?php echo $row->qty; ?></span></td>
                                        </tr> -->
                        ...
                        <p align="right" style="font-weight:bold;font-size:16px"><b>TOTAL : Rp. <?= number_format($total, '2', ',', '.') ?></b> </p>

                    </div><!-- style overflow -->

                    <?php if ($pelayan == 'PETUGAS') { 
                        // var_dump($data_tindakan_pasien_farmasi);die(); 
                        ?>
                    <!-- untuk farmasi -->
                    <br>
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                foreach ($data_tindakan_pasien_farmasi as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row->qty; ?></td>                                       
                                        <td><?php echo number_format((int)$row->biaya_obat,0); ?></td>
                                        <td><?php echo number_format((int)$row->embalase,0); ?></td>                                       
                                        <td>
                                            <div align="right">
                                                <?= number_format(intval($row->vtot)+intval($row->embalase), 2, ',', '.') ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
                ...
                <div class="form-group">
                    <?php if ($pelayan == 'DOKTER' or $pelayan == 'PERAWAT') {
                        if (substr($no_register, 0, 2) == "RJ") {
                            if($idrg == 'BA00'){ ?>
                                ...
                                <form action="<?php echo base_url().'ird/rdcpelayanan/update_rujukan_resep_ruangan'; ?>" method="post">
                                    <div class="form-inline" align="right">
													<input type="hidden" class="form-control" value="<?php echo $pelayan; ?>" name="pelayan">
                                        <input type="hidden" class="form-control" value="<?php echo $no_register; ?>" name="no_register">
                                        <input type="hidden" class="form-control" value="<?php echo $idrg; ?>" name="idrg">
                            ...
                            <?php }else{ ?>
                                ...
                                <form action="<?php echo base_url().'irj/rjcpelayanan/update_rujukan_resep_ruangan'; ?>" method="post">
                                    <!-- <div class="form-inline">
                                            <label>iter obat :</lebel>&nbsp;&nbsp;&nbsp;
                                            <div class="form-group">
                                                <select id="iter_obat" class="form-control " name="iter_obat">
                                                    <option value="0" selected="">-Pilih iter-</option>
                            ...
                            <?php   }
                                    ...
                                    <form action="<?php echo base_url().'iri/rictindakan/update_rujukan_penunjang_obat'; ?>" method="post">
                                            <div class="form-inline" align="right">
                                                <input type="hidden" class="form-control" value="<?php echo $pelayan; ?>" name="pelayan">
                    ...
                    <?php }else{ ?>
                        <form action="<?php echo base_url().'farmasi/frmcdaftar/insert_header_resep/'.$pelayan; ?>" method="post" target="_blank">
                            ...
                            <?php 
                           $total_obat = 0;
                            foreach ($data_tindakan_pasien as $rows) { 
                               
                                if($rows->racikan == '1'){
                                    foreach($data_tindakan_racikan as $v){
                                        if($v->id_resep_pasien == $rows->id_resep_dokter){
                                            $total_obat++;
                                            echo '<input type="checkbox" name="jumlah_obat-perawat[]" id="'.$v->id_inventory.'" value="'.$v->id_inventory.'" checked="TRUE">
                                            <input type="hidden" class="form-control" value="'.$v->qty.'" name="qty-perawat-'.$v->id_inventory.'">
                                            <input type="hidden" class="form-control" value="'.$v->nama_obat.'" name="nama_obat-perawat-'.$v->id_inventory.'">
                                            <input type="hidden" class="form-control" value="'.$rows->kali_harian.'" name="kali_harian-perawat-'.$v->id_inventory.'">
                                            <input type="hidden" class="form-control" value="1" name="racikan-perawat[]">
                                            <input type="hidden" name="id_obat-perawat[]" id="id_obat" value="'.$v->item_obat.'">';
                                        }
                                    }
                                }else{
                                    $total_obat++;
                            ...
                            <div class="form-inline" align="right">
                                ...
                                foreach($data_tindakan_pasien as $data){
                                    $total_akhir_data += $data->vtot +=$data->embalase;
                                }
            ...
            <?php echo form_open('farmasi/Frmcdaftar/edit_obat_dokter'); ?>
            <!-- Modal Edit Obat -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Signa</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="signa_edit" id="signa_edit">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="hidden" name="edit_id_resep_dokter" id="edit_id_resep_dokter">
                                    <input type="hidden" name="pelayan" id="pelayan" value="<?php echo $pelayan; ?>">
                                </div>
                            </div>
                        </div>
            ...
            <!-- editModalFarmasiRacikan -->
            <form id="form_edit_obat_farmasi_racikan">
                <div class="modal fade" id="editModalFarmasiRacikan" role="dialog" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog modal-success modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="isiModalEditObatRacikan">
                                
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button class="btn btn-primary" type="button" id="simpan_edit_obat_farmasi_racikan">simpan Obat</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <form id="form_edit_obat_farmasi">
                <!-- Modal Edit Obat -->
                <div class="modal fade" id="editModalFarmasi" role="dialog" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog modal-success">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" class="form-control" name="id_obat"
                                            id="edit_id_obat_farmasi_hidden">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <p class="col-sm-3 form-control-label">Nama Obat</p>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="nama_obat" id="edit_nama_obat_farmasi" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <p class="col-sm-3 form-control-label">Kronis?</p>
                                    <div class="col-sm-6">
                                        <select name="kronis" id="kronis_farmasi" class="form-control"  width="100%"  >
                                            <option value="0" selected> Non Kronis</option>
                                            <option value="1"> Kronis</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Batch</p>
                                    <div class="col-sm-6">
                                        <select id="pilihbatch" name="id_inventory" class="form-control" width="100%" onchange="ajaxbiayaobat(this.value)">
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Biaya Obat</p>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="biaya_obat"
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Signa</p>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="width: 100%" name="signa" id="edit_signa_farmasi" >
                                            <option value="">-Pilih Signa-</option>
                                            <?php
                                                foreach ($satuan_signa as $row) {
                                                ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Qtx</p>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="width: 100%" name="qtx" id="edit_qtx_farmasi" >
                                            <option value="">-Pilih Qtx-</option>
                                            <?php
                                                foreach ($qtx as $row) {
                                                ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Satuan</p>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="width: 100%" name="Satuan_obat" id="edit_satuan_farmasi" >
                                            <option value="">-Pilih Satuan-</option>
                                            <?php
                                                foreach ($satuan as $row) {
                                                ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Cara Pakai</p>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="width: 100%" name="cara_pakai" id="edit_cara_pakai_farmasi" >
                                            <option value="">-Pilih Cara Pakai-</option>
                                            <?php
                                                foreach ($cara_pakai as $row) {
                                                ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <p class="col-sm-3 form-control-label">Quantity</p>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" name="qty" id="edit_qty_farmasi"
                                            onkeyup="set_total_new(this.value)">
                                        <!-- <input type="hidden" name="edit_qty_farmasi_hidden" id="edit_qty_farmasi_hidden"> -->
                                        <input type="hidden" name="no_register" id="edit_no_register_far">
                                        <input type="hidden" name="id_resep_dokter" id="edit_id_resep_dokter_far">
                                        <input type="hidden" name="pelayan" id="pelayan" value="<?php echo $pelayan; ?>">
                                        <input type="hidden" class="form-control" value="<?php echo $kelas_pasien; ?>"
                                            name="kelas">
                                        <input type="hidden" class="form-control" value="<?php echo $cara_bayar; ?>"
                                        ...
                                        <input type="hidden" class="form-control" value="<?php echo $user_info->username; ?>"
                                            name="xuser">
                                        <input type="hidden" name="no_medrec" value="<?php echo $no_cm;?>">
                                        <input type="hidden" name="obat_luar" id="obat_luar">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <p class="col-sm-3 form-control-label">Total Akhir</p>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" name="vtot"
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button class="btn btn-primary" type="button" id="simpan_edit_obat_farmasi">simpan Obat</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php echo form_open('farmasi/Frmcdaftar/edit_obat_farmasi_luar'); ?>
            <!-- Modal Edit Obat -->
            <div class="modal fade" id="editModalFarmasiLuar" role="dialog" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog modal-success">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-sm-1"></div>
                                <p class="col-sm-3 form-control-label">Nama Obat Luar</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_nama_obat_farmasi_luar" id="edit_nama_obat_farmasi_luar" disabled="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <select id="id_obat_new" class="form-control select2" name="id_inven" style="width:100%">
                                            <option value="">-Pilih Obat-</option>
                                            <?php
                                            foreach($data_obat as $row){
                                                echo '<option value="'.$row->id_inventory.'">'.$row->nm_obat.' '.'-'.'(batch: '.$row->batch_no.')-(stock:'.$row->qty.')</option>';
                                            }
                                            ?>
                                        </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Biaya Obat</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_biaya_farmasi_luar" id="edit_biaya_farmasi_luar" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Signa</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_signa_farmasi_luar" id="edit_signa_farmasi_luar" >
                                        <option value="">-Pilih Signa-</option>
                                        <?php
                                            foreach ($satuan_signa as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Qtx</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_qtx_farmasi_luar" id="edit_qtx_farmasi_luar" >
                                        <option value="">-Pilih Qtx-</option>
                                        <?php
                                            foreach ($qtx as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Satuan</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_satuan_farmasi_luar" id="edit_satuan_farmasi_luar" >
                                        <option value="">-Pilih Satuan-</option>
                                        <?php
                                            foreach ($satuan as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Cara Pakai</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_cara_pakai_farmasi_luar" id="edit_cara_pakai_farmasi_luar" >
                                        <option value="">-Pilih Cara Pakai-</option>
                                        <?php
                                            foreach ($cara_pakai as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Quantity</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_qty_farmasi_luar" id="edit_qty_farmasi_luar"
                                           onkeyup="set_total_new(this.value)">
                                    <input type="hidden" name="edit_qty_farmasi_luar_hidden" id="edit_qty_farmasi_luar_hidden">
                                    <input type="hidden" name="edit_no_register_far_luar" id="edit_no_register_far_luar">
                                    <input type="hidden" name="edit_id_resep_dokter_far_luar" id="edit_id_resep_dokter_far_luar">
                                    <input type="hidden" name="pelayan" id="pelayan" value="<?php echo $pelayan; ?>">
                                    <input type="hidden" class="form-control" value="<?php echo $kelas_pasien; ?>"
                                        name="kelas_pasien">
                                    <input type="hidden" class="form-control" value="<?php echo $cara_bayar; ?>"
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Total Akhir</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_total_akhir_luar"
                                           id="edit_total_akhir_luar" min="0" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_qty_racikan" id="edit_qty_racikan"
                                           onkeyup="set_total_harga_racikan(this.value)">
            ...
            <?php echo form_open('farmasi/Frmcdaftar/edit_obat_racikan_farmasi'); ?>
           
            <!-- Modal Edit Obat -->
            <div class="modal fade" id="editModalracikanFarmasi" role="dialog" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog modal-success">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Id Obat</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_id_obat_racikan_far" id="edit_id_obat_racikan_far"
                                           disabled="">
                                    <input type="hidden" class="form-control" name="edit_id_obat_racikan_far_hidden"
                                           id="edit_id_obat_racikan_far_hidden">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-1"></div>
                                <p class="col-sm-3 form-control-label">Nama Obat</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_nama_obat_racikan_far" id="edit_nama_obat_racikan_far" disabled="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Dosis</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_dosis_obat_racikan_far"
                                           id="edit_dosis_obat_racikan_far" min="0" disabled="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Quantity</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_qty_racikan_far" id="edit_qty_racikan_far"
                                           onkeyup="set_total_harga_racikan(this.value)">
                                    <input type="hidden" name="edit_qty_racikan_far_hidden" id="edit_qty_racikan_far_hidden">
                                    <input type="hidden" name="edit_no_register_racikan_far" id="edit_no_register_racikan_far">
                                    <input type="hidden" name="edit_id_resep_pasien_racikan_far" id="edit_id_resep_pasien_racikan_far">
                                    <input type="hidden" name="pelayan_racikan_far" id="pelayan_racikan_far" value="<?php echo $pelayan; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <p class="col-sm-3 form-control-label">Obat Substitusi</p>
                                <div class="col-sm-6">
                                    <select id="obatsubtitusiracik" name="cari_obat_sub_racik" class="form-control" width="100%" onchange="ajaxracik(this.value)">
                                        <option value="">Obat substitusi tidak tersedia</option>
                                    </select>
                                    <input type="hidden" name="nm_sub" id="idtindakansubracik">
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Batch</p>
                                <div class="col-sm-6">
                                    <select id="pilihbatchracik" name="batch_farmasi_racik" class="form-control" width="100%" onchange="ajaxbiayaobatracik(this.value)">
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Biaya Obat</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_biaya_obat_racik"
                                           id="edit_biaya_obat_racik" min="0">
                                </div>
                            </div>
        ...
        <?php echo form_close(); ?>
            ...
            <div class="modal fade" id="paketobat" role="dialog" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog modal-success">
                    ...
                    <!-- Modal content-->
                    <div class="modal-content">
                    <?php echo form_open('farmasi/Frmcdaftar/insert_paket_obat'); ?>
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<form method="POST" id="embalase_form" class="form-horizontal">
    <!-- Modal Edit Obat -->
    <div class="modal fade" id="bhpPetugas"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Embalase</h4>
                </div>
                <div class="modal-body">
					<div class="form-group row">
						<div class="col-sm-1"></div>
						<p class="col-sm-3 form-control-label">Nama Obat</p>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="edit_obat" id="edit_obat" disabled="">
					...
					<div class="form-group row">
						<div class="col-sm-1"></div>
						<p class="col-sm-3 form-control-label">Tarif Embalase</p>
						<div class="col-sm-6">
							<select name="edit_embalase" id="edit_embalase" class="form-control select2">
								<option value="">-- Pilih Embalase --</option>
								<?php
								foreach($tarif_embalase as $r) {
									echo '<option value="'.$r->idtindakan.'@'.$r->total_tarif.'">'.$r->nmtindakan.'</option>';
								}
								?>
							</select>
						</div>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                  <button class="btn btn-primary" type="submit" id="btn-embalase">Edit</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
 function insert_petugas(id) {
    $.ajax({
      type:'POST',
      dataType: 'json',
      url:"<?php echo base_url('farmasi/frmcdaftar/get_data_resep_by_id')?>",
      data: {
        id: id
      },
      success: function(data){
        //console.log(data);
        $('#edit_obat').val(data[0].nama_obat);
		$('#edit_id_hidden').val(data[0].id_resep_pasien);
...
$('#embalase_form').on('submit', function(e){  
        e.preventDefault();             
        document.getElementById("btn-embalase").innerHTML = '<i class="fa fa-spinner fa-spin" ></i> Menyimpan...';
        $.ajax({  
          url:"<?php echo base_url(); ?>farmasi/frmcdaftar/insert_tarif_embalase",                         
          method:"POST",  
          ...
          success: function(data)  
          { 
            document.getElementById("btn-embalase").innerHTML = 'Edit';
            $('#bhpPetugas').modal('hide'); 
            document.getElementById("embalase_form").reset();
            swal({
									title: "Selesai",
      ...
      $("#simpan_edit_obat_farmasi_racikan").click(function(){
        let data = $('#form_edit_obat_farmasi_racikan').serialize();
        $.ajax({  
          url:"<?php echo base_url(); ?>farmasi/frmcdaftar/edit_obat_farmasi_racikan",                         
          method:"POST",  
          data:data,  
          success: function(data)  
          { 
    ...
    //   simpan edit obat farmasi
      $('#simpan_edit_obat_farmasi').click(function(){
        let data = $("#form_edit_obat_farmasi").serialize();
        $.ajax({  
          url:"<?php echo base_url(); ?>farmasi/frmcdaftar/edit_obat_farmasi",                         
          method:"POST",  
          data:data,  
          success: function(data)  
          { 
