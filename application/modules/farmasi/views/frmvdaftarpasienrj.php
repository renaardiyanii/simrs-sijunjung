...
var site = "<?php echo site_url();?>";
	...
	$(document).ready(function() {
        ...
        objTable = $('#example2').DataTable( {
            ajax: "<?php echo site_url('farmasi/frmcdaftar/get_data_pasien_rj'); ?>",
            columns: [
                { data: "no" },
                { data: "tgl_kunjungan" },
                { data: "no_cm" },
        ...
        $("#find_by_date").click(function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: { tgl: tgl },
                url: "<?php echo site_url('farmasi/frmcdaftar/get_data_pasien_rj'); ?>",
        ...
        $("#find_by_noreg").click(function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: { key: key },
                url: "<?php echo site_url('farmasi/frmcdaftar/get_data_pasien_noreg_rj'); ?>",
                success: function( response ) {
                    objTable.clear().draw();
                    objTable.rows.add(response.data);
                    objTable.columns.adjust().draw();
