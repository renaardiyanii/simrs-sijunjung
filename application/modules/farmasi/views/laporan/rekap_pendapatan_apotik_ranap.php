...
<script>
	...
	function excel() {
		window.location.href = `<?php echo site_url('farmasi/Frmclaporan/rekap_pendapatan_apotik_ranap'); ?>?bulan=${$('#bulan').val()}&carabayar=${$('#carabayar').val()}&idrg=${$('#idrg').val()}`
	}
	...
	function rekap() {
		...
		$.ajax({
			url: `<?php echo site_url('farmasi/Frmclaporan/rekap_pendapatan_apotik_ranap'); ?>?bulan=${bulan}&carabayar=${carabayar}&json=true&idrg=${idrg}`,
			...
			<div class="col-md-4">
				<div class="form-group">
					<select class="form-control" id="idrg">
						<option value="semua" selected="">---- Pilih Ruang ----</option>
...
<div class="card p-4">
	<div class="card-header">
		<div style="text-align:center;font-size:16px">
			<h4>Rekap Pendapatan Apotik Rawat Inap</h4>
		</div>
	</div>
	<div class="card-body">
