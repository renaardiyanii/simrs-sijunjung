...
<div class="row">
        ...
        <div class="ribbon-wrapper card">
            ...
            <div class="ribbon-content">
                <form id="form_resep_pasien">
                    ...
                    <input type="hidden" name="tgl_kunjungan" value="<?= isset($data_tindakan_pasien_dokter[0]->tgl_kunjungan )?$data_tindakan_pasien_dokter[0]->tgl_kunjungan :date('Y-m-d')?>">
                    ...
                    if(date('Y-m',strtotime($data_pasien_resep->tgl_masuk)) < '2025-04' and substr($no_register, 0, 2) == 'RI'){ ?>
                            ...
                            ?>
                                    <tr id="resep-<?= $i ?>">
                                        <td width="20%">
                                            ...
                                            <input type="hidden" name="obat_pulang-<?= $i ?>" value="<?= $row->obat_pulang; ?>">
    ...
    <script>
        ...
        function simpanresep() {
            ...
            $.ajax({
                method: 'post',
                url: "<?php echo base_url('farmasi/Frmcdaftar/simpan_resep_pasien_new/1') ?>",
                data: data,
                beforeSend: function() {
                        ...
                        swal({
                            ...
                            function() {
                                if(roleid == '1028'){
                                    ...
                                    window.open('<?= base_url() ?>' + 'farmasi/Frmcdaftar/permintaan_obat_petugas_pulang?no_register='+noreg, '_self');
                                }else{
