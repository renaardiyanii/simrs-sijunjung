...
<script type='text/javascript'>
  ...
  $(document).ready(function() {
    ...
    $('#insert_form').on('submit', function(e) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>master/mctindakan_new/insert_master_tindakan",
        method: "POST",
    ...
    $('#delete_form').on('submit', function(e) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>master/mctindakan_new/soft_delete_tindakan/",
        method: "POST",
        data: new FormData(this),
        contentType: false,
        cache: false,
  ...
  function edit_tindakan(idtindakan) {
    ...
    $('#edit_nmtindakan').val("");
    $('#edit_tarif_tind').val("");
    $('#edit_id_poli_tind').val("");

    $.ajax({
      type: 'POST',
      dataType: 'json',
      url: "<?php echo base_url('master/mctindakan_new/get_data_edit_tindakan') ?>",
      data: {
        idtindakan: idtindakan
      },
      success: function(data) {
        console.log(data[0].id_poli);
        $('#edit_idtindakan').val(data[0].idtindakan);
        $('#edit_idtindakan_hide').val(data[0].idtindakan);
        $('#edit_nmtindakan').val(data[0].nmtindakan);
        $('#edit_tarif_tind').val(data[0].tarif);
        $('#edit_id_poli_tind').val(data[0].id_poli);
  ...
  function edit()
  {
    ...
    url = "<?php echo site_url('master/mctindakan_new/edit_tindakan_new')?>";  
  ...
  function aktifTindakan(idtindakan) {
    if (confirm('Yakin Mengaktifkan tindakan ini?')) {
      $('#modalLoading').modal('show');
      $.ajax({
        type: 'POST',
        url: "<?php echo base_url(); ?>master/mctindakan_new/active_tindakan/" + idtindakan,
        data: {
          idtindakan: idtindakan
        },
        contentType: false,
...
function nonAktifTindakan(idtindakan) {
  if (confirm('Yakin Ingin Mengnonaktifkan Tindakan ini?')) {
    ...
    $.ajax({
      type: 'POST',
      url: "<?php echo base_url(); ?>master/mctindakan_new/nonactive_tindakan/" + idtindakan,
      data: {
        idtindakan: idtindakan
      },
      contentType: false,
              ...
              <div class="modal-dialog modal-lg" style="max-width: 100%;">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-1"></div>
                      <p class="col-sm-3 form-control-label" id="lbl_biaya">TMNO</p>
                      <div class="col-sm-6">
                        <select class="form-control select2" style="width: 100%" name="tmno" id="tmno">
                          <option value="">-- Pilih --</option>
                          <option value="KECIL">KECIL</option>
                          <option value="SEDANG">SEDANG</option>
                          <option value="BESAR">BESAR</option>
                          <option value="KHUSUS I">KHUSUS I</option>
                          <option value="KHUSUS II">KHUSUS II</option>
                          <option value="KHUSUS III">KHUSUS III</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                      <div class="col-sm-1"></div>
                      <p class="col-sm-3 form-control-label" id="lbl_biaya">Poliklinik</p>
                      <div class="col-sm-6">
                        <select id="id_poli" class="form-control" name="id_poli">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-1"></div>
                      <p class="col-sm-3 form-control-label" id="lbl_nama">Tarif</p>
                      <div class="col-sm-6">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $row->instalasi; ?></td>
                  <td><?php echo $row->tarif; ?></td>
                   <td><?php echo $row->nmpoli; ?></td>
                ...
                <div class="modal-body">
                  <form action="#" id="formedit" class="form-horizontal">
                    ...
                    <div class="form-group row">
                      ...
                      <p class="col-sm-3 form-control-label" id="lbl_nama">Tarif</p>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="edit_tarif_tind" id="edit_tarif_tind" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <p class="col-sm-3 form-control-label" id="lbl_biaya">Poliklinik</p>
                      <div class="col-sm-6">
                        <select id="edit_id_poli_tind" class="form-control" name="edit_id_poli_tind">
                            <option value="" disabled selected="">-Pilih Poli-</option>
                            <?php 
                              foreach($poliklinik as $row){
                                echo '<option value="'.$row->id_poli.'">'.$row->nm_poli.'</option>';
