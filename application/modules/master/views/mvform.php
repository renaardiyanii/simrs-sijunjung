...
<script type='text/javascript'>
  ...
  $(document).ready(function() {
    ...
    $('#insert_form').on('submit', function(e){  
        ...
        $.ajax({  
          url:"<?php echo base_url(); ?>master/mcform/insert",                         
          method:"POST",  
      ...
      $('#insert_role_form').on('submit', function(e){  
        ...
        document.getElementById("btn-insert").innerHTML = '<i class="fa fa-spinner fa-spin" ></i> Menyimpan...';
        $.ajax({  
          url:"<?php echo base_url(); ?>master/mcform/insert_role_form",                         
          method:"POST",  
          data:new FormData(this),  
          contentType: false,  
          cache: false,  
  ...
  function hak_akses(id_form){
    ...
    $('#myModalRoleForm').on('shown.bs.modal', function (e) {
      $('#id_form').val(id_form);
      $.ajax({  
        url:"<?php echo base_url(); ?>master/mcform/get_role_form/"+id_form,                           
        success: function(data)  
        { 
          var listForm = [];
          data.data.map((val)=>{
          ...
          <div class="demo-checkbox">
                <input class="filled-in" type="checkbox" name="role[]" value="1" id="administrator_hakakses" ${listForm.includes('1')?'checked':''}>
                <label for="administrator_hakakses">Administrator</label>

                <input class="filled-in" type="checkbox" name="role[]" value="dokter_dpjp" id="dokter_dpjp" ${listForm.includes('dokter_dpjp')?'checked':''}>
                <label for="dokter_dpjp">Dokter DPJP</label>

                <input class="filled-in" type="checkbox" name="role[]" value="Dokter Bersama" id="dokter_bersama" ${listForm.includes('Dokter Bersama')?'checked':''}>
                <label for="dokter_bersama">Dokter Bersama</label>

                <input class="filled-in" type="checkbox" name="role[]" value="Konsultasi 1x" id="konsultasi" ${listForm.includes('Konsultasi 1x')?'checked':''}>
                <label for="konsultasi">Kosultasi 1x ( Dokter Konsultasi )</label>

                <input class="filled-in" type="checkbox" name="role[]" value="DPJP sebelumnya" id="DPJP Sebelumnya" ${listForm.includes('DPJP sebelumnya')?'checked':''}>
                <label for="DPJP Sebelumnya">DPJP Sebelumnya</label>

                <input class="filled-in" type="checkbox" name="role[]" value="DPJP pengganti" id="dpjp_pengganti" ${listForm.includes('DPJP pengganti')?'checked':''}>
                <label for="dpjp_pengganti">DPJP pengganti</label>
                
                <input class="filled-in" type="checkbox" name="role[]" value="dokter_ruang_jaga" id="dokter_ruang_jaga" ${listForm.includes('dokter_ruang_jaga')?'checked':''}>
                <label for="dokter_ruang_jaga">Dokter Ruang Jaga</label>

                <input class="filled-in" type="checkbox" name="role[]" value="dokter_jaga" id="dokter_jaga" ${listForm.includes('dokter_jaga')?'checked':''}>
                <label for="dokter_jaga">Dokter Jaga</label>

                <input class="filled-in" type="checkbox" name="role[]" value="dokter_ruangan" id="dokter_ruangan" ${listForm.includes('dokter_ruangan')?'checked':''}>
                <label for="dokter_ruangan">Dokter Ruangan</label>

                <input class="filled-in" type="checkbox" name="role[]" value="case_manager" id="case_manager" ${listForm.includes('case_manager')?'checked':''}>
                ...
                <input class="filled-in" type="checkbox" name="role[]" value="Nutrisionis" id="Nutrisionis" ${listForm.includes('Nutrisionis')?'checked':''}>
                <label for="Nutrisionis">Nutrisionis</label>

                <input class="filled-in" type="checkbox" name="role[]" value="Farmatologi" id="Farmatologi" ${listForm.includes('Farmatologi')?'checked':''}>
                <label for="Farmatologi">Farmatologi</label>

                <input class="filled-in" type="checkbox" name="role[]" value="Fisioterapis" id="Fisioterapis" ${listForm.includes('Fisioterapis')?'checked':''}>
                <label for="Fisioterapis">Fisioterapis/Okupasi Terapi/Ortotik Prostetik/Terapi Wicara</label>

                <input class="filled-in" type="checkbox" name="role[]" value="Perawat Case Manager" id="Perawat Case Manager" ${listForm.includes('Perawat Case Manager')?'checked':''}>
                <label for="Perawat Case Manager">Perawat Case Manager</label>
