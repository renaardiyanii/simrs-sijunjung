...
<script type='text/javascript'>
  ...
  $(document).ready(function() {
      ...
      $('#edit_form').on('submit', function(e){  
        ...
        $.ajax({  
          url:"<?php echo base_url(); ?>master/mctindakan/update_tindakan_rad",                         
          method:"POST",  
          data:new FormData(this),  
          contentType: false,  
          cache: false,  
          ...
          success: function(data)  
          { 
            document.getElementById("btn-edit").innerHTML = 'Edit Tindakan Radiologi';
  ...
  function edit_tindakan(id) {
    $.ajax({
      type:'POST',
      dataType: 'json',
      url:"<?php echo base_url('master/mctindakan/get_data_edit_tindakan_rad')?>",
      data: {
        id: id
      },
      success: function(data){
        $('#edit_id_tindakan').val(data[0].idtindakan);
        $('#edit_id_tindakan_hidden').val(data[0].idtindakan);
        $('#edit_nama_tindakan').val(data[0].nmtindakan);
        $('#edit_modality').val(data[0].modality);
      },
      error: function(){
        alert("error");
      }
          ...
          <table id="example" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModalEdit" onclick="edit_tindakan('<?php echo $row->idtindakan;?>')"><i class="fa fa-edit"></i></button>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="col-sm-12">
                    <div class="form-group row">
                      <p class="col-sm-3 form-control-label" id="lbl_jenis_hasil">ID Tindakan</p>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="edit_id_tindakan" id="edit_id_tindakan" disabled>
                        <input type="hidden" class="form-control" name="edit_id_tindakan_hidden" id="edit_id_tindakan_hidden">
                      </div>
                    </div>
                    <div class="form-group row">
                      <p class="col-sm-3 form-control-label" id="lbl_jenis_hasil">Nama Tindakan</p>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="edit_nama_tindakan" id="edit_nama_tindakan">
                      </div>
                    </div>
                    <div class="form-group row">
                      <p class="col-sm-3 form-control-label" id="lbl_jenis_hasil">Modality</p>
                      <div class="col-sm-8">
                        <select name="edit_modality" id="edit_modality" class="form-control">
                        ...
                        <!-- <input type="text" class="form-control" name="edit_modality" id="edit_modality"> -->
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
