...
<div class="col-lg-12 col-md-12">
    <div style="background: #e4efe0">
        <div class="card">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="id_kebijakan" id="id_kebijakan" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-1"></div>
            ...
            <tbody id="bodyt">
              ...
              <tr>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#deleteModal" onclick="delete_kebijakan('<?php echo $row->id_kebijakan;?>')">Hapus Kebijakan</button>
                </td>
              </tr>
              <?php } ?>
            </tbody>
                ...
                <div class="modal-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <input type="hidden" class="form-control" name="edit_id_kebijakan_hidden" id="edit_id_kebijakan_hidden" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <p class="col-sm-3 form-control-label" id="lbl_keterangan">Keterangan</p>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" name="edit_keterangan" id="edit_keterangan" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-1"></div>
                    <p class="col-sm-3 form-control-label" id="lbl_nilai">Nilai</p>
                    <div class="col-sm-6">
                      <input type="number" class="form-control" name="edit_nilai" id="edit_nilai" required>
                    </div>
                  </div>
          ...
          <?php echo form_open('master/mcobat/delete_kebijakan');?>
          <!-- Modal Edit Obat -->
          <div class="modal fade" id="deleteModal" role="dialog" data-backdrop="static" data-keyboard="false">
            ...
            <input type="hidden" class="form-control" name="delete_id" id="delete_id">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title">Yakin mau hapus Diagnosa?</h4>
                </div>
                <div class="modal-footer">
