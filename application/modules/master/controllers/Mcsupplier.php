...
class Mcsupplier extends Secure_area {
	...
	public function soft_delete_supplier($id_supplier){
		$result = $this->Mmsupplier->soft_delete_supplier($id_supplier);
		echo json_encode($result);
		// redirect('master/Mcsupplier');
	}

	public function active_supplier($id_supplier){
		$this->Mmsupplier->active_supplier($id_supplier);
		redirect('master/Mcsupplier');
