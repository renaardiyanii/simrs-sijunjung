...
class Mcpoli extends Secure_area {
	...
	public function index(){
	    ...
	    //echo json_encode( array('data'=> $data['poli']) );
	}
	...
	public function edit_poli(){
		...
		if(!$data['active'] || $data['active'] == null || !isset($data['active'])){
			unset($data['active']);
		}
	...
	public function test_poli($id_poli){		
		$this->load->view('master/mvpoli_mdb');
	}

	public function soft_delete_poli($id_poli){
		$result = $this->mmpoli->soft_delete_poli($id_poli);
		echo json_encode($result);
		// redirect('master/Mcpoli');
	}

	public function active_poli($id_poli){
		$result = $this->mmpoli->active_poli($id_poli);
		// redirect('master/Mcpoli');
		echo json_encode($result);
	}
