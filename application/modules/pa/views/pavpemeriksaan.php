	...
	$(document).ready(function() {
		...
		var idpollllmantap = '<?php echo $idrg ?>';
		  ...
		  $("#update_rujukan_pa").submit(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url().'pa/pacdaftar/update_rujukan_penunjang'; ?>",
				dataType: "JSON",
				...
				success: function(data){   
					...
					if (data.status == true) {
						if(noreg.substr(0,2) == 'RI'){
							location.href = '<?php echo base_url().'iri/rictindakan/form/pa/'; ?>'+noreg;
						}else{
							if(idpollllmantap == 'BA00'){
								location.href = '<?php echo base_url().'ird/rdcpelayanan/form/pa/' ?>'+noreg;
							}else{
	                                ...
	                                <div class="tab-content">
										...
										?>
											...
											<div class="form-group row">
																<label class="control-label text-right col-md-2" id="lbl_biaya_periksa">Tanggal</label>
																<div class="col-sm-3">
