...
<body class="A4">
	<div class="A4 sheet  padding-fix-10mm">
		...
		<div>
			<b>Jenis Pemeriksaan : <?php echo isset($data_hasil_pa[0]->jenis_tindakan) ? $data_hasil_pa[0]->jenis_tindakan : '' ?></b><br>
			
			<p>Hasil Pengirim</p>
			<pre style="font-size:12px"><?php echo isset($data_hasil_pa[0]->hasil_pa) ? $data_hasil_pa[0]->hasil_pa : '' ?></pre>
			<hr>
		</div>
