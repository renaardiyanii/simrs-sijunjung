...
class Frmckwitansi extends Secure_area{
	...
	public function kwitansi()
	{
		...
		$data['daftar_farmasi']=$this->Frmmkwitansi->get_list_kwitansi_rj()->result();
	...
	public function kwitansi_pasien_rj($no_register = '') {
		...
		//if($no_resep!=''){
			...
			// 	$data['data_adm']=array();
			// }
			//$data['data_permintaan']=$this->Frmmkwitansi->get_data_permintaan_rj($no_register)->row();
	...
	public function st_cetak_kwitansi_kt()
	{
		...
		$data_pasien=$this->Frmmkwitansi->get_data_pasien_rj($no_register)->row();
		...
		$getvtotobat=$this->Frmmkwitansi->get_data_permintaan_rj($no_register)->row()->vtot_obat;
		...
		$user = $login_data->username;
			...
			$datak['asal'] = $data_pasien->id_poli;
	...
	public function cetak_faktur_kt($no_resep=''){
		...
		if($no_resep!=''){
			...
			$mpdf->WriteHTML($html);
			$mpdf->Output();
			// $this->load->view('paper_css/faktur_farmasi',$data);
		}
	...
	public function cetak_kwitansi_kt($no_register='',$penyetors = '', $diskon=""){
		...
		//$data['no_resep'] = $no_resep;
			$data['data_pasien']=$this->Frmmkwitansi->get_data_pasien_rj($no_register)->row();
			$data['datpasien']=$this->Frmmkwitansi->get_data_pasien_rj($no_register)->row();
