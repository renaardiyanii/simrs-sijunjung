...
select: function (event, ui) {
    ...
    function edit_obat_farmasi(id_resep_dokter,id_obat) {
        $.ajax({
            type: 'POST',
            dataType: 'json',
    ...
    function ajaxbiayaobatracik(id)
    {
        let idobat = $('#pilihbatchracik').val();
        console.log(idobat);
        $.ajax({
            url: '<?= base_url('farmasi/Frmcdaftar/get_biaya_obat/') ?>'+idobat,
            beforeSend: function() {
            ...
            success: function(data) {
               console.log(data)
               $('#edit_biaya_obat_racik').val(data.hargajual);
            //    $('#biaya_obat_hide').val(data.hargajual);
            //    $('#idtindakansub').val(data.nm_obat_substitusi);
            set_total_harga_racikan();
...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row->racikan == '1') { ?>
                                                <a href="<?php echo site_url("farmasi/Frmcdaftar/hapus_data_obat_racik/".$pelayan."/". $row->no_register . "/" . $row->id_resep_dokter. "/". $row->qty); ?>"class="btn btn-danger btn-xs">Hapus</a>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php }else { ?>
                                                    <?php if($row->id_obat == null){ ?>
                                                     ...
                                                     <?php }else{ ?>
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModalFarmasi" onclick="edit_obat_farmasi(<?php echo $row->id_resep_dokter;?>,<?php echo $row->id_obat;?>)">Detail Obat</button>
                                                    <?php   } ?>
                                                <?php } ?>
                                        ...
                                        <td>
                                            ...
                                            if ($row->racikan == '1') {
                                                foreach ($data_tindakan_racik as $row1) {
                                                    if ($row->id_resep_dokter == $row1->id_resep_pasien) {
            ...
            <?php echo form_open('farmasi/Frmcdaftar/edit_obat_farmasi'); ?>
            <!-- Modal Edit Obat -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_id_obat_farmasi" id="edit_id_obat_farmasi"
                                           disabled="">
                                    <input type="hidden" class="form-control" name="edit_id_obat_farmasi_hidden"
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Nama Obat</p>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_nama_obat_farmasi" id="edit_nama_obat_farmasi" disabled="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="edit_biaya_obat"
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Signa</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_signa_farmasi" id="edit_signa_farmasi" >
                                        <option value="">-Pilih Signa-</option>
                                        <?php
                                            foreach ($satuan_signa as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Qtx</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_qtx_farmasi" id="edit_qtx_farmasi" >
                                        <option value="">-Pilih Qtx-</option>
                                        <?php
                                            foreach ($qtx as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Satuan</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_satuan_farmasi" id="edit_satuan_farmasi" >
                                        <option value="">-Pilih Satuan-</option>
                                        <?php
                                            foreach ($satuan as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Cara Pakai</p>
                                <div class="col-sm-8">
                                    <select class="form-control" style="width: 100%" name="edit_cara_pakai_farmasi" id="edit_cara_pakai_farmasi" >
                                        <option value="">-Pilih Cara Pakai-</option>
                                        <?php
                                            foreach ($cara_pakai as $row) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <p class="col-sm-3 form-control-label">Quantity</p>
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="edit_qty_farmasi" id="edit_qty_farmasi"
                                           onkeyup="set_total_new(this.value)" min="1">
                                    <input type="hidden" name="edit_qty_farmasi_hidden" id="edit_qty_farmasi_hidden">
                                    <input type="hidden" name="edit_no_register_far" id="edit_no_register_far">
                                    <input type="hidden" name="edit_id_resep_dokter_far" id="edit_id_resep_dokter_far">
                                    <input type="hidden" name="pelayan" id="pelayan" value="<?php echo $pelayan; ?>">
                                    <input type="hidden" class="form-control" value="<?php echo $kelas_pasien; ?>"
                                        name="kelas_pasien">
                                    <input type="hidden" class="form-control" value="<?php echo $cara_bayar; ?>"
