            ...
            <br>
				...
				<table class="table-font-size1" border="1">
                    <tr>
                        ...
                        <th><p align="center">Nama Item</p></th>
                        <th><p align="center">Harga</p></th>
                        <th><p align="center">Banyak</p></th>
                    ...
                    <?php $i=1;
						...
						<tr>
                            ...
                            <td><p style="font-size:11px"><?php echo $row->nama_obat ?></p></td>
                            <td><p style="font-size:11px"><?php echo number_format($row->biaya_obat + $row->embalase) ?></p></td>
                            <td><p style="font-size:11px"><?php echo $row->qty ?></p></td>
                            <td><p style="font-size:11px"><?php echo number_format($row->vtot + $row->embalase);
                            //$jumlat_vtot += $row->vtot + $row->embalase; ?></p></td>
                        </tr>
                   ...
                   <?php } //if($cara_bayar=='BPJS'){
                    ...
                    <?php //} ?>
                       ...
                       <?php $vtot_terbilang=$cterbilang->terbilang($jumlah_vtot); ?>
                                ...
                                <tr></hr></br>
                                    <th colspan="4"><p class="table-font-size1" align="right">Jumlah   </p></th>
                                    <th bgcolor="yellow"><p class="table-font-size1" align="right"><?= number_format( $jumlah_vtot, 2 , ',' , '.' )?></p></th>
                                </tr>
                                <?php if($cara_bayar == 'BPJS') { ?>
                                    <tr></hr></br>
                                    <th colspan="4"><p class="table-font-size1" align="left">Biaya yang dibayar oleh pasien sebesar 0 rupiah (Ditanggung BPJS)</p></th>
                                </tr>
                                <?php }  ?>
                               <?php  
