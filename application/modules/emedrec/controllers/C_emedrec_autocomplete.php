...
class C_emedrec_autocomplete extends Secure_area {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////registrasi
	public function data_pasien_by_nomedrec(){
			$keyword = $this->uri->segment(4);
			$data = $this->db->from('data_pasien')
			->like('cast(no_medrec as text)',$keyword)
			->limit(12, 0)->get()->result();
