...
<body class="A4">
    ...
    <?php $this->load->view('emedrec/rj/header_print') ?>
                ...
                <div class="border-all" style="font-size:12px">
                    ...
                    <div>
                        ...
                        <div class="margintoright">
                            <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data->cara_masuk)?$data->cara_masuk == 'other'?"checked":'':"") ?>>
                            <span class="margin-text">Rujukan, dari <?= isset($data->{'cara_masuk-Comment'})?$data->{'cara_masuk-Comment'}:'' ?></span>
                        </div>
                        ...
                        <div class="two-row">
                            ...
                            <div>
                                ...
                                <div class="titlewithcheckbox">
                                    <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data-> death_of_arival)?in_array('tanda_kehidupan',$data->death_of_arival)?'checked':'':'') ?>>
                                    <span class="margin-text">Tanda Kehidupan</span>
                                    <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data-> death_of_arival)?in_array('ekg_flat',$data->death_of_arival)?'checked':'':'') ?>>
                                    <span class="margin-text">EKG Flat</span>
                                    <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data-> death_of_arival)?in_array('tidak_ada_denyut_nadi',$data->death_of_arival)?'checked':'':'') ?>>
                                    <span class="margin-text">Tidak ada denyut nadi</span>
                                    <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data-> jam_doa1)?in_array('jam_doa',$data->jam_doa1)?'checked':'':'') ?>>
                                    <span class="margin-text">Jam DOA : <?= (isset($data->jam_doa)?$data->jam_doa:'') ?> WIB</span><br>
                                    <input type="checkbox" id="neurologi" name="neurologi" value="neurologi" <?= (isset($data-> death_of_arival)?in_array('reflek_cahaya',$data->death_of_arival)?'checked':'':'') ?>>
            ...
            <p style="text-align:left;font-size:12px">Hal 1 dari 6</p>
        </div>
    </section>
    ...
    <?php $this->load->view('emedrec/rj/header_print_genap') ?>
            <div id="body" >
                ...
                <p style="text-align:left;font-size:12px">Hal 2 dari 6</p>
            </div>
        </div>
    ...
    <?php $this->load->view('emedrec/rj/header_print') ?>
                ...
                <div id="part1" style="font-size:12px">
                    ...
                    <!-- dirapihin -->
                        ...
                        <br><br>
                        <p style="text-align:left;font-size:12px">Hal 3 dari 6</p>
    ...
    <section class="sheet padding-10mm">
        ...
        <!-- added -->
                        ...
                        <!-- end -->
                        <p style="text-align:left;font-size:12px">Hal 4 dari 6</p>
                        </div>
    ...
    <section class="sheet padding-10mm">
        ...
        <div style="font-size:12px">
                ...
                <div>
                    ...
                    <p style="text-align:left;font-size:12px">Hal 5 dari 6</p>
                </div> 
    ...
    <section class="sheet padding-10mm">
        <?php $this->load->view('emedrec/rj/header_print_genap') ?>
            ...
            <table border="1" width="100%" >
                ...
                <p style="text-align:left;font-size:12px">Hal 6 dari 6</p>
            </div>
        </div>
    </section>
