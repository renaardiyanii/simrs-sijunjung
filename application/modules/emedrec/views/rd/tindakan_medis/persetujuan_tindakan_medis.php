    ...
    <tr>
        <td width="30%">
            <table border="0" width="100%">
                <tr>
                    <td width="8%"><img src="<?= base_url("assets/img/logo.png"); ?>" alt="img" height="60px" width="50px" style="padding-right:17px;"></td>
                    <td width="92%" style="vertical-align:middle"><h3>RSUD SIJUNJUNG</h3></td>
                </tr>
                <tr>
        ...
        <table border="1" width="100%" cellpadding="5px" style="margin-top:0px">
                <tr>
                    <td style="border: 1px solid black; padding: 8px; ">
                        <center>
                            <span style="font-size:17px;font-weight:bold;">PERSETUJUAN</span><br>
                            
                        </center>
                    </td>
                </tr>
                <tr>
                    <td style="border: 1px solid black; padding: 5px; font-size:12px; "><p>Yang bertanda tangan dibawah ini, Nama _________________________Umur ___________________________tahun<BR>
                    Alamat __________________________________________________________<br></p><br>
                    Dengan ini menyatakan <b>SETUJU</b> untuk dilakukan tindakan_____________________________________.<br>Terhadap saya/___________________________________saya,yang bernama__________________________________<br>
                    Tgl.Lahir____________________________Alamat________________________________________________<br>Dirawat di___________________________________________No.RM_________________________________<BR>
