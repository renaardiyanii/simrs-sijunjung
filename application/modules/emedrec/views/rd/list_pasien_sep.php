...
var urllistirj = "<?php echo base_url('emedrec/c_emedrec/get_sep_igd'); ?>";
var urlupdatesep = "<?php echo base_url('emedrec/c_emedrec/update_sep'); ?>";
	...
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			<div class="card-block">
                <?php //echo form_open('emedrec/c_emedrec/sep_irj');?>
        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Pasien IGD SEP Kosong</h4></div>					
