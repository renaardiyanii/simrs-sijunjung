      ...
      <div class="modal fade" id="myModal" role="dialog" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-success">
              ...
              <div class="modal-content">
                ...
                <?php
                  foreach ($data_pasien_irj as $row_data_pasien_irj) {
                    foreach($data_pasien as $row_data_pasien){
                ?>
                    <a type="button" class="list-group-item list-group-item-action" href="<?php echo site_url('emedrec/C_emedrec/cetak_asesmen_awal_keperawatan/'.$row_data_pasien->no_cm.'/'.$row_data_pasien_irj->noregister); ?>" target="_blank">ASESMEN AWAL KEPERAWATAN</a>
