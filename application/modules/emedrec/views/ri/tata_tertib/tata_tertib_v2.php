        ...
        <div class="A4 sheet  padding-fix-10mm">
            ...
            <ol style="list-style-type: upper-alpha;font-size: 13px;">
                <li>Tata Tertib Pasien, Penunggu dan Pengunjung Rumah Sakit Otak DR. Drs. M. Hatta  Bukittinggi</li>
                    <ol>
                        <li>Jam Berkunjung (bezuk) Pasien  : <br> a.Ruang Rawat Inap Panorama, Limpapeh, Merapi  :    : <br>Pagi : Jam 11.00 s/d 13.00 WIB <br> Sore : Jam 17.00 s/d 19.00 WIB <br><br> b.Ruang Rawat ICU dan HCU : <br>Pagi : Jam 11.00 s/d 12.00 WIB <br>Sore : Jam 17.00 s/d 18.00 WIB </li><br>
