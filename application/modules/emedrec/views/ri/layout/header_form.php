...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <img class="navbar-brand" src="<?php echo base_url('assets/images/rsud_sjj2.png'); ?>" width="200" alt="">
...
<div class="card m-5">
  ...
  <div class="card-body">
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?php echo $data_pasien[0]->nama?>">
        </div>
        <label for="no_medrec" class="col col-form-label">No. Medrec</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?php echo $data_pasien[0]->no_cm?>" >
        </div>
        <label for="no_medrec" class="col col-form-label">Tgl. Lahir</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?php echo date('d-m-Y',strtotime($data_pasien[0]->tgl_lahir))?>" >
        </div>
    </div>
  </div>
</div>
