...
<div style ="min-height:870px">
        <table id="data" border="1" cellspacing="2px" cellpadding="2px">
            <tr style="height: 50px;">
                <td class="text-center" style="width: 20%;">
                    <span>
                        Tanggal Masuk :<br><br><?= isset($data->tgl_masuk)?date('d-m-Y',strtotime($data->tgl_masuk)):''; ?>
                    </span>
                </td>
            ...
            <tr>
                <td class="text-center" colspan="2">
                    <span>Dokter yang merawat</span><br><br>
                    <span><?= isset($data->dokter_yang_merawat)?Explode('-',$data->dokter_yang_merawat)[0]:(isset($data->merawat)?Explode('-',$data->merawat)[0]:''); ?></span>
                </td>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <label for="">Nadi : <?= isset($data->nadi)?$data->nadi:''; ?> X/menit</label>
                    <br>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <table>
                        <tr>
                            <td style="width: 25%;font-size:9pt;"><b>INFORMASI MEDIS</b></td>
                            <td style="width: 25%;font-size:9pt;"><b>Gangguan</b></td>
                            <td style="width: 25%;font-size:9pt;"><b>Inkontinensia</b></td>
                            <td style="width: 25%;font-size:9pt;"><b>Potensial untuk dilakukan rehabilitasi</b></td>
                        </tr>
                        <tr>
