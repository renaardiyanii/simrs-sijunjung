                    ...
                    <header style="margin-top:20px; font-size:1pt!important;">
                        <!-- <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td><span>
                                    <barcode code="<?php echo isset($pasien->no_cm)?$pasien->no_cm:''; ?>" type="EAN13" height="0.5" />
                                </span></td>
                            </tr>
        ...
        <?php }elseif($kode_jenis == 'MD'){ ?>
            <?php if($jsond != null){ ?>
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <p style="font-size:12px">Dokter Ruangan : <?= isset($dokter_ruangan->nm_dokter)?$dokter_ruangan->nm_dokter:'' ?></p>
