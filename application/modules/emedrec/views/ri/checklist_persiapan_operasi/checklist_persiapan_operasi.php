...
$result = array_chunk($persiapan_operasi, 1);
//  var_dump($data->question2);
?>
<head>
       <title></title>
   </head>
    ...
    if($result){
        ...
        <div class="A4 sheet  padding-fix-10mm">
            ...
            <div style="font-size:12px">
                        ...
                        <td width="50%">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="2%">:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 1'})?$value->question10->{'Row 1'}->{'Column 1'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Diagnosis</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 2'})?$value->question10->{'Row 1'}->{'Column 2'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Dokter Bedah</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 3'})?$value->question10->{'Row 1'}->{'Column 3'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Dokter Anestesi</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 4'})?$value->question10->{'Row 1'}->{'Column 4'}:'' ?></td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td width="50%">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="2%">:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 5'})?$value->question10->{'Row 1'}->{'Column 5'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Jenis Pembiusan</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 6'})?$value->question10->{'Row 1'}->{'Column 6'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Dokter Anestesi</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 7'})?$value->question10->{'Row 1'}->{'Column 7'}:'' ?></td>
                                </tr>
                                <tr>
                                    <td>Sifat Operasi</td>
                                    <td>:</td>
                                    <td><?= isset($value->question10->{'Row 1'}->{'Column 8'})?$value->question10->{'Row 1'}->{'Column 8'}:'' ?></td>
                                </tr>
                            </table>
                        </td>
              ...
              <table width="100%" id="value" border="1" cellpadding="2px">
                <tr>
                    <th width="10%">No</th>
                    <th>Persiapan</th>
                    <th width="10%">Ya</th>
                ...
                <tr>
                    ...
                    <td style="text-align:center"><?php echo isset($value->question1->item1->{'column1'})? $value->question1->item1->{'column1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question1->item1->{'column1'})? $value->question1->item1->{'column1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>b.	Administrasi Keuangan</td>
                    <td style="text-align:center"><?php echo isset($value->question1->item2->{'column1'})? $value->question1->item2->{'column1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question1->item2->{'column1'})? $value->question1->item2->{'column1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>c.	SJPK / Askes</td>
                    <td style="text-align:center"><?php echo isset($value->question1->item3->{'column1'})? $value->question1->item3->{'column1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question1->item3->{'column1'})? $value->question1->item3->{'column1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>d.	Status Pasien</td>
                    <td style="text-align:center"><?php echo isset($value->question1->item4->{'column1'})? $value->question1->item4->{'column1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question1->item4->{'column1'})? $value->question1->item4->{'column1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>b.	Rontgent</td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 1'}->{'Column 1'})? $value->question7->{'Row 1'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 1'}->{'Column 1'})? $value->question7->{'Row 1'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>c.	EKG</td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 2'}->{'Column 1'})? $value->question7->{'Row 2'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 2'}->{'Column 1'})? $value->question7->{'Row 2'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>d.	Laboratorium</td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 3'}->{'Column 1'})? $value->question7->{'Row 3'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 3'}->{'Column 1'})? $value->question7->{'Row 3'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>e.	Echo</td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 4'}->{'Column 1'})? $value->question7->{'Row 4'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 4'}->{'Column 1'})? $value->question7->{'Row 4'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>f.	Lain – lain :  <?= isset($value->question8)?$value->question8:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 5'}->{'Column 1'})? $value->question7->{'Row 5'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question7->{'Row 5'}->{'Column 1'})? $value->question7->{'Row 5'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>a.	TTV</td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 1'})? $value->question2->{'Row 1'}->{'Column 1'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 1'})? $value->question2->{'Row 1'}->{'Column 1'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>b.	Makan terakhir : jam : <?= isset($value->question2->{'Row 1'}->{'Column 3'})?$value->question2->{'Row 1'}->{'Column 3'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 2'})? $value->question2->{'Row 1'}->{'Column 2'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 2'})? $value->question2->{'Row 1'}->{'Column 2'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>c.	Pre medikasi : jam : <?= isset($value->question2->{'Row 1'}->{'Column 5'})?$value->question2->{'Row 1'}->{'Column 5'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 4'})? $value->question2->{'Row 1'}->{'Column 4'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 4'})? $value->question2->{'Row 1'}->{'Column 4'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>d.	Levement : jam : <?= isset($value->question2->{'Row 1'}->{'Column 7'})?$value->question2->{'Row 1'}->{'Column 7'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 6'})? $value->question2->{'Row 1'}->{'Column 6'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 6'})? $value->question2->{'Row 1'}->{'Column 6'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>e.	Persiapan kulit / cukur <?= isset($value->question2->{'Row 1'}->{'Column 9'})?$value->question2->{'Row 1'}->{'Column 9'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 8'})? $value->question2->{'Row 1'}->{'Column 8'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 8'})? $value->question2->{'Row 1'}->{'Column 8'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>f.	Vagina toilet <?= isset($value->question2->{'Row 1'}->{'Column 16'})?$value->question2->{'Row 1'}->{'Column 16'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 10'})? $value->question2->{'Row 1'}->{'Column 10'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 10'})? $value->question2->{'Row 1'}->{'Column 10'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>g.	Pengosongan kandung kemih : jam : <?= isset($value->question2->{'Row 1'}->{'Column 12'})?$value->question2->{'Row 1'}->{'Column 12'}:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 11'})? $value->question2->{'Row 1'}->{'Column 11'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 11'})? $value->question2->{'Row 1'}->{'Column 11'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>h.	Perhiasan</td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 13'})? $value->question2->{'Row 1'}->{'Column 13'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 13'})? $value->question2->{'Row 1'}->{'Column 13'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>i.	Gigi palsu </td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 14'})? $value->question2->{'Row 1'}->{'Column 14'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 14'})? $value->question2->{'Row 1'}->{'Column 14'} == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>j.	Pewarna kuku</td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 15'})? $value->question2->{'Row 1'}->{'Column 15'} == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question2->{'Row 1'}->{'Column 15'})? $value->question2->{'Row 1'}->{'Column 15'} == "0" ? "✓":'':'' ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>a.	Darah	: <?= isset($value->question3->darah->column2)?$value->question3->darah->column2:'' ?> cc</td>
                    <td style="text-align:center"><?php echo isset($value->question3->darah->column1)? $value->question3->darah->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question3->darah->column1)? $value->question3->darah->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>b.	Infus	    : <?= isset($value->question3->infus->column2)?$value->question3->infus->column2:'' ?> cc </td>
                    <td style="text-align:center"><?php echo isset($value->question3->infus->column1)? $value->question3->infus->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question3->infus->column1)? $value->question3->infus->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>c.	Jenis	: <?= isset($value->question3->jenis->column2)?$value->question3->jenis->column2:'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question3->jenis->column1)? $value->question3->jenis->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question3->jenis->column1)? $value->question3->jenis->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center"><?php echo isset($value->question4->diabetes->column1)? $value->question4->diabetes->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->diabetes->column1)? $value->question4->diabetes->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>b. Hipertensi</td>
                    <td style="text-align:center"><?php echo isset($value->question4->hipertensi->column1)? $value->question4->hipertensi->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->hipertensi->column1)? $value->question4->hipertensi->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>c.	Asma</td>
                    <td style="text-align:center"><?php echo isset($value->question4->asma->column1)? $value->question4->asma->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->asma->column1)? $value->question4->asma->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>d.	Jantung</td>
                    <td style="text-align:center"><?php echo isset($value->question4->jantung->column1)? $value->question4->jantung->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->jantung->column1)? $value->question4->jantung->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>e.	Ginjal</td>
                    <td style="text-align:center"><?php echo isset($value->question4->ginjal->column1)? $value->question4->ginjal->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->ginjal->column1)? $value->question4->ginjal->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>f.	Alergi obat / makanan : <?= isset($value->lergi)?$value->lergi:''?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->alergi->column1)? $value->question4->alergi->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->alergi->column1)? $value->question4->alergi->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
                <tr>
                    
                    <td>g. Lain lain : <?= isset($value->question9)?$value->question9:''?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->lainya->column1)? $value->question4->lainya->column1 == "1" ? "✓":'':'' ?></td>
                    <td style="text-align:center"><?php echo isset($value->question4->lainya->column1)? $value->question4->lainya->column1 == "0" ? "✓":'':'' ?></td>
                </tr>
              ...
              <div style="display: inline; position: relative;">
                    ...
                    <div style="float: right;">
                        <span>Bukittinggi, <?= isset($val->tgl_input)? date('d-m-Y',strtotime($val->tgl_input)):'' ?></span>
