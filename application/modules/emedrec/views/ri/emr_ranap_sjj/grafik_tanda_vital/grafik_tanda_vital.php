...
<body class="A4">
    ...
    <tr>
        ...
        <td width="40%" style="vertical-align:middle">
            <center>
                <h3>CATATAN GRAFIK TANDA VITAL <br></h3>
            </center>
    ...
    <table border="1" width="100%" cellpadding="5px" style="margin-top:0px">
       ...
       <tr>
            <td colspan="4">
                ...
                <table border="1" width="100%" cellpadding="2">
                    <tr>
                        <th width="20%" colspan="4">TANGGAL</th>
                    ...
                    <tr>
                        <td width="20%" colspan="4">INFEKSI NOSOKOMIAL</td>
                    ...
                    <tr>
                        <td width="20%" colspan="4">BERAT BADAN</td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                    ...
                    <tr>
                        <td width="20%" colspan="4">TINGGI BADAN</td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                    ...
                    <tr>
                        <td width="20%" colspan="4">CAIRAN MASUK</td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                    ...
                    <tr>
                        <td width="20%" colspan="4">CAIRAN KELUAR</td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                        <td colspan="4" width="10%" ></td>
                ...
                <p> keterangan :</p>
                <p>TD = Tekanan darah , FP = Freg.Pernafasan, FN = Freg. Nadi, </p>
                <p>6,11,15,19 = Waktu pemeriksaan dilakukan  (jam/pukul)</p>
            </td>  
        </td>
       </tr>
