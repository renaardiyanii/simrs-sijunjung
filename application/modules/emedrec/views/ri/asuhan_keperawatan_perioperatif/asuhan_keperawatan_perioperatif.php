...
$result = array_chunk($asuhan_keperawatan, 1);
// var_dump($asuhan_keperawatan[1]->formjson->ttd_perawat);die();
?>
<head>
       <title></title>
   </head>
            ...
            <div style="font-size:12px">
                ...
                <table width="100%" id="pengkajian" cellpadding="3px" cellspacing="2px">
                    <tr>
                        ...
                        <td>
                            <span>
                            <span style="margin-right:20px">Suhu : <?= isset($value->question1->suhu)?$value->question1->suhu:'' ?></span>
                            <span style="margin-right:20px">Nadi : <?= isset($value->question1->nadi)?$value->question1->nadi:'' ?> x/mnt</span>
                            <span style="margin-right:20px">RR : <?= isset($value->question1->rr)?$value->question1->rr:'' ?> x/mnt</span>
                            <span style="margin-right:20px">TD : <?= isset($value->question1->td)?$value->question1->td:'' ?></span>
                            <span>Skor Nyeri : <?= isset($value->question1->skornyeri)?$value->question1->skornyeri:'' ?></span>
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->tingkat)?in_array("sadar", $value->question2[0]->tingkat)?'checked':'':'') ?>>
                                <span>Sadar Penuh</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->tingkat)?in_array("bingung", $value->question2[0]->tingkat)?'checked':'':'') ?>>
                                <span>Bingung</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->tingkat)?in_array("gelisah", $value->question2[0]->tingkat)?'checked':'':'') ?>>
                                <span>Gelisah</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->tingkat)?in_array("mengantuk", $value->question2[0]->tingkat)?'checked':'':'') ?>>
                                <span>Mengantuk</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->tingkat)?in_array("koma", $value->question2[0]->tingkat)?'checked':'':'') ?>>                              
                                <span>Koma</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->riwayat)?in_array("hipertensi", $value->question2[0]->riwayat)?'checked':'':'') ?>>
                                <span>Hipertensi</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->riwayat)?in_array("diabetes", $value->question2[0]->riwayat)?'checked':'':'') ?>>                          
                                <span>Diabetes</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->riwayat)?in_array("hepatitis", $value->question2[0]->riwayat)?'checked':'':'') ?>>                           
                                <span>Hepatitis</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->riwayat)?in_array("asma", $value->question2[0]->riwayat)?'checked':'':'') ?>>                      
                                <span>Asma</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->riwayat)?in_array("other", $value->question2[0]->riwayat)?'checked':'':'') ?>>                      
                                 <span>Lainnya : <?= isset($value->question2[0]->{'riwayat-Comment'})?$value->question2[0]->{'riwayat-Comment'}:'' ?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                <span style="margin-right:20px">Jenis Operasi : <?= isset($value->question2[0]->column1)?$value->question2[0]->column1:'' ?></span>
                                <span style="margin-right:20px">Kapan : <?= isset($value->question2[0]->kapan)?$value->question2[0]->kapan:'' ?> </span>
                                <span>Di : <?= isset($value->question2[0]->di)?$value->question2[0]->di:'' ?></span>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                                <input type="checkbox" value="Tidak" <?php echo isset($value->question2[0]->pengobatan)? $value->question2[0]->pengobatan == "tidak" ? "checked":'':'' ?>>
                                <span>Tidak Ada</span>
                                <input type="checkbox" value="Tidak" <?php echo isset($value->question2[0]->pengobatan)? $value->question2[0]->pengobatan == "tidak1" ? "checked":'':'' ?>>
                                <span>TIdak Diketahui</span>
                                <input type="checkbox" value="Tidak" <?php echo isset($value->question2[0]->pengobatan)? $value->question2[0]->pengobatan == "other" ? "checked":'':'' ?>>
                                <span>Ada,Jelaskan <?= isset($value->question2[0]->{'pengobatan-Comment'})?$value->question2[0]->{'pengobatan-Comment'}:'' ?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("dl", $value->question2[0]->hasillab)?'checked':'':'') ?>>
                                <span>DL</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("hcv", $value->question2[0]->hasillab)?'checked':'':'') ?>>                 
                                <span>HCV</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("pt", $value->question2[0]->hasillab)?'checked':'':'') ?>>                
                                <span>PT/APTT</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("goldar", $value->question2[0]->hasillab)?'checked':'':'') ?>>                    
                                <span>Gol Darah</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("urine", $value->question2[0]->hasillab)?'checked':'':'') ?>>                   
                                <span>Urine</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("hbsag", $value->question2[0]->hasillab)?'checked':'':'') ?>>                   
                                <span>HbsAG</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("hiv", $value->question2[0]->hasillab)?'checked':'':'') ?>>                 
                                <span>HIV</span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasillab)?in_array("other", $value->question2[0]->hasillab)?'checked':'':'') ?>>                   
                                <span>Lainnya <?= isset($value->question2[0]->{'hasillab-Comment'})?$value->question2[0]->{'hasillab-Comment'}:'' ?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasilrad)?in_array("thorax", $value->question2[0]->hasilrad)?'checked':'':'') ?>>                     
                                <span>Thorax : <?= isset($value->question2[0]->column2)?$value->question2[0]->column2:'...' ?></span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasilrad)?in_array("extremitas", $value->question2[0]->hasilrad)?'checked':'':'') ?>>                         
                                <span>Extremitas : <?= isset($value->question2[0]->column3)?$value->question2[0]->column3:'...' ?></span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasilrad)?in_array("ct", $value->question2[0]->hasilrad)?'checked':'':'') ?>>                 
                                <span>CT Scan : <?= isset($value->question2[0]->column4)?$value->question2[0]->column4:'...' ?></span>
                                <input type="checkbox" value="Tidak" <?= (isset($value->question2[0]->hasilrad)?in_array("mri", $value->question2[0]->hasilrad)?'checked':'':'') ?>>                  
                                <span>MRI : <?= isset($value->question2[0]->column5)?$value->question2[0]->column5:'...' ?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="5%">:</td>
                        <td>
                        <?= isset($value->question2[0]->diagnosa_sebelum)?$value->question2[0]->diagnosa_sebelum:'' ?>
                        </td>
                    </tr>
                ...
                <table id="data" cellspacing="2px" cellpadding="3px">
                    ...
                    <tr>
                        ...
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 1'})? $value->pasien->{'Row 1'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 1'})? $value->pasien->{'Row 1'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 1'})? $value->pasien->{'Row 1'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 2'})? $value->pasien->{'Row 1'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 2'})? $value->pasien->{'Row 1'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 1'}->{'Column 2'})? $value->pasien->{'Row 1'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 1'}->{'Column 3'})?$value->pasien->{'Row 1'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>2.</td>
                        <td>Pemeriksaan gelang identitas</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 1'})? $value->pasien->{'Row 2'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 1'})? $value->pasien->{'Row 2'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 1'})? $value->pasien->{'Row 2'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 2'})? $value->pasien->{'Row 2'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 2'})? $value->pasien->{'Row 2'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 2'}->{'Column 2'})? $value->pasien->{'Row 2'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 2'}->{'Column 3'})?$value->pasien->{'Row 2'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>3.</td>
                        <td>Surat pengantar rencana operasi</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 1'})? $value->pasien->{'Row 3'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 1'})? $value->pasien->{'Row 3'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 1'})? $value->pasien->{'Row 3'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 2'})? $value->pasien->{'Row 3'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 2'})? $value->pasien->{'Row 3'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 3'}->{'Column 2'})? $value->pasien->{'Row 3'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 3'}->{'Column 3'})?$value->pasien->{'Row 3'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>4.</td>
                        <td>Tanda dan lokasi pembedahan</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 1'})? $value->pasien->{'Row 4'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 1'})? $value->pasien->{'Row 4'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 1'})? $value->pasien->{'Row 4'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 2'})? $value->pasien->{'Row 4'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 2'})? $value->pasien->{'Row 4'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 4'}->{'Column 2'})? $value->pasien->{'Row 4'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 4'}->{'Column 3'})?$value->pasien->{'Row 4'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>5.</td>
                        <td>Periksa kelengkapan persetujuan pembedahan</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 1'})? $value->pasien->{'Row 5'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 1'})? $value->pasien->{'Row 5'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 1'})? $value->pasien->{'Row 5'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 2'})? $value->pasien->{'Row 5'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 2'})? $value->pasien->{'Row 5'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 5'}->{'Column 2'})? $value->pasien->{'Row 5'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 5'}->{'Column 3'})?$value->pasien->{'Row 5'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>6.</td>
                        <td>Periksa kelengkapan persetujuan anestesi</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 1'})? $value->pasien->{'Row 6'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 1'})? $value->pasien->{'Row 6'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 1'})? $value->pasien->{'Row 6'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 2'})? $value->pasien->{'Row 6'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 2'})? $value->pasien->{'Row 6'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 6'}->{'Column 2'})? $value->pasien->{'Row 6'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 6'}->{'Column 3'})?$value->pasien->{'Row 6'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>7.</td>
                        <td>Periksa kelengkapan dokumen medis (RI dan RJ)</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 1'})? $value->pasien->{'Row 7'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 1'})? $value->pasien->{'Row 7'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 1'})? $value->pasien->{'Row 7'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 2'})? $value->pasien->{'Row 7'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 2'})? $value->pasien->{'Row 7'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 7'}->{'Column 2'})? $value->pasien->{'Row 7'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 7'}->{'Column 3'})?$value->pasien->{'Row 7'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>8.</td>
                        <td>Periksa kelengkapan pemeriksaan penunjang (Lab,Rad)</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 1'})? $value->pasien->{'Row 8'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 1'})? $value->pasien->{'Row 8'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 1'})? $value->pasien->{'Row 8'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 2'})? $value->pasien->{'Row 8'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 2'})? $value->pasien->{'Row 8'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->pasien->{'Row 8'}->{'Column 2'})? $value->pasien->{'Row 8'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->pasien->{'Row 8'}->{'Column 3'})?$value->pasien->{'Row 8'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    ...
                    <tr>
                        <td>1.</td>
                        <td>Puasa/makan dan minum terakhir, jam	: <?= isset($value->question8->text1)?$value->question8->text1:'' ?></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 1'})? $value->fisik->{'item1'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 1'})? $value->fisik->{'item1'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 1'})? $value->fisik->{'item1'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 2'})? $value->fisik->{'item1'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 2'})? $value->fisik->{'item1'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item1'}->{'Column 2'})? $value->fisik->{'item1'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item1'}->{'Column 3'})?$value->fisik->{'item1'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>2.</td>
                        <td>IV line no	: <?= isset($value->question8->text2)?$value->question8->text2:'' ?> cairan <?= isset($value->question8->text3)?$value->question8->text3:'' ?></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 1'})? $value->fisik->{'item2'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 1'})? $value->fisik->{'item2'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 1'})? $value->fisik->{'item2'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 2'})? $value->fisik->{'item2'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 2'})? $value->fisik->{'item2'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item2'}->{'Column 2'})? $value->fisik->{'item2'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item2'}->{'Column 3'})?$value->fisik->{'item2'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>3.</td>
                        <td>Protese luar dilepaskan (gigi palsu, lensa kontak)</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 1'})? $value->fisik->{'item3'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 1'})? $value->fisik->{'item3'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 1'})? $value->fisik->{'item3'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 2'})? $value->fisik->{'item3'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 2'})? $value->fisik->{'item3'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item3'}->{'Column 2'})? $value->fisik->{'item3'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item3'}->{'Column 3'})?$value->fisik->{'item3'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>4.</td>
                        <td>Menggunakan protese dalam (implant,protese panggul/bahu,dll)</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 1'})? $value->fisik->{'item4'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 1'})? $value->fisik->{'item4'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 1'})? $value->fisik->{'item4'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 2'})? $value->fisik->{'item4'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 2'})? $value->fisik->{'item4'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item4'}->{'Column 2'})? $value->fisik->{'item4'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item4'}->{'Column 3'})?$value->fisik->{'item4'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>5.</td>
                        <td>Penjepit rambut/cat kuku/perhiasan (dilepaskan)</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 1'})? $value->fisik->{'item5'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 1'})? $value->fisik->{'item5'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 1'})? $value->fisik->{'item5'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 2'})? $value->fisik->{'item5'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 2'})? $value->fisik->{'item5'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item5'}->{'Column 2'})? $value->fisik->{'item5'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item5'}->{'Column 3'})?$value->fisik->{'item5'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>6.</td>
                        <td>Persiapan kulit / cukur</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 1'})? $value->fisik->{'item6'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 1'})? $value->fisik->{'item6'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 1'})? $value->fisik->{'item6'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 2'})? $value->fisik->{'item6'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 2'})? $value->fisik->{'item6'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item6'}->{'Column 2'})? $value->fisik->{'item6'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item6'}->{'Column 3'})?$value->fisik->{'item6'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>7.</td>
                        <td>Pengosongan kandung kemih</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 1'})? $value->fisik->{'item7'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 1'})? $value->fisik->{'item7'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 1'})? $value->fisik->{'item7'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 2'})? $value->fisik->{'item7'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 2'})? $value->fisik->{'item7'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item7'}->{'Column 2'})? $value->fisik->{'item7'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item7'}->{'Column 3'})?$value->fisik->{'item7'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>8.</td>
                        <td>Memerlukan persiapan darah</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 1'})? $value->fisik->{'item8'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 1'})? $value->fisik->{'item8'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 1'})? $value->fisik->{'item8'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 2'})? $value->fisik->{'item8'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 2'})? $value->fisik->{'item8'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item8'}->{'Column 2'})? $value->fisik->{'item8'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item8'}->{'Column 3'})?$value->fisik->{'item8'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>9.</td>
                        <td>Alat bantu (kacamata, alat bantu dengar) disimpan</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 1'})? $value->fisik->{'item9'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 1'})? $value->fisik->{'item9'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 1'})? $value->fisik->{'item9'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 2'})? $value->fisik->{'item9'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 2'})? $value->fisik->{'item9'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item9'}->{'Column 2'})? $value->fisik->{'item9'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item9'}->{'Column 3'})?$value->fisik->{'item9'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>10.</td>
                        <td>Riawayat alergi obat</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 1'})? $value->fisik->{'item10'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 1'})? $value->fisik->{'item10'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 1'})? $value->fisik->{'item10'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 2'})? $value->fisik->{'item10'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 2'})? $value->fisik->{'item10'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item10'}->{'Column 2'})? $value->fisik->{'item10'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item10'}->{'Column 3'})?$value->fisik->{'item10'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>11.</td>
                        <td>Obat antibiotika terakhir yang diberikan</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 1'})? $value->fisik->{'item11'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 1'})? $value->fisik->{'item11'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 1'})? $value->fisik->{'item11'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 2'})? $value->fisik->{'item11'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 2'})? $value->fisik->{'item11'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item11'}->{'Column 2'})? $value->fisik->{'item11'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item11'}->{'Column 3'})?$value->fisik->{'item11'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    <tr>
                        <td>12.</td>
                        <td>Vaskuler akses (cimino) dan lain-lain</td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 1'})? $value->fisik->{'item12'}->{'Column 1'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 1'})? $value->fisik->{'item12'}->{'Column 1'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 1'})? $value->fisik->{'item12'}->{'Column 1'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 2'})? $value->fisik->{'item12'}->{'Column 2'} == "item1" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 2'})? $value->fisik->{'item12'}->{'Column 2'} == "item2" ? "checked":'':'' ?>></td>
                        <td id="column01"><input type="checkbox" <?php echo isset($value->fisik->{'item12'}->{'Column 2'})? $value->fisik->{'item12'}->{'Column 2'} == "item3" ? "checked":'':'' ?>></td>
                        <td id="column01"><?= isset($value->fisik->{'item12'}->{'Column 3'})?$value->fisik->{'item12'}->{'Column 3'}:'…………………….' ?></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="9" style="border-top: 1px solid black;">
                            ...
                            <ul>
                            Site marking	:
                                <input type="checkbox" <?php echo isset($value->question3)? $value->question3 == "ya" ? "checked":'':'' ?>>	
                                <span>Ya</span> 
                                <input type="checkbox" <?php echo isset($value->question3)? $value->question3 == "tidak" ? "checked":'':'' ?>>	
                                <span>Tidak</span>
                            </ul>
                            ...
                            <div style="display: inline; position: relative;text-align: center;">
                                <div style="float: left;">
                                    ...
                                    <p>Perawat Ruangan</p>
                                        <?php
                                        $id4 = isset($val->id_pemeriksa)?$val->id_pemeriksa:null;
                                        $ttd_perawat = isset($value->ttd_perawat)?$value->ttd_perawat:null;
                                ...
                                <div style="float: right;">
                                    <p>Bukittinggi,<?= isset($value->question8)?date('d/m/Y', strtotime($value->question8)):'' ?> Jam : <?= isset($value->question8)?date('h:i', strtotime($value->question8)):'' ?></p>
                                    <p>Perawat Kamar Operasi</p>
                                    <?php
                                        $id5 = isset($val->id_pemeriksa_2)?$val->id_pemeriksa_2:null;
                                        $ttd_ok = isset($value->ttd_ok)?$value->ttd_ok:null;
            ...
            <table id="data" cellpadding="3px" cellspacing="2px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question4->{'Row 1'})? $value->question4->{'Row 1'} == "Column 1" ? "checked":'':'' ?>>Ya
                        <input type="checkbox" <?php echo isset($value->question4->{'Row 1'})? $value->question4->{'Row 1'} == "Column 2" ? "checked":'':'' ?>>Tidak
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question4->{'Row 2'})? $value->question4->{'Row 2'} == "Column 1" ? "checked":'':'' ?>>Ya
                        <input type="checkbox" <?php echo isset($value->question4->{'Row 2'})? $value->question4->{'Row 2'} == "Column 2" ? "checked":'':'' ?>>Tidak
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <span>Time Out :</span>
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 1'})? $value->question5->{'Row 1'}->{'Column 1'} == "1" ? "checked":'':'' ?>>Ya
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 1'})? $value->question5->{'Row 1'}->{'Column 1'} == "0" ? "checked":'':'' ?>>Tidak
                    </td>
                </tr>
                ...
                <tr>
                    <td width="2%">3.</td>
                    <td>
                        <span>Operasi yang dilakukan : <?= isset($value->question5->{'Row 1'}->{'Column 2'})?$value->question5->{'Row 1'}->{'Column 2'}:'' ?></span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 3'})? $value->question5->{'Row 1'}->{'Column 3'} == "item1" ? "checked":'':'' ?>>Elektif
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 3'})? $value->question5->{'Row 1'}->{'Column 3'} == "item2" ? "checked":'':'' ?>>Darurat
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 3'})? $value->question5->{'Row 1'}->{'Column 3'} == "item3" ? "checked":'':'' ?>>ODC
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 4'})? $value->question5->{'Row 1'}->{'Column 4'} == "item1" ? "checked":'':'' ?>>Rileks
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 4'})? $value->question5->{'Row 1'}->{'Column 4'} == "item2" ? "checked":'':'' ?>>Gelisah
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 4'})? $value->question5->{'Row 1'}->{'Column 4'} == "item3" ? "checked":'':'' ?>>Tidak ada respon
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item1" ? "checked":'':'' ?>>Ta-kiri
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item2" ? "checked":'':'' ?>>Ta-kanan
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item3" ? "checked":'':'' ?>>Ka-kiri
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item4" ? "checked":'':'' ?>>Ka-kanan
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item5" ? "checked":'':'' ?>>Arterial line
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <span></span>
                        <input type="checkbox" style="margin-left:140px" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "item6" ? "checked":'':'' ?>>CVP
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 5'})? $value->question5->{'Row 1'}->{'Column 5'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question5->{'Row 1'}->{'Column 5-Comment'})?$value->question5->{'Row 1'}->{'Column 5-Comment'}:'' ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 6'})? $value->question5->{'Row 1'}->{'Column 6'} == "item1" ? "checked":'':'' ?>>Terlentang
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 6'})? $value->question5->{'Row 1'}->{'Column 6'} == "item2" ? "checked":'':'' ?>>Lithotomy
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 6'})? $value->question5->{'Row 1'}->{'Column 6'} == "item3" ? "checked":'':'' ?>>Tengkurap
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <span></span>
                        <input type="checkbox" style="margin-left:140px" <?php echo isset($value->question5->{'Row 1'}->{'Column 6'})? $value->question5->{'Row 1'}->{'Column 6'} == "item4" ? "checked":'':'' ?>>Lateral Kiri-Kanan*
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 6'})? $value->question5->{'Row 1'}->{'Column 6'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question5->{'Row 1'}->{'Column 6-Comment'})?$value->question5->{'Row 1'}->{'Column 6-Comment'}:'' ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 7'})? $value->question5->{'Row 1'}->{'Column 7'} == "item1" ? "checked":'':'' ?>>Diruangan <?= isset($value->question5->{'Row 1'}->{'Column 8'})?$value->question5->{'Row 1'}->{'Column 8'}:'' ?>
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 7'})? $value->question5->{'Row 1'}->{'Column 7'} == "item2" ? "checked":'':'' ?>>Dalam kamar operasi
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 7'})? $value->question5->{'Row 1'}->{'Column 7'} == "item3" ? "checked":'':'' ?>>Tidak
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 9'})? $value->question5->{'Row 1'}->{'Column 9'} == "item1" ? "checked":'':'' ?>>Tidak
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 9'})? $value->question5->{'Row 1'}->{'Column 9'} == "item2" ? "checked":'':'' ?>>Bipolar
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 9'})? $value->question5->{'Row 1'}->{'Column 9'} == "item3" ? "checked":'':'' ?>>Monopolar
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item1" ? "checked":'':'' ?>>Bokong Kiri	
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item4" ? "checked":'':'' ?>>Bokong Kanan
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item2" ? "checked":'':'' ?>>Paha Kiri
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item5" ? "checked":'':'' ?>>Paha Kanan
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item3" ? "checked":'':'' ?>>Betis Kiri
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 10'})? $value->question5->{'Row 1'}->{'Column 10'} == "item6" ? "checked":'':'' ?>>Betis Kanan
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 11'})? $value->question5->{'Row 1'}->{'Column 11'} == "utuh" ? "checked":'':'' ?>>Utuh		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 11'})? $value->question5->{'Row 1'}->{'Column 11'} == "mengelembung" ? "checked":'':'' ?>>Menggelembung
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 11'})? $value->question5->{'Row 1'}->{'Column 11'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset( $value->question5->{'Row 1'}->{'Column 11-Comment'})? $value->question5->{'Row 1'}->{'Column 11-Comment'}:'' ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 12'})? $value->question5->{'Row 1'}->{'Column 12'} == "item1" ? "checked":'':'' ?>>Utuh		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 12'})? $value->question5->{'Row 1'}->{'Column 12'} == "item2" ? "checked":'':'' ?>>Menggelembung
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 12'})? $value->question5->{'Row 1'}->{'Column 12'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset( $value->question5->{'Row 1'}->{'Column 12-Comment'})? $value->question5->{'Row 1'}->{'Column 12-Comment'}:'' ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 13'})? $value->question5->{'Row 1'}->{'Column 13'} == "item1" ? "checked":'':'' ?>>ya		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 13'})? $value->question5->{'Row 1'}->{'Column 13'} == "item2" ? "checked":'':'' ?>>tidak
                ...
                <tr>
                    <td width="2%"> </td>
                    <td>
                        <span>Tempat <?= isset($value->question5->{'Row 1'}->{'Column 14'})?$value->question5->{'Row 1'}->{'Column 14'}:'' ?></span>
                       <span style="margin-left:20px">Jam mulai <?= isset($value->question5->{'Row 1'}->{'Column 15'})?$value->question5->{'Row 1'}->{'Column 15'}:'' ?> </span>	
                       <span>Jam selesai <?= isset($value->question5->{'Row 1'}->{'Column 16'})?$value->question5->{'Row 1'}->{'Column 16'}:'' ?> </span>
                    ...
                    <td>
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 18'})? $value->question5->{'Row 1'}->{'Column 18'} == "other" ? "checked":'':'' ?>>Benar, Jumlah <?= isset($value->question5->{'Row 1'}->{'Column 18-Comment'})?$value->question5->{'Row 1'}->{'Column 18-Comment'}:'' ?></td>
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 19'})? $value->question5->{'Row 1'}->{'Column 19'} == "other" ? "checked":'':'' ?>>Benar, Jumlah   <?= isset($value->question5->{'Row 1'}->{'Column 19-Comment'})?$value->question5->{'Row 1'}->{'Column 19-Comment'}:'' ?></td>
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 20'})? $value->question5->{'Row 1'}->{'Column 20'} == "other" ? "checked":'':'' ?>>Benar, Jumlah   <?= isset($value->question5->{'Row 1'}->{'Column 20-Comment'})?$value->question5->{'Row 1'}->{'Column 20-Comment'}:'' ?></td>
                            </tr>
                            <tr>
                                <td>Hitungan 2 (sebelum tutup perinium/kulit)		</td>
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 21'})? $value->question5->{'Row 1'}->{'Column 21'} == "other" ? "checked":'':'' ?>>Benar, Jumlah <?= isset($value->question5->{'Row 1'}->{'Column 21-Comment'})?$value->question5->{'Row 1'}->{'Column 21-Comment'}:'' ?> </td>
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 22'})? $value->question5->{'Row 1'}->{'Column 22'} == "other" ? "checked":'':'' ?>>Benar, Jumlah <?= isset($value->question5->{'Row 1'}->{'Column 22-Comment'})?$value->question5->{'Row 1'}->{'Column 22-Comment'}:'' ?> </td>
                                <td><input type="checkbox"<?php echo isset($value->question5->{'Row 1'}->{'Column 23'})? $value->question5->{'Row 1'}->{'Column 23'} == "other" ? "checked":'':'' ?>>Benar, Jumlah <?= isset($value->question5->{'Row 1'}->{'Column 23-Comment'})?$value->question5->{'Row 1'}->{'Column 23-Comment'}:'' ?> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 24'})? $value->question5->{'Row 1'}->{'Column 24'} == "item1" ? "checked":'':'' ?>>Ya		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 24'})? $value->question5->{'Row 1'}->{'Column 24'} == "item2" ? "checked":'':'' ?>>Tidak    
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 25'})? $value->question5->{'Row 1'}->{'Column 25'} == "item1" ? "checked":'':'' ?>>Ya		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 25'})? $value->question5->{'Row 1'}->{'Column 25'} == "item2" ? "checked":'':'' ?>>Tidak    
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 26'})? $value->question5->{'Row 1'}->{'Column 26'} == "item1" ? "checked":'':'' ?>>Tidak ada		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 26'})? $value->question5->{'Row 1'}->{'Column 26'} == "item2" ? "checked":'':'' ?>>Ada    
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <span>Spesimen</span>
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 27'})? $value->question5->{'Row 1'}->{'Column 27'} == "item1" ? "checked":'':'' ?>>Tidak ada		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 27'})? $value->question5->{'Row 1'}->{'Column 27'} == "item2" ? "checked":'':'' ?>>Ada    
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 27'})? $value->question5->{'Row 1'}->{'Column 27'} == "item3" ? "checked":'':'' ?>>Patologi		
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 27'})? $value->question5->{'Row 1'}->{'Column 27'} == "item4" ? "checked":'':'' ?>>Kultur 
                        <input type="checkbox" <?php echo isset($value->question5->{'Row 1'}->{'Column 27'})? $value->question5->{'Row 1'}->{'Column 27'} == "other" ? "checked":'':'' ?>>lain- lain <?= isset($value->question5->{'Row 1'}->{'Column 27-Comment'})?$value->question5->{'Row 1'}->{'Column 27-Comment'}:'' ?> <br>
                        <span> Nama dari jaringan : <?= isset($value->question5->{'Row 1'}->{'Column 28'})?$value->question5->{'Row 1'}->{'Column 28'}:'' ?></span>
                    </td>
                </tr>
            ...
            <table id="data" cellpadding="3px" cellspacing="2px">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 1'})? $value->question6->{'Row 1'}->{'Column 1'} == "item1" ? "checked":'':'' ?>>Ya, masuk jam : <?= isset($value->question6->{'Row 1'}->{'Column 2'})?$value->question6->{'Row 1'}->{'Column 2'}:'' ?>
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 1'})? $value->question6->{'Row 1'}->{'Column 1'} == "item2" ? "checked":'':'' ?>>Tidak, kembali langsung ke ruangan/ICU*<br>
                        <span style="margin-left:100px">Keluar jam : <?= isset($value->question6->{'Row 1'}->{'Column 3'})?$value->question6->{'Row 1'}->{'Column 3'}:'' ?> </span>
                    </td>
                </tr>
                <tr>
                    <td width="2%">1.</td>
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 4'})? $value->question6->{'Row 1'}->{'Column 4'} == "item1" ? "checked":'':'' ?>>Baik
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 4'})? $value->question6->{'Row 1'}->{'Column 4'} == "other" ? "checked":'':'' ?>>Jelek, Jelaskan <?= isset($value->question6->{'Row 1'}->{'Column 4-Comment'})?$value->question6->{'Row 1'}->{'Column 4-Comment'}:'' ?>
                    </td>
                </tr>
                <tr>
                    <td width="2%">2.</td>
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 5'})? $value->question6->{'Row 1'}->{'Column 5'} == "item1" ? "checked":'':'' ?>>Sadar
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 5'})? $value->question6->{'Row 1'}->{'Column 5'} == "item2" ? "checked":'':'' ?>>Mudah dibangunkan
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 5'})? $value->question6->{'Row 1'}->{'Column 5'} == "item3" ? "checked":'':'' ?>>Tidak ada respon
                    </td>
                </tr>
                <tr>
                    <td width="2%">3.</td>
                    <td>
                        ...
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 6'})? $value->question6->{'Row 1'}->{'Column 6'} == "item1" ? "checked":'':'' ?>>Patent
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 6'})? $value->question6->{'Row 1'}->{'Column 6'} == "item2" ? "checked":'':'' ?>>Tidak Patent
                        <input type="checkbox" <?php echo isset($value->question6->{'Row 1'}->{'Column 6'})? $value->question6->{'Row 1'}->{'Column 6'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question6->{'Row 1'}->{'Column 6-Comment'})?$value->question6->{'Row 1'}->{'Column 6-Comment'}:'' ?>
                    </td>
                </tr>
                <tr>
                    <td width="2%"></td>
                    <td>
                        ...
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 7'})? $value->question6->{'Row 1'}->{'Column 7'} == "item1" ? "checked":'':'' ?>>Patent
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 7'})? $value->question6->{'Row 1'}->{'Column 7'} == "item2" ? "checked":'':'' ?>>Tidak Patent
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 7'})? $value->question6->{'Row 1'}->{'Column 7'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question6->{'Row 1'}->{'Column 7-Comment'})?$value->question6->{'Row 1'}->{'Column 7-Comment'}:'' ?>
                    </td>
                </tr>
                <tr>
                    <td width="2%">4.</td>
                    <td>
                        <span>Terapi Oksigen <?= isset($value->question6->{'Row 1'}->{'Column 8'})?$value->question6->{'Row 1'}->{'Column 8'}:'' ?>l/mnt</span>
                        <span style="margin-left:20px">Jenis : <?= isset($value->question6->{'Row 1'}->{'Column 9'})?$value->question6->{'Row 1'}->{'Column 9'}:'' ?></span>
                    </td>
                </tr>
                <tr>
                    <td width="2%">5.</td>
                    <td>
                        ...
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 10'})? $value->question6->{'Row 1'}->{'Column 10'} == "item1" ? "checked":'':'' ?>>Kering/lembab*
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 10'})? $value->question6->{'Row 1'}->{'Column 10'} == "item2" ? "checked":'':'' ?>>Merah muda/kebiruan*
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 10'})? $value->question6->{'Row 1'}->{'Column 10'} == "item3" ? "checked":'':'' ?>>Hangat/dingin*	
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 10'})? $value->question6->{'Row 1'}->{'Column 10'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question6->{'Row 1'}->{'Column 10-Comment'})?$value->question6->{'Row 1'}->{'Column 10-Comment'}:'' ?>	
                    </td>
                </tr>
                <tr>
                    <td width="2%">6.</td>
                    <td>
                        ...
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 11'})? $value->question6->{'Row 1'}->{'Column 11'} == "item1" ? "checked":'':'' ?>>Lateral kanan-kiri
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 11'})? $value->question6->{'Row 1'}->{'Column 11'} == "item2" ? "checked":'':'' ?>>Semi fowler
                        <input type="checkbox"  <?php echo isset($value->question6->{'Row 1'}->{'Column 11'})? $value->question6->{'Row 1'}->{'Column 11'} == "other" ? "checked":'':'' ?>>Lain-lain <?= isset($value->question6->{'Row 1'}->{'Column 11-Comment'})?$value->question6->{'Row 1'}->{'Column 11-Comment'}:'' ?>
                    </td>
                </tr>
                <tr>
                    <td width="2%">7.</td>
                ...
                <tr>
                    <td width="2%"></td>
                    <td>
                        <p><?= isset($value->question6->{'Row 1'}->{'Column 12'})?$value->question6->{'Row 1'}->{'Column 12'}:'' ?></p>
                    </td>
                </tr>
                <tr>
                    <td width="2%"></td>
                    <td>
                        ...
                        <input type="checkbox" <?= (isset($value->question6->{'Row 1'}->{'Column 13'})?in_array("item1", $value->question6->{'Row 1'}->{'Column 13'})?'checked':'':'') ?>>Laporan Anestesi
                        <input type="checkbox" <?= (isset($value->question6->{'Row 1'}->{'Column 13'})?in_array("item2", $value->question6->{'Row 1'}->{'Column 13'})?'checked':'':'') ?>>Laporan Operasi	
                        <input type="checkbox" <?= (isset($value->question6->{'Row 1'}->{'Column 13'})?in_array("other", $value->question6->{'Row 1'}->{'Column 13'})?'checked':'':'') ?>>Lain-lain <?= isset($value->question6->{'Row 1'}->{'Column 13-Comment'})?$value->question6->{'Row 1'}->{'Column 13-Comment'}:'' ?>
                    </td>
                </tr>
