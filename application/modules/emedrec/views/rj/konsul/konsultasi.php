...
<body class="A4">
    ...
    <table border="1" width="100%" cellpadding="5px" style="margin-top:30px">
        ...
        <tr>
              <td width="40%"> &nbsp; &nbsp;
                    <p style="margin: 5px;">Yth :  <span style="border-bottom: 1px dotted black; width: 80px;"><?= isset($data->yth)?$data->yth:'' ?></span></p>
              ...
              <td width="20%">&nbsp; &nbsp;
                <p style="margin: 5px;">Tanggal : <span style="border-bottom: 1px dotted black; width: 80px; display: inline-block;"><?= isset($data->tanggal)?date('d-m-Y',strtotime($data->tanggal)):'' ?></span></p>
              </td>
         </tr>
    </table>
    <table border="1" width="100%" cellpadding="5px" style="margin-top:0px">
       ...
       <tr>
            <td colspan="4">
                ...
                <p style="text-align: right;">Tanah Badantuang, <?= isset($data->tanggal)?date('d-m-Y',strtotime($data->tanggal)):'' ?></span></p>
                <?php
                                    ...
                                    $id = isset($val->id_pemeriksa)?$val->id_pemeriksa:null;                           
                                            ...
                                            WHERE
                                                hmis_users.userid = $id")->row():null;

                                    ?>
                                   
                                    
                                <p style="text-align: right;"> <img width="70px" src="<?= isset($query->ttd)?$query->ttd:'' ?>" alt=""><br></p>
                                <p style="text-align: right;"><span>( <?= isset($query->name)?$query->name:'' ?> )</span><br></p>
            </td>
       </tr>
    </table>
       ...
       <tr>
            <td colspan="4">
                   ...
                   <?php  }
                    ...
                    <p style="text-align: right;">Tanah Badantuang,  <?= isset($val->tgl_jawaban)?date('d-m-Y',strtotime($val->tgl_jawaban)):date('d-m-Y',strtotime($val->tgl_jawaban)) ?></span></p><br><br><br>
                    <p style="text-align: right;">Dokter Konsulen</span></p> 
                    <?php
                                    $dokter = explode('-',$data->yth);
                                    $id = isset($dokter)?$dokter[1]:null; 
