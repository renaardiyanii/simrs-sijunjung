...
foreach ($pemeriksaan_elektromedik as $data) {
    ...
    $kode=$this->M_emedrec->get_data_hasil_em_pertindakan($data->id_pemeriksaan_em)->row();
    $kode_jenis = $kode->kode_jenis;
...
?>    
    <?php if($data->no_register == $kode->no_register){ ?>
                ...
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <header style="margin-top:20px; font-size:12pt!important;">
                        <table border="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 75%;line-height: 1;"><p> : <?php //echo $data_pasien_tindak->no_register ?></p></td> -->
                                <td width="35%"><span class="text_body">Patient</span></td>
                                <td width="5%"><span class="text_body">:</span></td>
                                <td width="60%"><span class="text_isi"><?php echo $data_pasien_tindak->no_register; ?></span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td width="35%"><span class="text_body">Nama</span></td>
                                <td width="5%"><span class="text_body">:</span></td>
                                <td width="60%"><span class="text_isi"><?php echo $data_pasien->nama; ?></span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td width="35%"><span class="text_body">NIK</span></td>
                                <td width="5%"><span class="text_body">:</span></td>
                                <td width="60%"><span class="text_isi"><?php echo $data_pasien->no_identitas; ?></span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td width="18%"><span class="text_body">No. RM</span></td>
                                <td width="2%"><span class="text_body">:</span></td>
                                <td width="50%"><span class="text_isi"><?php echo $data_pasien->no_cm; ?></span></td>
                                <td width="30%"><span class="text_isi">(<?php echo $data_pasien->sex; ?>)</span></td>
                            </tr>
                            <tr>
                                <td width="18%"><span class="text_body">Tgl Lahir</span></td>
                                <td width="2%"><span class="text_body">:</span></td>
                                <td width="50%"><span class="text_isi"><?php echo $data_pasien->tgl;//substr($data_pasien->tgl_lahir,0,10); ?></span></td>
                                <td width="30%"><span class="text_isi">
                                    <barcode code="<?= $data_pasien->no_cm; ?>" type="EAN13" height="0.5" />
                                </span></td>
                            </tr>
                        </table> 
                    </header>
                    ...
                    <h4 align="center"><b>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 25%; font-size: 13px;"><p>Nama Pasien</p></td>
                                <td style="width: 75%; font-size: 13px;"><p> : <?= $data_pasien_tindak->nama ?></p></td>
                            </tr>
                            <tr>
                                <td style="font-size: 13px;"><p>Medical Record</p></td>
                                <td style="font-size: 13px;"><p> : <?= $data->no_em ?></p></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px;"><p> : <?= $data_pasien_tindak->kotakabupaten ?></p></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px;"><p> : <?php echo $jsonf['mf_data']; ?></p></td>
                            </tr>
                            <tr>
                                <td style="font-size: 13px;"><p>Kesan</p></td>
                                <td style="font-size: 13px;"><p> : <?php echo $jsonf['mf_kesan']; ?></p></td>
                            </tr>
                            <tr>
                                <td style="font-size: 13px"><p>Kesimpulan</p></td>
                                <td style="font-size: 13px"><p> : <?php echo $jsonf['mf_kesimpulan']; ?></p></td>
                            </tr>
                        </table>
            ...
            <?php if($jsonb != null){ ?>
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 25%;line-height: 1;"><p>Patient</p></td>
                            <td style="width: 75%;line-height: 1;"><p> : <?= $data_pasien_tindak->no_register ?></p></td>
                        </tr>
                        <tr>
                            <td style="width: 25%;line-height: 1;"><p>Patient</p></td>
                    ...
                    <p style="line-height: 1;font-size:13px"><?php echo $jsonb['mb_interpretation']; ?></p>
                    <p style="line-height: 1;font-size:13px">KESAN : <?php echo $jsonb['mb_kesan']; ?></p>

                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 25%;line-height: 1;font-size:13px"><p>Physician Signature</p></td>
                            <td style="width: 75%;line-height: 1;font-size:13px"><p> : <?= $nama_dokter_reading ?></p></td>
                        </tr>
                        <tr>
                            <td style="line-height: 1;font-size:13px"><p>Date Dictated</p></td>
                            <td style="line-height: 1;font-size:13px"><p> : <?= $data->tanggal_isi ?></p></td>
                        </tr>
                    </table>
            ...
            <?php if($jsonc != null){ ?>
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td align="left" style="width: 50%;line-height: 1;"><b><p>Patient : <?= $data_pasien_tindak->nama?></p></b></td>
                        ...
                        <tr>
                            ...
                            <td align="right" style="line-height: 1;"><p> <?= $data->tgl_kunjungan ?></p></td>
                        </tr>
                        <tr>
                            <td align="left" colspan="2" style="line-height: 1;"><p>Protocol name : <?= $data->jenis_tindakan ?></p></td>
                        </tr>
                    </table>
                        ...
                        <p style="font-size:13px;">Kesimpulan : </p>
                ...
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <header style="margin-top:20px; font-size:12pt!important;">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="50%"><span class="text_isi"><?php echo $data_pasien->tgl;//substr($data_pasien->tgl_lahir,0,10); ?></span></td>
                                <td width="30%"><span class="text_isi">
                                    <barcode code="<?php echo $data_pasien->no_cm; ?>" type="EAN13" height="0.5" />
                                    <!-- <svg class="barcode"
                                        jsbarcode-format="code128"
                                        jsbarcode-height="30"
                                        jsbarcode-width="1"
                                        jsbarcode-displayValue="false"
                                        jsbarcode-value="<?php //echo $data_pasien->no_cm??""; ?>"
                        ...
                        <?php //var_dump($data_pasien->no_cm);die(); ?>
                    </header>
                    <hr color="black">
                    ...
                    <table border="1" cellspacing="0" cellpadding="0" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%;"><?= $data_pasien_tindak->no_register ?></td>
                        </tr>
                        <tr>
                            <td style="width: 25%;">Name</td>
        ...
        <?php }elseif($kode_jenis == 'MA'){ ?>
            <?php if($jsona != null){ ?>
                <div class="A4 sheet  padding-fix-10mm">
                                    ...
                                    <tr>
                                        <td width="50%">
                                            ...
                                            <tr >
                                                    ...
                                                    <td width="3%"><span>:</td>
                                                    <td width="65%"><span> <?php echo $data_pasien_tindak->no_register; ?></span></td>
                                                </tr>
                                                <tr >
                                                    <td width="2%"></td>
                                                    <td width="30%"><span>No. RM</td>
                                        ...
                                        <td width="50%">
                                            <table border ="0" width ="100%">
                                                <tr>
                                                    <td width="2%"></td>
                                                    <td width="30%"><span>Rujukan</td>
                                                    <td width="3%"><span>:</td>
                                                    <td width="65%"><span><?= $nama_poli ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td width="2%"></td>
                                                    <td width="30%"><span>Tgl. Periksa</td>
                                                    <td width="3%"><span>:</td>
                                                    <td width="65%"><span><?= date('d F Y',strtotime($data->tgl_kunjungan)) ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td width="2%"></td>
                                                    <td width="30%"><span>Tgl. Hasil</td>
                                                    <td width="3%"><span>:</td>
                                                    <td width="65%"><span><?= $data->tanggal_isi ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td width="2%"></td>
                                                    <td width="30%"><span>Dokter Pengirim</td>
                                                    <td width="3%"><span>:</td>
                                                    <td width="65%"><span><?= $nama_dokter_reffering ?></span></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                    </table>
                    <p style="font-size:13px">Klinis :  <?php echo $diagnosa; ?></p>

                    <p>
                        <span style="font-size:13px">TS Yth</span><br>
                        <span style="font-size:13px">Pemeriksaan Ultrasonografi Abdomen atas dengan transduser kurve.</span>
                    </p>
                    ...
                    <span style="font-size:13px">Kesan : </span>
        ...
        <?php }elseif($kode_jenis == 'ME'){ ?>
            <?php if($jsone != null){ ?>
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <center><h5>CAROTID ULTRASOUND</h5></center>
                            ...
                            <td width="100%">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="2%"><span class="text_body">:</span></td>
                                        <td>
                                            <span class="text_isi"> <?= $data_pasien_tindak->no_register ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="100%">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="2%"><span class="text_body">:</span></td>
                                        <td>
                                            <span class="text_isi"> <?= $data_pasien_tindak->nama ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="100%">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="2%"><span class="text_body">:</span></td>
                                        <td>
                                            <span class="text_isi"><?= $data_pasien_tindak->kotakabupaten ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="100%">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="2%"><span class="text_body">:</span></td>
                                        <td>
                                        <span class="text_isi"><?= date('d F Y',strtotime($data->tgl_kunjungan)) ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td width="100%">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td width="2%"><span class="text_body">:</span></td>
                                        <td>
                                        <span class="text_isi"><?= $jsone['me_faktor_resiko'] ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <div class="grid-container">
                        <div class="item2">
                            ...
                            <table width= "100%" style="text-align:center;font-size:12px" border=1>
                                <tr>
                                    <th  width= "40%" style="font-size:12px">Segment</th>
                                    <th  width= "30%" style="font-size:12px">PSV</th>
                                    <th  width= "30%" style="font-size:12px">EDV</th>
                                </tr>
                                <tr>
                                    <td  width= "40%">CCA</td>
        ...
        <?php }else{ ?>
                <div class="A4 sheet  padding-fix-10mm">
                    ...
                    <p align="center" class="text_judul" style="font-weight:bold;">SURAT ELEKTROMEDIK</p>
                                        ...
                                        <table border="0" width="100%">
                                            <tr>
                                                ...
                                                <td width="50%"><span class="text_sub_judul">
                                                        Ruang Poli : <?= $nama_poli ?>
                                                    </span></td>
                                                <td width="50%"><span class="text_sub_judul">
                                                        Dokter Pengirim : <?= $nama_dokter_reffering ?>
                                                    </span></td>
                                            </tr>                                            
                                        </table>
                                    </td>
                            ...
                            <td>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <div style="width:150px;height:120px; display:flex;justify-content:center;align-items:center;">
                                                <img  width="160px" src="<?= ($pemeriksaan_elektromedik)?$pemeriksaan_elektromedik[0]->ttd?$pemeriksaan_elektromedik[0]->ttd:'-':'-' ?>" alt="">
                                ...
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td> <span class="text_isi">No.Sip <?= ($nipeg_dokter)?$nipeg_dokter->nipeg?$nipeg_dokter->nipeg:'-':'-' ?></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
