            ...
            <header style="margin-top:20px; font-size:1pt!important;">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td width="50%"><span class="text_isi"><?php echo $row->no_cm; ?></span></td>
                        <td width="30%"><span class="text_isi">(<?php echo $row->sex; ?>)</span></td>
                    </tr>
                    <tr>
                        <td width="18%"><span class="text_body">Tgl Lahir</span></td>
                        <td width="2%"><span class="text_body">:</span></td>
                        <td width="50%"><span class="text_isi"><?php echo $row->tgl;//substr($row->tgl_lahir,0,10); ?></span></td>
