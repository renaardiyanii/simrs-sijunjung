    ...
    <?php if ($result) { ?>
        <?php for ($i = 0; $i < count($result); $i++) { ?>
            ...
            <div class="A4 sheet  padding-fix-10mm">
                ...
                <p align="center" style="font-weight:bold;font-size:14px">CATATAN PERKEMBANGAN PASIEN TERINTEGRASI RAWAT JALAN</p>
                        ...
                        <?php foreach ($result[$i] as $value) : ?>
                            ...
                            <tr>
                                <td>
                                    <table width="100%">
                                        <tr>
                                            <td><span class="text_body"><?= isset($value->waktu_masuk_poli) ? date("d-m-Y", strtotime($value->waktu_masuk_poli)) : '-'; ?></span></td>
                                        </tr>
                                        <tr>
                                ...
                                <td>
                                    <table border="0">
                                        ...
                                        <tr>
                                            <td style="text-align:center;"><span class="text_isi">(<?= isset($value->nm_perawat) ? $value->nm_perawat : ''; ?>)</span></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;"><span class="text_isi">Perawat</span></td>
                                        </tr>
                        ...
                        <?php foreach ($result[$i] as $value) : ?>
                            ...
                            <tr>
                                <td>
                                    <table width="100%">
                                        <tr>
                                            <td><span class="text_body"><?= isset($value->waktu_masuk_dokter) ? date("d-m-Y", strtotime($value->waktu_masuk_dokter)) : '-'; ?></span></td>
                                        </tr>
                                        <tr>
                ...
                <tr>
                    ...
                    <td>
                        <table border="0">
                            ...
                            <tr>
                                <td style="text-align:center;"><span class="text_isi">(-)</span></td>
                            </tr>
                            <tr>
                                <td style="text-align:center;"><span class="text_isi">Perawat</span></td>
                            </tr>
                ...
                <tr>
                    ...
                    <td>
                        <table border="0">
                            ...
                            <tr>
                                <td style="text-align:center;"><span class="text_isi">Dokter</span><br>
                                    <span class="text_isi">SIP. -</span>
                                </td>
                            </tr>
