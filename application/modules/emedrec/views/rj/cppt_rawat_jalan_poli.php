                ...
                <table border="1" width="100%">
                    ...
                    <?php foreach($result[$i] as $value): ?>
                        <?php 
                            ...
                            echo $value->noreg.' - '.$value->nm_poli;
                    ...
                    <tr>
                        ...
                        <td>
                            <table border="1" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($value->id_poli == 'BC00'){ ?>
                                            <span>Obat :</span><br>
                                                <?= isset($value->plan_dokter)? $value->plan_dokter: '-' ;?>
                                            <span><br>Procedure :</span><br>
                                            <?php 
                                            $data_procedure = $this->M_emedrec->get_procedur($value->noreg)->result();
                                            foreach($data_procedure as $dat){
                                ...
                                <tr>
                                    <td width=5%><span class="text_body soap">Intruksi.</span></td>
                                    <td><?= isset($value->intruksi)? $value->intruksi: '-' ;?></td>
                                </tr>
                            </table>
                        </td>
                        <td>
