<?php 
// var_dump($data_rawat_jalan[0]->ttd);
...
?>
   ...
   <body class="A5" >
       <div class="A sheet  padding-fix-10mm">
       <header style="margin-top:20px; font-size:1pt!important;">
        ...
        <tr>
            <td width="13%">
            <p align="center">
            <img src="<?= base_url("assets/img/$logo_kesehatan_header"); ?>" alt="img" height="50" style="padding-right:5px;">
            </p>
            </td>
            <td  width="74%" style="font-size:9px;" align="center">
            <font style="font-size:7pt!important">
            ...
            <label>Email : rsomh.bkt@gmail.com Email : rssnyanmed@yahoo.co.id Website : www.rsstrokebkt.com</label>
            </td>
            <td width="13%">
            <p align="center">
                <img src=" <?= base_url("assets/img/$logo_header"); ?>"  alt="img" height="50" style="padding-right:5px;">
            </p>
            </td>
        ...
        <?php
            ...
            foreach($data_rawat_jalan as $value){
        ?>
         <?php
            if($data_pasien != null){
        ...
        <div class="table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            $diagnosa = $this->M_emedrec->get_diagnosa_pasien_by_noreg($value->no_register);
                            if(isset($diagnosa)){
                                    foreach($diagnosa as $diagnosas){
                                        echo $diagnosas['diagnosa'].'.';
                                    }
                            }
                        ?>
                    </td>
        ...
        <p style="float:right">Bukittinggi,<?= date('d-m-Y',strtotime($value->tgl_kunjungan))??'.............................................................' ?> </p><br>
        <table width="100%">
        <tr>
        <td width="90%">&nbsp;</td>
        <td>
            <img  width="120px" src="<?= $data_rawat_jalan[0]->ttd ?>" alt="" srcset=""><br>
        </td>
        </tr>
        </table>
        <p style="float:right">
        <?php 
                ...
                ?><br>
            <span>SIP. <?= isset($nipeg_dokter->nipeg)?$nipeg_dokter->nipeg:'' ?></span>
        </p>
