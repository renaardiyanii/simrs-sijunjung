			...
			KARTU TINDAKAN
					...
					<table border="0" width="100%">
                        ...
                        <tr>
							<td><b>Kelas</b></td>
							<td> : </td>
							<td><?= isset($data_pasien->kelas_pasien)?$data_pasien->kelas_pasien:'' ?></td>
							<td><b>Kelamin</b></td>
							<td> : </td>
						...
						<tr>
							...
							<td> : </td>
							<td><?= isset($data_pasien->nm_dokter)?$data_pasien->nm_dokter:'' ?></td>
						</tr>
					</table>
					<br>
					...
					foreach($list_tindakan_pasien as $r){
						...
						<tr>
							...
							?></td>
							<td>Rp. <?php echo number_format($r->biaya_tindakan); ?></td>
							<!-- <td>Rp. <?php //echo number_format($r['tarifalkes'],0) ; ?></td> -->
							<td><?php echo $r->qtyind ; ?></td>
							<td>Rp. <?php echo number_format($r->biaya_tindakan * $r->qtyind); ?></td>
							<?php //$total_bayar = $total_bayar + ($r['tumuminap']+$r['tarifalkes'])*$r['qtyyanri'];?>
							<td id="ttd"><img id="imageid" name="imageid" src="<?php echo $r->ttd; ?>" alt="Red dot" width="75px" height="75px"></td>
							<?php
			 		...
			 		<table style="width:100%;">
			 			<tr>
			 				...
			 				<td width="25%">
                                 ...
                                 <p><?php echo isset($dokter)?$dokter:''; ?></p>
			 					</p>
			 				</td>
			 			</tr>	
			 		</table>	
