<?php 
$data = isset($asuhan_gizi_rj->formjson)?json_decode($asuhan_gizi_rj->formjson):'';
// var_dump($data);die();
?>
    ...
    <tr>
        <td colspan="3">
             <table border="0" width="100%" cellpadding="7px">
                ...
                <tr>
                    <td>BB : <?= isset($data->question3->text1)?$data->question3->text1:'' ?> kg</td>
                    <td>Lingkar lengan atas : <?= isset($data->question3->text2)?$data->question3->text2:'' ?> </td>
                </tr>
                <tr>
                    <td>TB : <?= isset($data->question3->text3)?$data->question3->text3:'' ?> cm</td>
                    <td>Tinggi Lutut : <?= isset($data->question3->text4)?$data->question3->text4:'' ?> </td>
                </tr>
                 <tr>
                    <td>IMT : <?= isset($data->question3->text5)?$data->question3->text5:'' ?> kg/cm2</td>
                </tr>
