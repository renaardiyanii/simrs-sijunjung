...
<script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                submitHandler: function(form) {
                        var jadwal = document.getElementById('tgl_jadwal_ok').value;
            ...
            function detail_ok(id){
                window.open('<?php echo site_url('ok/okcdaftar/detail_ok');?>/'+id);    
            }
        ...
        <div class="row">           
            <div class="col-md-12">             
                <div class="card card-outline-info">
                    ...
                    <div class="row p-t-0">
                    <?php echo form_open('ok/okcdaftar/daftar_pasien_luar');?>
                    <div class="col-md-4">
                    ...
                    <div class="modal-dialog modal-success modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                    <div class="col-sm-1"></div>
                                    <p class="col-sm-3 form-control-label" id="lbl_alamat">Dokter*</p>
                                    <div class="col-sm-7">
                                        <div class="form-inline">
                                                <select id="dokter" class="form-control select2" name="dokter" required="">
                                                    <option value="">--Silahkan Pilih Dokter Bedah--</option>
                                                    <?php 
                                                    foreach($dokter_bedah as $row){
                                                        echo '<option value="'.$row->nm_dokter.'">'.$row->nm_dokter.'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                    ...
                    <?php echo form_close();?>
                        ...
                        <form class="form-horizontal" method="POST" id="formsearchok">
                                <div class="form-group row">
									<div class="col-md-4">											
                                        <input type="date" id="tgl_jadwal_ok" class="form-control" placeholder="Tanggal Jadwal OK" name="tglok" min="<?php //echo date('Y-m-d') ?>" required>																				
									</div>
