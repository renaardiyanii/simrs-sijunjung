<!-- <div class="row"> -->
			...
			?>
						...
						<div class="row" style="align: center;margin-top:10px">
								<div class="col-md-12">
										<a href="<?php echo base_url().'emedrec/C_emedrec/rekam_medik_detail/'.$no_cm.'/'.$no_medrec.'/'.$no_register ?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary" style="margin-left: 45%;width: 20%;">E-KAMEK</a>									
								</div>								
							</div>
							</div>
							</div>
