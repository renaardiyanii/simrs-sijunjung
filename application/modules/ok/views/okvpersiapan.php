...
<script type="text/javascript">
            ...
            function tablejadwalok(tgl_jadwal){
                table = $('#operasi').DataTable({
                    ajax: "<?php echo site_url();?>iri/ricreservasi/show_persiapan/"+tgl_jadwal,
                    columns: [
                        { data: "no_reservasi" },
                        { data: "no_reservasi" },
                        { data: "type_rawat" },
            ...
            function detail_persiapan(id){
                window.open('<?php echo site_url('ok/okcdaftar/detail_persiapan');?>/'+id);    
            }
        ...
        <div class="row">           
            <div class="col-md-12">             
                <div class="card card-outline-info">
                    <div class="card-header" align="center" ><h4 class="text-white">Persiapan Operasi</h4></div>
