	...
	<div class="card-body">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<button class="nav-link active" id="nav-graphic-pemantauan-tab" data-bs-toggle="tab" data-bs-target="#nav-graphic-pemantauan" type="button" role="tab" aria-controls="nav-graphic-pemantauan" aria-selected="false">Grafik Pemantauan Status Sedasi</button>
		...
		<div class="tab-content" id="nav-tabContent">
			<div class="tab-pane fade show active" id="nav-graphic-pemantauan" role="tabpanel" aria-labelledby="nav-graphic-pemantauan-tab">
				<div id="SurveyStatusSedasiGrafikPemantauan"></div>
			</div>
...
function sendDataToServerStatusSedasi(survey) {
        ...
        $.ajax({
            type: "POST",
            url: '<?= base_url('ok/okcdaftar/status_sedasi/') ?>',
            data: {
...
surveyJSONStatusSedasiGrafikPemantauan = <?php echo file_get_contents("status_sedasi_grafik_pemantauan.json", FILE_USE_INCLUDE_PATH); ?>;

	function sendDataToServerStatusSedasiGrafikPemantauan(survey) {
		$.ajax({
			type: "POST",
			url: '<?= base_url('ok/okchasil/status_sedasi_grafik_pemantauan') ?>',
			data: {
				no_ipd: '<?php echo $no_register; ?>',
				id_ok: '<?php echo $id; ?>',
	...
	var survey_status_sedasi_grafik_pemantuan = new Survey.Model(surveyJSONStatusSedasiGrafikPemantauan);
	$("#SurveyStatusSedasiGrafikPemantauan").Survey({
		model: survey_status_sedasi_grafik_pemantuan,
		onComplete: sendDataToServerStatusSedasiGrafikPemantauan
	});

	// survey_status_sedasi_grafik_pemantuan.completeText = "Simpan";

	<?php if ($status_sedasi_grafik_pemantauan) { ?>
		survey_status_sedasi_grafik_pemantuan.data = <?= $status_sedasi_grafik_pemantauan->grafikjson ?>
	<?php } ?>
</script>