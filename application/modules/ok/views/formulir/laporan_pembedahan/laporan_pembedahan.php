...
<div class="A4 sheet  padding-fix-10mm">
    ...
    <table border="1" width="100%" cellpadding="5px" style="margin-top:0px">
            ...
            <td colspan="4">
                ...
                <table border="1" width="100%" cellpadding="2">
                    <tr>
                        ...
                        <td rowspan="2">Mulai :<br> <?= isset($data->mulai)?$data->mulai:'' ?></td>
                        <td rowspan="2">Selesai : <br><?= isset($data->selesai)?$data->selesai:'' ?></td>
                        <td>Lama pembedahan</td>
                        <td rowspan="">OK</td>
                     </tr>
                     <tr>
                        <td>Posisi pasien :  <?= isset($data->{'posisi_pasien:'})?$data->{'posisi_pasien:'}:'' ?></td>
                        <td> <?= isset($data->lama_pembedahan)?$data->lama_pembedahan:'' ?> </td>
                        <td> <?= isset($data->ok)?$data->ok:'' ?></td>
                     </tr>
       ...
       <tr>
             <td colspan="4" style="padding-bottom: 90px;"><b>URAIAN PEMBEDAHAN </b> : <br><?= nl2br(htmlspecialchars(trim($data->{'uraian_pembedahan:'} ?? ''))) ?>
             </td>
       </tr>
       <tr>
             <td colspan="4" style="padding-bottom: 40px;"><b>KOMPLIKASI : <?= isset($data->komplikasi)?$data->komplikasi:'' ?></b></td>
       </tr>
       <tr>
            ...
            <br><p>Asal Jaringan   : <?= isset($data->asal_jaringan)?$data->asal_jaringan:'' ?></td>
             ...
             <p style="margin: 10px 0;"> <img width="70px" src="<?= isset($data->question1)?$data->question1:'' ?>" alt=""><br></p>
             <p style="margin: 10px 0;"> <?= isset($data->ahli_bedah1)?$data->ahli_bedah1:'' ?><br></p>
             </td>
        </tr>
    </table>
    <div>
