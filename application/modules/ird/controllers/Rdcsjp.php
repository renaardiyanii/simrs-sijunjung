...
class Rdcsjp extends Secure_area{
	...
	public function index()
	{
		...
		$data['pasien_daftar']=$this->rdmkwitansi->get_pasien_sjp()->result();
		$data['url']='';
		...
		*/
		$this->load->view('ird/rdvsjp',$data);
	}
	...
	public function cetak_sjp($no_register='')
	{
		...
		if($no_register!=''){
			...
			$data_pasien=$this->rdmkwitansi->getdata_pasien_sjp($no_register)->row();
