								...
								<table id="example" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0">
									...
									<tbody>
										...
										<td class="<?= $row->waktu_masuk_dokter?'bebas':''; ?>">
											...
											<td style="<?= $row->waktu_masuk_dokter?'color:white':''; ?>" class="<?= $row->waktu_masuk_dokter?'bebas':''; ?>"><?php echo $row->antri;?></td>
											...
											<td  class="<?= $row->waktu_masuk_dokter?'text-white':''; ?>"><?php echo date("d-m-Y", strtotime($row->tgl)).' | '.date("H:i", strtotime($row->tgl));?></td>
