		...
		<div class="row">			
			...
			<div class="card card-outline-info">
					...
					<div class="form-inline">						
						...
						<input type="date" class="form-control" placeholder="yyyy-mm-dd" name="tgl0" required>						
						<input type="date" class="form-control" placeholder="yyyy-mm-dd" name="tgl1" required>				  
						&nbsp;&nbsp;&nbsp;&nbsp;
