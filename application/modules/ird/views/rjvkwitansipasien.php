							...
							<table class="table table-hover table-striped table-bordered">
							  ...
							  <tbody>
								...
								?>
									...
									<?php } }} if($data_ok!=''){ ?>
									 <tr>
									  <td><?php if($data_pasien->cara_bayar!='UMUM' || $data_pasien->cara_bayar!='BPJS' || $data_pasien->cara_bayar!='KERJASAMA'){echo '5';}else{ echo '2';}?></td>
									  <td>Kamar Operasi</td>
									  <td></td>
	...
	<br>
		<div class="form-inline row" align="left" style="margin-left:10px;">
			...
			<?php echo form_open('irj/rjckwitansi/st_cetak_kwitansi_kt');?>
					...
					<span>
						<button type="submit" id="btn-cetak" class="btn btn-primary" onClick="cetak()">Cetak</button>
					</span>									
			<?php echo form_close();?>
			</div>
			<!--<div class="input-group">			
...
function cetak(){
	...
	var myWindow = window.open("<?php echo base_url('irj/rjckwitansi/cetak_faktur_kt')?>/"+no_register+"/"+penyetor+"/", "", "width=200,height=100");
	myWindow.focus();
}
