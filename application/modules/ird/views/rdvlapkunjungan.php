...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			...
			<?php echo form_open('ird/Rdclaporan/data_kunjungan');?>
				<div class="row p-t-20">
					...
					<div class="form-actions">
						<input type="hidden" name="id_poli" value="BA00@IGD (Intalasi Gawat Darurat)">
        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan Kunjungan <?php echo ($id_poli=="SEMUA" ? "Poliklinik IGD":"Poliklinik ".$nm_poli)." ".$date_title; ?></h4></div>
					<?php if($cara_bayar!='SEMUA'){ ?>
						...
						<div class="panel-body">
							<div style="display:block;overflow:auto;">
								...
								<?php 
								if ($tampil_per=="TGL") {  
									include("rdvlapkunjungan_harian.php");
								} else if ($tampil_per=="BLN") {
									include("rdvlapkunjungan_bulanan.php");
								} else if ($tampil_per=="THN") {  
									include("rdvlapkunjungan_tahunan.php");
								} 
							...
							<div class="form-inline" align="right">
								<div class="form-group">
									<!--<a target="_blank" href="<?php// echo site_url('ird/rdclaporan/lap_kunj_poli/'.$tgl_awal.'/'.$tgl_akhir);?>"><input type="button" class="btn btn-primary" value="Cetak Detail"></a>-->
									...
									<!-- <a target="_blank" href="<?php echo site_url('ird/rdclaporan/excel_lapkunj_ird/'.$param);?>"><input type="button" class="btn 
									" style="background-color: lime;color:white;" value="EXCEL"></a> -->
									&nbsp;
									<a target="_blank" href="<?php echo site_url('ird/rdclaporan/pdf_lap_kunj_ird/'.$param);?>"><input type="button" class="btn 
									" style="background-color: red;color:white;" value="PDF"></a>
									
									
									
									<!--<?php //echo form_open('ird/Rdclaporan/cetak_lap_kunj');?>
...
function buatajax(){
    ...
    ajaxku = buatajax();
    var url="<?php echo site_url('ird/rdclaporan/data_dokter_poli'); ?>";
    url=url+"/"+id;
    url=url+"/"+Math.random();
