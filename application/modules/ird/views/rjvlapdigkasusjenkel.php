							...
							<?php }else{ ?>
								<table cellpadding="0" cellspacing="0" class="table table-hover table-bordered" border="1">
									<tr>
										...
										<th rowspan="2">Kode ICD10</th>
										<th colspan="2">Kunjungan Baru</th>
										<th rowspan="2">Total Kunjungan Baru</th>
										<th rowspan="2">Total Kunjungan Lama</th>
										<th rowspan="2">Total Kunjungan (B + L)</th>
									</tr>
									<tr>
										<th>L</th>
										<th>P</th>
									...
									<tr>
										...
										<th><?php echo $jumlah_l; ?></th>
										<th><?php echo $jumlah_p; ?></th>
										<th><?php echo $jumlah_lama; ?></th>
										<th><?php echo $jumlah_baru; ?></th>
										<th><?php echo $jumlah_total; ?></th>
									</tr>
								</table>
								<?php } ?>
							</div>							
