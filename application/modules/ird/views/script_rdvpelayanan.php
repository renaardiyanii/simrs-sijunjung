...
$(document).ready(function() {
  ...
  $("#form_add_diet").submit(function(event) {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo base_url().'ird/rdcpelayanan/insert_dietpasien'; ?>",
          dataType: "JSON",
    ...
    table_diagnosa_view = $('#table_diagnosa_view').DataTable({ 
      ...
      "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
      "ajax": {
        "url": "<?php echo site_url('ird/rdcpelayanan/diagnosa_pasien_view')?>",
        "type": "POST",
        "dataType": 'JSON',
        "data": function (data) {
    ...
    // if(carabayar=='BPJS'){
      ...
      table_procedure_view = $('#tabel_procedure_view').DataTable({ 
        ...
        "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
        "ajax": {
          "url": "<?php echo site_url('ird/rdcpelayanan/procedure_pasien_view')?>",
          "type": "POST",
          "dataType": 'JSON',
          "data": function (data) {
            data.no_register = '<?php echo $no_register;?>';
...
function cek_diag_utama(){
  $.ajax({
          type: "POST",
          url: "<?php echo base_url().'ird/rdcpelayanan/cek_diag'; ?>",
          dataType: "JSON",
          data: {"no_register" : "<?php echo $no_register;?>"},
          success: function(data){
        if (data == '1') {
...
function pilih_tindakan_lab(id_tindakan) {
   // alert("<?php echo site_url('ird/rdcpelayanan/get_biaya_tindakan'); ?>");
	$.ajax({
		type:'POST',
		dataType: 'json',
...
function insert_diagnosa(){
  if ($('#diagnosa_separate').val() !='' && $('#id_diagnosa').val()!='') {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url().'ird/Diagnosa/insert_ird'; ?>",
        dataType: "JSON",
...
//     $.ajax({
//         type: "POST",
//         url: "<?php echo base_url().'procedure/insert_ird'; ?>",
//         dataType: "JSON",
