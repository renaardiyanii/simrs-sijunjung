...
$(function() {
 ...
 //    $('#form_input_keluarga').hide();
    ...
    //     placeholder: '-- Cari Kota/Kabupaten, Kecamatan atau Kelurahan --',
    //     ajax: {
    //       url: '<?php echo site_url('ird/rdcregistrasi/get_wilayah'); ?>',
    //       dataType: 'json',
    //       delay: 250,
    //       processResults: function (data) {
    //         var results = [];
...
function ajaxkec(id){
    ...
    url=url+"/"+res[0];
    url=url+"/"+Math.random();ird/rdcregistrasi/pasien
...
// 	else {
//     ajaxku = buatajax();
//     var url="<?php echo site_url('ird/rdcwebservice/check_no_rujukan'); ?>";
...
function cek_no_kartu(no_kartu, no_kartu_old){
	$.ajax({
		type:'POST',
		dataType: 'json',
		url:"<?php echo base_url('ird/rdcregistrasi/cek_available_nokartu')?>/"+no_kartu+"/"+no_kartu_old,
		success: function(data){
			//alert(data);
			if (data>0) {
									...
									<div class="col-sm-8">
										<div class="input-group">
											<div class="demo-radio-button mt-1">
												<input name="kekhususan" type="radio" id="cacat_1" class="with-gap" value="jalan_tanpa_bantuan" />
												<label for="cacat_1">Jalan Tanpa Bantuan</label>
												<input name="kekhususan" type="radio" id="cacat_2" class="with-gap" value="kursi_roda" />
												<label for="cacat_2">Kursi Roda</label>
												<input name="kekhususan" type="radio" id="cacat_3" class="with-gap" value="brankar" />
												<label for="cacat_3">Brankar</label>
												<input name="kekhususan" type="radio" id="cacat_4" class="with-gap" value="datang_sendiri" />
												<label for="cacat_4">Datang Sendiri</label>
									...
									<div class="col-sm-8">
										<div class="form-inline">
												<select id="id_poli" class="form-control select2" style="width: 100%" name="id_poli" required>
													<option value="<?php echo $poli->id_poli;echo $poli->nm_pokpoli;?>" selected><?php echo $poli->nm_poli; ?></option>
												</select>
										</div>
									</div>
								</div>
									...
									<div id="input_kecelakaan">
										<div class="form-group row">
											...
											<div class="col-sm-8">
												...
												<input type="text" class="form-control m-t-10" placeholder="Jenis Kecelakaan" name="jenis_kecelakaan" >
