...
<script type='text/javascript'>
	...
	$(function() {
		...
		$('.auto_search_by_nonrp').autocomplete({
			serviceUrl: site+'/ird/rdcautocomplete/data_pasien_by_nonrp',
	...
	function cek_no_identitas(no_identitas){
		...
		$.ajax({
			type:'POST',
			dataType: 'json',
			url:"<?php echo base_url('ird/rdcregistrasi/cek_available_noidentitas')?>/"+no_identitas+"/",
	...
	function cek_alamat_nik(nik){
		if(nik!=''){
			...
			$.ajax({
				type:'POST',
				dataType: 'json',
				url:"<?php echo base_url('ird/rdcregistrasi/cek_alamat_nik')?>/"+nik,
				success: function(data){
					//alert(data);
    ...
    function myTimer() {
        $.ajax({
            type: 'GET',
            url: '<?php echo site_url(); ?>ird/rdcregistrasi/cek_temp/loket3',
            dataType: "json",
...
<div class="card card-outline-info">
	<div class="card-header">
        <h4 class="m-b-0 text-white text-center">PENDAFTARAN PASIEN BARU IGD</h4>
    </div>
    <div class="card-block p-b-15">
    <!-- <?php echo form_open_multipart('ird/rdcregistrasi/insert_data_pasien');?>	 -->
    				<form method="POST" onsubmit="return validate(this)" action="<?php echo base_url('ird/rdcregistrasi/insert_data_pasien')?>">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<div class="input-group">
                                        <input type="text" class="form-control" name="no_kartu" id="no_bpjs" onkeypress="return inputNumbersOnly(event)" maxlength="16">
