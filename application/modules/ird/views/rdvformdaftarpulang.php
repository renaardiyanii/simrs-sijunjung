		...
		<div class="row">			
			...
			<div class="card card-outline-info">
					<div class="card-header">
						<center><h4 class="text-white"> Daftar Pasien IRD Tanggal <b><?php echo date('d-m-Y', strtotime("-4 days")) ?></b> s/d <b><?php echo  date('d-m-Y') ?></b></h4></div>
							...
							<thead>
							  ...
							  <tbody><?php //if($search_per=='nama' || $search_per=='alamat') { ?>
								...
								?>
									<tr>
									<td>
											<a href="<?php echo site_url("ird/rdcpelayanan/pelayanan_tindakan/".$row->id_poli."/".$no_register);?>" class="btn btn-danger btn-xs">Tindak (Perawat)</a>
											<a href="<?php echo site_url("ird/rdcpelayananfdokter/pelayanan_tindakan/".$row->id_poli."/".$no_register);?>" class="btn btn-success btn-xs">Tindak (Dokter)</a>
