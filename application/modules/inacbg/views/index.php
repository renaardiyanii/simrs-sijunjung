    ...
    $('#table-pelayanan tbody').on('click', 'td.details-control', function () {
        ...
        if (row.child.isShown()) {
            ...
            $('#id_diagnosa').select2({
              ...
              ajax: {
                type: 'GET',
                url: '<?php echo base_url().'inacbg/diagnosa/select2_inacbg'; ?>',
                dataType: 'JSON',          
                delay: 250,
              ...
              if (data.length > 0) {
                $.ajax({
                  type: "POST",
                  url: "<?php echo site_url('inacbg/diagnosa/insert')?>",
                  dataType: "JSON",
                  data: {
            ...
            $('#id_procedure').select2({
              ...
              ajax: {
                type: 'GET',
                url: '<?php echo base_url().'inacbg/procedure/select2_inacbg'; ?>',
                dataType: 'JSON',          
                delay: 250,
                processResults: function (data) {            
                  return {
              ...
              if (data.length > 0) {
                $.ajax({
                  type: "POST",
                  url: "<?php echo site_url('inacbg/procedure/insert')?>",
                  dataType: "JSON",
                  data: {
                    "no_register" : no_register,
                    "tgl_masuk" : $('#tgl_masuk').val(),
            ...
            table_diagnosa = $('#table_diagnosa').DataTable({ 
              ...
              "ajax": {
                "url": "<?php echo site_url('inacbg/diagnosa/get_diagnosa_inacbg')?>",
                "type": "POST",
                "dataType": 'JSON',
                "data": function (data) {
            ...
            table_procedure = $('#table_procedure').DataTable({ 
              ...
              "lengthMenu": [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
              "ajax": {
                "url": "<?php echo site_url('inacbg/procedure/get_procedure')?>",
                "type": "POST",
                "dataType": 'JSON',
                "data": function (data) {
                  data.no_register = no_register;
...
function get_claim_data(){
  ...
  function set_utama_diagnosa(id_diagnosa_pasien) {
    swal({
      ...
      closeOnConfirm: true
        ...
        $.ajax({
          type: 'POST',
          url: "<?php echo site_url('inacbg/diagnosa/set_utama')?>",
          dataType:"JSON",
  ...
  function delete_diagnosa(id) {       
    swal({
      ...
      showLoaderOnConfirm: true,
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url().'inacbg/diagnosa/delete'; ?>",
          dataType: "JSON",        
  ...
  function delete_procedure(id) {       
    swal({
      ...
      showLoaderOnConfirm: true,
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url().'inacbg/procedure/delete'; ?>",
          dataType: "JSON",                    
  ...
  function check_login() {
    $.ajax({
      type: "GET",
      url: "<?php echo site_url('user/login/ajax_check')?>",
      dataType: "JSON",
      success: function(result) {
        if (result === 0) {
          swal({
