        ...
        <div class="card card-block printableArea">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <hr>
					<?php
						//echo form_open('lab/labckwitansi/st_cetak_kwitansi_kt',array('target'=>'_blank'));
					?>
					<form id="cetakKwitansi">
						...
						<input type="hidden" class="form-control" name="no_lab" id="no_lab" value="<?php echo $no_lab ?>">
...
function submitPembayaran()
{
	...
	$.ajax({  
		url:"<?= base_url() ?>/lab/labckwitansi/st_cetak_kwitansi_kt",                         
		method:"POST",  
		data:data,   
		...
		{ 
			...
			function () {
				window.open('<?php echo base_url() ?>'+'lab/labckwitansi/cetak_kwitansi_kt/'+'<?= $no_lab ?>','_blank');
				 window.location.href = '<?php echo base_url() ?>'+"lab/labckwitansi/kwitansi";
	...
	function cetak(){
		...
		var myWindow = window.open("<?php echo base_url('lab/labckwitansi/cetak_kwitansi_kt')?>/"+no_lab+"/"+penyetor+" ", "", "width=200,height=100");
		myWindow.focus();
	}
	...
	function showswal() {
		...
		function () {
			window.location.href = base+"lab/labckwitansi/kwitansi";
		});
	}
