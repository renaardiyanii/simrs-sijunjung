...
<body class="A4">
   ...
   foreach ($medrec as $kol) {
    $register .= $this->labmdaftar->get_nolab_pemeriksaan_lab($kol->no_medrec)->result();
        ...
        HASIL PEMERIKSAAN LABORATORIUM
            ...
            <table  border="0" cellpadding="0" cellspacing="1" width="100%">
                ...
                <br>
                    ...
                    <?php //$tgl_isi = $this->labmdaftar->get_isi_hasil_lab($row->no_lab)->result(); ?>
                    <br/>
