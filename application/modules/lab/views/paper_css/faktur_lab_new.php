                ...
                FAKTUR LABORATORIUM 
					...
					<table border="0" width="100%">
						...
						<tr>
							...
							<td>: </td>
							<td><?php 
								if($data_pasien->idrg == 'BI00' && $data_pasien->kelas == 'NK') {
									echo 'MCU';
								} else if($data_pasien->idrg == 'BI03' && $data_pasien->kelas == 'EKSEKUTIF') {
									echo 'MCU EKSEKUTIF';
								} else if($data_pasien->idrg != 'BI00' && $data_pasien->idrg != 'BI03' && $data_pasien->kelas == 'EKSEKUTIF') {
									echo 'EKSEKUTIF';
								} else {
                    ...
                    <p style = "font-weight:bold; font-size: 12px; text-align: left;">Tindakan Non Hematologi :</p>
						...
						<?php
                            ...
                            foreach($data_pemeriksaan as $row){
                                ...
                                <tr>
                                    ...
                                    <td><p><?= number_format( $row->biaya_lab, 2 , ',' , '.' )?></p></td>
                                    <td><p><?= $row->qty ?></p></td>
                                    <td><p><?= $vtot ?></P></td>
                                </tr>
                        <?php } ?>
                    ...
                    <p style = "font-weight:bold; font-size: 12px; text-align: left;">Tindakan Hematologi :</p>
                    ...
                    <table border="1" id="data">
						...
						<?php
                            $i=1;
                            $jumlah_vtot=0;
                            foreach($data_pemeriksaan_hema as $row){
                                $jumlah_vtot=$jumlah_vtot+$row->vtot;
                                $vtot = number_format( $row->vtot, 2 , ',' , '.' );?>
                                <tr>
                                    <td><p><?= $i++?></p></td>
                    ...
                    <p style = "font-weight:bold; font-size: 12px; text-align: left;">Tindakan Mikrobiologi :</p>
                    ...
                    <table border="1" id="data">
						...
						<?php
                            $i=1;
                            $jumlah_vtot=0;
                            foreach($data_pemeriksaan_mikro as $row){
                                $jumlah_vtot=$jumlah_vtot+$row->vtot;
                                $vtot = number_format( $row->vtot, 2 , ',' , '.' );?>
                                <tr>
                                    <td><p><?= $i++?></p></td>
