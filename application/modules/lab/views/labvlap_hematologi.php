...
function down_excel(){
    ...
    window.open('<?php echo site_url('lab/labclaporan/excel_lap_hematologi');?>/'+date1+'/'+tindakan, '_blank');      
}
...
function get_bln(){
    ...
    $.ajax({
        url: "<?php echo base_url();?>lab/labclaporan/lap_hematologi_exe/"+date1+"/"+tindakan,
        beforeSend: function() {
