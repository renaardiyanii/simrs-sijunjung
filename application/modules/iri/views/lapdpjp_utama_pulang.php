...
function down_excel(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>iri/riclaporan/excel_lap_dpjp_utama_tgl_pulang/"+date+"/"+ppa;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>iri/riclaporan/excel_lap_dpjp_utama_pulang/"+bln+"/"+ppa;
    }
...
function get_bln(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>iri/riclaporan/lap_dpjp_pulang_exe_tgl/"+date+"/"+ppa;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>iri/riclaporan/lap_dpjp_pulang_exe/"+bln+"/"+ppa;
    }
