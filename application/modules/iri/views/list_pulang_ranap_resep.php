	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">		
					...
					<h4  class="text-white" align="center">Cetak Resep Pasien Pulang Rawat Inap</h4>

			</div>
			<div class="card-block">
				<div class="row">
					<form action="<?php echo base_url();?>iri/ricmedrec/cetak_resep_ranap" method="post" accept-charset="utf-8">
							...
							<?php 
								...
								foreach($data_tind as $val){ 
									...
									<tr>
										<td><?php echo $i++ ?></td>
										<td>
											<a href="<?php echo base_url(); ?>iri/ricmedrec/cetak_list_resep/<?php echo $val->no_ipd?>" target="_blank"><button type="button" class="btn btn-danger btn-sm" ><i class="fa fa-plusthick"></i> Cetak</button></a>
										</td>
