...
<div class="row">
	<div class="col-lg-12">
        ...
        <?php
        if($ppa_sebagai == 'dokter_dpjp' || $ppa_sebagai == "Dokter Bersama" || $ppa_sebagai =='Kosultasi 1x' || strpos($ppa_sebagai,'sebelumnya')  ){
        ?>
       ...
       <li class="nav-item"> <a class="nav-link <?= $tab_transfer_ruangan; ?>" data-toggle="tab" href="#tabTransferRuangan" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Transfer Ruangan</span></a> </li>
        ...
        <?php }elseif($ppa_sebagai == "Fisioterapis" || $ppa_sebagai =='Okupasi Terapi' || $ppa_sebagai == 'Ortotik Prostetik' || $ppa_sebagai == 'Terapi Wicara' ){ ?>
         ...
         <li class="nav-item"> <a class="nav-link <?=$tab_rad?>" data-toggle="tab" href="#tabRadiologi" role="tab"><span class="hidden-xs-down">Radiologi</span></a></li>  
          ...
          <li class="nav-item"> <a class="nav-link <?= $tab_persalinan_normal; ?>" data-toggle="tab" href="#tab_persalinan_normal" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Persalinan Normal</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_obs_khusus_pengkajian_nyeri; ?>" data-toggle="tab" href="#tab_obs_khusus_pengkajian_nyeri" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Catatan Observasi Khusus Dan Pengkajian Nyeri</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_asesmen_risiko_jatuh_dewasa; ?>" data-toggle="tab" href="#tab_asesmen_risiko_jatuh_dewasa" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Monitoring Asesmen Risiko Jatuh Orang Dewasa</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_asesmen_risiko_jatuh_anak; ?>" data-toggle="tab" href="#tab_asesmen_risiko_jatuh_anak" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Monitoring Asesmen Nyeri Pada Pasien Anak 1-7 Tahun</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_pengkajian_resiko_jatuh_anak; ?>" data-toggle="tab" href="#tab_pengkajian_resiko_jatuh_anak" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Pengkajian Resiko Jatuh Pada Pasien Anak (Skala Humpty Dumty)</span></a> </li>
          ...
          <li class="nav-item"> <a class="nav-link <?= $tab_gizi_anak; ?>" data-toggle="tab" href="#tab_gizi_anak" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">SKRINING GIZI ANAK LANJUT</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_monitoring_nyeri_dewasa; ?>" data-toggle="tab" href="#tab_monitoring_nyeri_dewasa" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">MONITORING ASESMEN NYERI PADA PASIEN DEWASA</span></a> </li>
          <li class="nav-item"> <a class="nav-link <?= $tab_monitoring_nyeri_anak; ?>" data-toggle="tab" href="#tab_monitoring_nyeri_anak" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">MONITORING ASESMEN NYERI PADA PASIEN ANAK</span></a> </li>
          ...
          <li class="nav-item"> <a class="nav-link <?= $tab_nyeri_komprehensif; ?>" data-toggle="tab" href="#tab_nyeri_komprehensif" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Pengkajian Nyeri Komprehensif</span></a> </li>
        ...
        <div id="tab_nyeri_komprehensif" class="tab-pane <?= $tab_nyeri_komprehensif ?>" role="tabpanel">
          <div class="p-20">
            <?php include('survey/nyeri_komprehensif/nyeri_komprehensif.php'); ?>
          </div>
        </div>
        ...
        <div id="tab_monitoring_nyeri_dewasa" class="tab-pane <?= $tab_monitoring_nyeri_dewasa ?>" role="tabpanel">
          <div class="p-20">
            <?php include('survey/monitoring_nyeri_dewasa/monitoring_nyeri_dewasa.php'); ?>
          </div>
        </div>
        ...
        <div id="tab_obs_khusus_pengkajian_nyeri" class="tab-pane <?= $tab_obs_khusus_pengkajian_nyeri ?>" role="tabpanel">
          <div class="p-20">
            <?php include('survey/obs_khusus_pengkajian_nyeri/catatan_observasi_khusus.php'); ?>
          </div>
        </div>

        <div id="tab_persalinan_normal" class="tab-pane <?= $tab_persalinan_normal ?>" role="tabpanel">
          <div class="p-20">
            <?php include('survey/persalinan_normal/persalinan_normal.php'); ?>
          </div>
        </div>
        ...
        <div id="tab_pengkajian_resiko_jatuh_anak" class="tab-pane <?= $tab_pengkajian_resiko_jatuh_anak ?>" role="tabpanel">
          <div class="p-20">
            <?php include('survey/pengkajian_resiko_jatuh_anak/pengkajian_resiko_jatuh_anak.php'); ?>
          </div>
        </div>
