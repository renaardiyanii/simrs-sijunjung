						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								...
								<div class="form-inline">
									<input type="date" id="date_picker" class="form-control date_picker" placeholder="Tanggal Awal" name="date0">
									&nbsp;&nbsp;s/d&nbsp;&nbsp;
									<input type="date" id="date_picker" class="form-control date_picker" placeholder="Tanggal Akhir" name="date1">
									&nbsp;&nbsp;									
