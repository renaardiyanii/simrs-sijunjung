        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan Visite Dokter Bersama Utama</h4></div>					
...
function down_excel(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>iri/riclaporan/excel_lap_visite_raber_exe_tgl/"+date1;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>iri/riclaporan/excel_lap_visite_raber_exe_bln/"+bln;
    }
...
function get_bln(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>iri/riclaporan/lap_visite_raber_exe_tgl/"+date1;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>iri/riclaporan/lap_visite_raber_exe_bln/"+bln;
    }
