		...
		<section class="content">
				<div class="row">
						<div class="card card-outline-info">
							<div class="card-header text-white" align="center" >Laporan Masuk Pasien Rawat Inap <br> 
				...
				<?php
					...
					<tr>
						...
						<td></td>
						<td> <?php echo date('H:i:s',strtotime($r['tgldaftarri']));?></td>
						<td> <?php echo date('H:i:s',strtotime($r['wkt_masuk_rg']));?></td>
				...
				?>
						...
						<div class="form-inline" align="right">
							<div class="form-group">
								...
								<a target="_blank" href="<?php echo site_url('iri/riclaporan/excel_lapmasuk_iri/');?><?php echo $tgl_awal.'/'.$tgl_akhir;?>"><input type="button" class="btn 
