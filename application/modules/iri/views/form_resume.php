...
$(function(){
	...
	$('.auto_diagnosa_pasien').autocomplete({
		...
		onSelect: function (suggestion) {
			...
			$('#nm_diagnosa2').val(''+suggestion.nm_diagnosa);
					...
					<div class="p-20">						
						<div class="row">
							...
							<div class="col-sm-6">
											...
											<!-- <div class="form-group row">
												<label for="" class="col-sm-4 col-form-label">Obat Akhir</label>

												<div class="form-group row">
												<div class="offset-sm-4 col-sm-8">
													<a href="<?php echo base_url()?>iri/rictindakan/tambah_diagnosa/<?php echo  $data_pasien[0]['no_ipd'] ;?>"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Obat</button></a>
												</div>
											</div> -->
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<select class="form-control" name="cara_pulang">
														...
														<option value="pindah_rs">PINDAH RS</option>
						...
						<div class="row">
							<div class="col-md-12">
          						<div class="form-actions"> 
									...
									<a class="btn btn-danger" target="_blank" href="<?php echo base_url()?>/emedrec/C_emedrec_iri/cetak_resume_medis_iri/<?php echo  $data_pasien[0]['no_ipd'] ;?>"><i class="fa fa-print"></i> Cetak Resume Medik</a>												
								</div>
							</div>
						</div>
					</div> <!-- p-20 -->
