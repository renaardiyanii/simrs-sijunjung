...
var site = "<?php echo site_url(); ?>";
var poli = "<?php echo $data_pasien[0]['nm_poli']?>";
$(function(){
	$('.auto_no_register_dokter').autocomplete({
		serviceUrl: site+'/iri/ricpendaftaran/data_dokter_autocomp/'+poli ,
		onSelect: function (suggestion) {
			$('#id_dokter').val(''+suggestion.id_dokter);
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="form-group row">
								...
								<div class="col-md-7">
									<span class="label-form-validation"></span>
									<input type="date" class="form-control input-sm" id="calendar-tgl-rencana-masuk" name="tglrencanamasuk" value="<?php echo date('Y-m-d') ?>" min="<?php echo date('Y-m-d') ?>" onchange="getemptyroom(this.value)" required>
								</div>
							</div>
							 <div class="form-group row">
						...
						<div class="col-md-12">
							...
							<div class="form-group row">
												...
												<div class="col-sm-9">
													...
													<input type="text" class="form-control auto_no_register_dokter" id="nmdokter" name="nmdokter" value="<?php if(isset($data_pasien[0]['nm_dokter'])){echo $data_pasien[0]['nm_dokter'];}?>" required>
												</div>
											</div>
							<!-- <div class="form-group row">
					...
					<div class="card-block">
						<form class="form-horizontal" method="POST" id="formsearchok">
							<div class="form-group row">
								...
								<div class="col-md-4">
									<div class="">
										<input type="date" min="<?php echo date('Y-m-d') ?>" id="tglok" class="form-control tgl_jadwal_ok" placeholder="Tanggal Jadwal OK" name="tglok" required>
									</div>
								</div>
						...
						<form class="form-horizontal" method="POST" id="formsearchbed">
							<div class="form-group row">
								...
								<div class="col-md-4">
									<div class="">
										<input type="date" min="<?php echo date('Y-m-d') ?>" id="tglbed" class="form-control tgl_jadwal_ok" placeholder="Tanggal Reservasi" name="tglbed" required>
									</div><!-- /input-group -->
								</div>
