...
<div class="card m-5">
	...
	<div class="card-body">
		...
		<div class="input-group">
			<a href="<?php echo base_url('rad/radcdaftar/cetak_order/').$data_pasien[0]['no_ipd']; ?>" target="_blank" class="btn btn-primary">Order</a>&nbsp;&nbsp;
		...
		<div class="table-responsive m-t-0">
			<table id="tabel_rad" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0" width="100%">
				...
				if(!empty($list_rad_pasien)){
					if($data_pasien[0]['rad'] == '1'){ ?>

						<!-- <tr>
							<td colspan="8"><a href="<?php echo base_url().'rad/radcdaftar/batal_kunjung/'.$data_pasien[0]['no_ipd']; ?>/ri" class="btn text-white btn-xs"  style="background-color: red;">Batal Kunjungan <i class="ti-trash"></i></a></td>
						</tr> -->
...
<script>
    function inputradiologi() {
        ...
        //     if (result.isConfirmed) {
				window.open("<?php echo base_url('rad/radcdaftar/pelayanan_rad/'.$data_pasien[0]['no_ipd'].'/DOKTER')?>", "_self");
