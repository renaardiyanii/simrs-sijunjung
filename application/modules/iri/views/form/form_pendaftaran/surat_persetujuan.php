...
<script>
	...
	<?php } else { ?>
		surveyPersetujuan.data = {
			"penanggung_jawab_pasien": {
				"nama": "<?php echo isset($data_pasien_iri->nmpjawabri) ? $data_pasien_iri->nmpjawabri : '' ?>",
				"no_identitas": "<?php echo isset($data_pasien_iri->noidpjawab) ? $data_pasien_iri->noidpjawab : '' ?>",
				"umur": "<?php echo $tahunpj ?>",
			...
			"identitas_pasien": {
				...
				"alamat": "<?php echo isset($data_pasien[0]['alamat']) ? trim($data_pasien[0]['alamat']) : '' ?>",
