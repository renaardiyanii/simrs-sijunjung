...
// var_dump($pasien_iri[0]->jatahklsiri);die();
//  var_dump($all_kelas);die();
?>
<style>
...
<script>
    ...
    function getRuanganBedIbu(no_ipd_ibu) {
        ...
        // ajaxku.send(null);
        $.ajax({
            url: "<?php echo site_url('iri/rictindakan/data_bed_ruangan_ibu'); ?>" + `/${no_ipd_ibu}/${Math.random()}`,
            beforeSend: function() {},
            ...
            <div class="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="id_kontraktor_old" value="<?php echo $data_pasien[0]['id_kontraktor']; ?>" id="id_kontraktor_old">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control input-sm select2" name="carabayar" onchange="update_form_bpjs(this.value)" id="cara_bayar">
                            ...
                            foreach ($cara_bayar as $r) {
                                if (isset($pasien_iri[0]->carabayar)) {
                                    if (!$pasien_iri[0]->carabayar) {
                                        ...
                                        if ($r['cara_bayar'] == $pasien_iri[0]->cara_bayar) {
                                        ?>
                                            <option value="<?php echo $r['cara_bayar']; ?>" selected><?php echo $r['cara_bayar']; ?></option>
                                        <?php
                                        } else {
                            ...
                            <?php }
                                    ...
                                    echo '
                                        <option value="' . $r['cara_bayar'] . '">' . $r['cara_bayar'] . '</option>
                                    ';
                                }
                            }
                            ?>
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="hidden" class="form-control input-sm" name="id_dokter" id="id_dokter" value="<?php if (isset($data_pasien[0]['id_dokter'])) {
                                                                                                                        echo $data_pasien[0]['id_dokter'];
                                                                                                                    } ?>">
                        <input type="hidden" class="form-control input-sm" id="nmdokter" name="nmdokter" value="<?php if (isset($data_pasien[0]['nm_dokter'])) {
                                                                                                                    echo $data_pasien[0]['nm_dokter'];
                                                                                                                } ?>" required>
                        <input type="text" class="form-control input-sm auto_no_register_dokter" id="nmdokter2" name="nmdokter1" value="<?php if (isset($data_pasien[0]['nm_dokter'])) {
                                                                                                                                            echo $data_pasien[0]['nm_dokter'];
                                                                                                                                        } ?>" required>
                ...
                <div class="form-group row hidebayi">
                    ...
                    <div class="col-sm-9">
                        ...
                        if (empty($kelas)) {
                        ?>
                            <select class="form-control select2" id="ruang" name="ruang" onchange="get_bed(this.value)">
                                <option value="" selected="true">Semua Kelas Penuh</option>
                            </select>
                            <?php
                        } //end dari empty kelas

                        else { //start dari not empty kelas
                            if (empty($status_bed)) { //start dari empty status bed
                            ?>
                                <select class="form-control input-sm select2" id="ruang" name="ruang" onchange="get_bed(this.value)">
                            ...
                            <?php
                            } //end dari empty status bed 
                            else { // start dari not empty status bed
                            ?>
                                <select class="form-control input-sm select2" id="ruang" name="ruang" onchange="get_bed(this.value)">
                                    ...
                                    <?php
                                    // var_dump($kelas);die();
                                    foreach ($kelas as $r) { //start foreach dari status kelas 
                            ...
                            <?php
                                ...
                                } //end dari not empty status bed
                            } // end dari not empty kelas
                            ?>
                                </select>
                    </div>
                </div>
                <div class="form-group row hidebayi">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control input-sm select2" id="bed" name="bed">
                        </select>
                    </div>
                </div>
        ...
        <div class="col-sm-6 form-right">
            <div class="box-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control input-sm" disabled="true" name="nama_disp" value="<?php echo ($data_pasien[0]['nm_poli']) ?? $irna_reservasi[0]['nm_poli'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control input-sm" disabled="true" name="nama_disp" value="<?php echo $diagnosa_pasien ? $diagnosa_pasien[0]->id_diagnosa . '-' . $diagnosa_pasien[0]->diagnosa : $irna_reservasi[0]['diagnosa'].'-'.$irna_reservasi[0]['nm_diagnosa']; ?>">
                        <input type="hidden" name="diagnosa_id" value="<?php echo $diagnosa_pasien ? $diagnosa_pasien[0]->id_diagnosa . '-' . $diagnosa_pasien[0]->diagnosa : $irna_reservasi[0]['diagnosa'].'-'.$irna_reservasi[0]['nm_diagnosa']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <!-- <div class="col-sm-3">
                        ...
                        <div class="demo-checkbox">
                            <input type="checkbox" class="filled-in" value="1" name="selisih_tarif" id="selisih_tarif" />
                            <label for="selisih_tarif">Selisih Tarif</label>
                        </div>
                        <div class="demo-checkbox">
                            <input type="checkbox" class="filled-in" value="1" name="naik_1_tingkat" id="naik_1_tingkat" />
                            <label for="naik_1_tingkat">Naik 1 Tingkat</label>
                        </div>
                    </div> -->
                </div>
            </div>
