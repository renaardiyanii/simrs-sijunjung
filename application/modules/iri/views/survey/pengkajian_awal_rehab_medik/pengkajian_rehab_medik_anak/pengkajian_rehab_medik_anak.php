...
<div class="card m-5">
    <div class="body">
    <div id="PengkajianRehabMedikAnak"></div>
...
surveyJSONPengkajianRehabMedikAnak = <?php echo file_get_contents("pengkajian_rehab_medik_anak.json",FILE_USE_INCLUDE_PATH);?>;

function sendDataToServerPengkajianRehabMedikAnak(survey) {
    ...
    var pengkajian_rehab_medik_view = new Survey.Model(surveyJSONPengkajianRehabMedikAnak);
...
// survey.css = myCss;
$("#PengkajianRehabMedikAnak").Survey({
    model: pengkajian_rehab_medik_view,
    onComplete: sendDataToServerPengkajianRehabMedikAnak
});
</script>