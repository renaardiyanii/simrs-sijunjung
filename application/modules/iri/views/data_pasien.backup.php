					...
					<div class="card-block">
						...
						<br/>
							<div class="row" style="align: center;">
								<div class="col-md-12">
										<a href="<?php echo base_url().'emedrec/C_emedrec/rekam_medik_detail/'.$data_pasien[0]['no_cm'].'/'.$data_pasien[0]['no_medrec'].'/'.$data_pasien[0]['no_ipd'].'/'.$data_pasien[0]['noregasal'] ?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary" style="margin-left: 45%;width: 20%;">E-KAMEK</a>									
								</div>								
							</div>
					</div>
				</div>
				...
				<div class="card card-outline-danger">
					...
					<div class="card-header text-white" align="center">Status Pulang</div>
						<div class="card-block">
							...
							<?php 
							if($data_pasien[0]['verifikasi_plg'] != 1){
							?>

							<form action="<?php echo site_url('iri/rictindakan/update_verifikasi_plg'); ?>" method="post">
								<div class="form-check">
									<input class="form-check-input" type="checkbox" id="verifikasi_plg" name="verifikasi_plg" value=1>
									<label for="verifikasi_plg" class="form-check-label">Verifikasi</label>
								</div>
					...
					<?php } ?>
					<div class="card card-outline-info">
						<div class="card-header text-white" align="center" >Punya Bayi</div>
							<div class="card-block">
								<form action="<?php echo site_url('iri/rictindakan/update_punya_bayi'); ?>" method="post">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="punya_bayi" name="punya_bayi" value=1 <?php echo isset($data_pasien[0]['punya_bayi'])? $data_pasien[0]['punya_bayi'] == "1" ? "checked":'':'' ?>>
										<label for="punya_bayi" class="form-check-label">Ya</label>
									</div>
									<div class="form-inline" align="right">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['no_ipd'];?>" name="no_ipd">
										<div class="form-group" align="right">
					...
					<div class="card card-outline-info">
						<div class="card-header text-white" align="center" >Selisih Tarif</div>
							<div class="card-block">
								<form action="<?php echo site_url('iri/rictindakan/update_pindah_ruangan'); ?>" method="post">
									<!-- <div class="form-check">
										<input class="form-check-input" type="checkbox" id="pindah_ruang" name="pindah_ruang" value=1 <?php echo isset($data_pasien[0]['pindah_ruang'])? $data_pasien[0]['pindah_ruang'] == "1" ? "checked":'':'' ?>>
										<label for="pindah_ruang" class="form-check-label">Pindah Ruangan</label>
									</div> -->

									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="selisih_tarif" name="selisih_tarif" value=1 <?php echo isset($data_pasien[0]['selisih_tarif'])? $data_pasien[0]['selisih_tarif'] == "1" ? "checked":'':'' ?>>
										<label for="selisih_tarif" class="form-check-label">Selisih Tarif</label>
									</div>
									<div class="form-inline" align="right">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['no_ipd'];?>" name="no_ipd">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['idrg'];?>" name="idrg">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['bed'];?>" name="bed">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['klsiri'];?>" name="kelas">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['noregasal'];?>" name="noregasal">
										<input type="hidden" class="form-control" value="<?php echo $data_pasien[0]['no_medrec'];?>" name="no_medrec">
