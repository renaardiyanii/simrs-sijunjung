...
<script src="<?= base_url('assets/') ?>/surveyjswidget.min.js"></script>
<script>
    function closepage(){
        // alert()
        window.top.close();
...
<div class="card m-5">
  ...
  <div class="card-body">
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?= $data_pasien[0]['nama'] ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">No. Medrec</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= $data_pasien[0]['no_cm'] ?>" readonly>
        </div>

        <label for="nama" class="col col-form-label">No. Register</label>
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?= $data_pasien[0]['no_ipd'] ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">Tgl. Lahir</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= date('d-m-Y',strtotime($data_pasien[0]['tgl_lahir'])) ?>" readonly>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="alamat" value="<?= $data_pasien[0]['alamat'] ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">Gol Darah</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= $data_pasien[0]['goldarah'] ?>" readonly>
        </div>

        <label for="nama" class="col col-form-label">Tgl. Kunjungan</label>
        <div class="col">
            <input type="text" readonly class="form-control" id="nama" value="<?= date('d-m-Y',strtotime($data_pasien[0]['tgl_masuk'])) ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">Kelas</label>
        <div class="col">
            <input type="text" class="form-control" id="no_medrec" value="<?= $data_pasien[0]['kelas'] ?>" readonly>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            <input type="text" readonly class="form-control" id="alamat" value="<?= $data_pasien[0]['nm_dokter'] ?>">
        </div>
        <label for="no_medrec" class="col col-form-label">Cara Bayar : </label>
        <div class="col">
        <input type="text" class="form-control" id="no_medrec"  
            value="<?php if($data_pasien[0]['carabayar'] == 'KERJASAMA' or $data_pasien[0]['carabayar'] == 'BPJS') {
                        echo $data_pasien[0]['carabayar'].'('.$data_pasien[0]['nmkontraktor'].')';
                } else{
                        echo $data_pasien[0]['carabayar'];
                }?>" readonly>
        </div>
