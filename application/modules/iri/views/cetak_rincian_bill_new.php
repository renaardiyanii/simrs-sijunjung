                        ...
                        <tbody>
                            ...
                            if($resep_pasien) {
                                foreach($resep_pasien as $obat) { ?>
                                    <tr>
                                        <td><?php echo $obat->nama_gudang;?></td>
                                        <td><?php echo $obat->nama_obat==''?'Obat Racikan':$obat->nama_obat;?></td>
                                        <td><?php echo $obat->qty;?></td>
                                        <td><?php echo number_format($obat->biaya_obat + $obat->embalase); ?></td>
                                        <td>-</td>
                                        <td>-</td>
                                        <td><?php echo number_format($obat->vtot + $obat->embalase);?></td>
                                    </tr>
                            <?php $total_resep += ($obat->vtot + $obat->embalase); }
                             } ?>
                            <?php
                            if($ruang_intensif) {
