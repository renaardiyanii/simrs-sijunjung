...
$(document).ready(function(){
	...
	if ($('#barulahir_v2').prop('checked')==true) {

		$('#input_regibu_v2').show();
		$('.hidebayi').hide();
		...
		$('#input_regibu_v2').hide();

	}

	$('#barulahir_v2').change(function() {
	...
	var cara_bayar = '<?= isset($irna_reservasi[0]->carabayar)?$irna_reservasi[0]->carabayar:null ?>';
	...
	<div class="list-group list-group-flush">
		<div class="list-group-item" >
			...
			<div id="collapseOne" class="collapse show ml-2 mr-2 mt-4" aria-labelledby="headingOne" data-parent="#accordion">
				<?php include('form_daftar_bayi/formpendaftaraniri.php') ?>
		...
		<div class="list-group-item" >
			...
			<div id="collapseTwo" class="collapse ml-2 mr-2 mt-4" aria-labelledby="headingTwo" data-parent="#accordion">
                <?php include('form_daftar_bayi/formpenanggungjawab.php') ?>
		...
		<div class="list-group-item">
			<div class="card-header" id="headingThree">
				<div class="row">
					<div class="img mr-3 ml-3 mt-2">
						<img width="30px" src="<?= base_url('assets/icons/') ?><?= ($general_consent)?'check.png':'uncheck.png' ?>" alt="">
					</div>
					<div >
						<a  data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
						<span class="title" style="font-weight:medium;font-size:12pt">Pengisian Formulir General Consent</span>
						</a><br>
						<span class="subtitle"><?= ($general_consent)?'Pengisian Formulir General Consent Sudah Selesai':'Pengisian Formulir General Consent Belum Selesai' ?></span>
					</div>
			...
			<div id="collapseThree" class="collapse ml-2 mr-2" aria-labelledby="headingThree" data-parent="#accordion">
                <?php include('form_daftar_bayi/form_pendaftaran/general_consent.php'); ?>										
			</div>
		</div>
		...
		<div class="list-group-item ">
			<div class="card-header" id="headingFour">
				<div class="row">
					<div class="img mr-3 ml-3 mt-2">
						<img width="30px" src="<?= base_url('assets/icons/') ?><?= ($surat_persetujuan_iri)?'check.png':'uncheck.png' ?>" alt="">
					</div>
					<div >
						<a  data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
						<span class="title" style="font-weight:medium;font-size:12pt">Pengisian Formulir Surat Persetujuan</span>
						</a><br>
						<span class="subtitle"><?= ($surat_persetujuan_iri)?'Pengisian Formulir Surat Persetujuan Sudah Selesai':'Pengisian Formulir Surat Persetujuan Belum Selesai' ?></span>
					</div>
			...
			<div id="collapseFour" class="collapse ml-2 mr-2" aria-labelledby="headingFour" data-parent="#accordion">
                <?php include('form_daftar_bayi/form_pendaftaran/surat_persetujuan.php'); ?>
			</div>
		</div>
		...
		<div class="list-group-item ">
			<div class="card-header" id="headingFive">
				<div class="row">
					<div class="img mr-3 ml-3 mt-2">
						<img width="30px" src="<?= base_url('assets/icons/') ?><?= ($selisih_tarif)?'check.png':'uncheck.png' ?>" alt="">
					</div>
					<div >
						<a  data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
						<span class="title" style="font-weight:medium;font-size:12pt">Surat Pernyataan Selisih Tarif</span>
						</a><br>
						<span class="subtitle"><?= ($selisih_tarif)?'Pengisian Formulir Surat Pernyataan Selisih Tarif Sudah Selesai':'Pengisian Formulir Surat Pernyataan Selisih Tarif Belum Selesai' ?></span>
					</div>
			...
			<div id="collapseFive" class="collapse ml-2 mr-2" aria-labelledby="headingFive" data-parent="#accordion">
                <?php include('form_daftar_bayi/form_pendaftaran/selisih_tarif/selisih_tarif.php'); ?>
			</div>
		</div>
	</div>
