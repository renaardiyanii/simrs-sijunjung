...
surveyJSONpermintaan_darah = <?php echo file_get_contents("permintaan_transfusi_darah_new.json",FILE_USE_INCLUDE_PATH);?>;

function sendDataToServerpermintaan_darah(survey) {

        $.ajax({
            type: "POST",
            url: '<?= base_url('iri/rictindakan/insert_permintaan_transfusi_darah/') ?>',
            data: {
                no_ipd : '<?php echo $no_ipd;?>',
                permintaan_transfusi_darah_new_json:JSON.stringify(survey.data),
            },
