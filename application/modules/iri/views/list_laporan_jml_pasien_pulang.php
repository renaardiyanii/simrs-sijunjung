			...
			<div class="col-lg-12 col-md-12">	
				<div style="background: #e4efe0">
					<div class="inner">
						...
						<form action="<?php echo base_url();?>iri/riclaporan/lap_jml_pasien_pulang_iri" method="post" accept-charset="utf-8">
						<div class="col-lg-10">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<div class="card">
							...
							<h3 align="center">Laporan Jumlah Kunjungan Pasien Rawat Inap<br> 
							Tanggal <?php echo $tgl_awal; ?> - <?php echo $tgl_akhir; ?></h3>
								<br/>
							</div>
                        ...
                        <div class="form-inline" align="right">
							<div class="form-group">
								<!-- <a target="_blank" href="<?php echo site_url('iri/riclaporan/cetak_laporan_kunjungan_bulanan/');?><?php echo '/'.$tgl_awal.'/'.$tgl_akhir;?>"><input type="button" class="btn 
								btn-primary" value="PDF"></a> -->
								<?php
								//if($tampil_per != "") { ?>
									<a target="_blank" href="<?php echo site_url('iri/riclaporan/cetak_lap_jml_pasien_pulang_iri/');?><?php echo '/'.$tgl_awal.'/'.$tgl_akhir;?>"><input type="button" class="btn 
									btn-warning" value="Excel"></a>
								<?php
								// } else if($tampil_per == "") { ?>
								 	<!-- <a target="_blank" href="<?php echo site_url('iri/riclaporan/cetak_lap_jml_pasien_pulang_iri_today/');?><?php echo '/'.$tgl_awal;?>"><input type="button" class="btn 
								 	btn-warning" value="Excel"></a> -->
								<?php
								// }
								?>
