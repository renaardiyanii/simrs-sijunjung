						  ...
						  <div id="tabtindakan" class="tab-pane active" role="tabpanel">	    								
							...
							<form class="form-horizontal" action="<?php echo site_url('iri/rictindakan/tambah_drbersama'); ?>" method="post">								
								...
								<!-- <div class="form-group row">
									<label class="col-sm-4  control-label col-form-label" id="dirujuk_ke" style="margin-bottom:0px;margin-top:0px;!important">Spesialis *</label>
									<div class="col-sm-8">
										<div class="form-inline">
											<select id="id_poli" class="form-control js-example-basic-single" style="width: 100%"  onchange="ajaxdokterkonsul(this.value)" required>
								...
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="operator">Pilih Dokter</p>
										<div class="col-sm-8">
											<select class="form-control js-example-basic-single" id="id_dokter_konsul" name="operatorTindakan" required>
												<option value="">-Pilih Dokter-</option>
												<?php
												foreach($user_dokter->result() as $val)
												{
												?>
												<option value="<?= $val->id_dokter.'-'.$val->kode_dpjp_bpjs.'-'.$val->nm_dokter ?>"><?= $val->nm_dokter ?></option>
												<?php } ?>
											</select>
										</div>
								</div>								
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="ket" id="r_1" value="dokter_jaga" >
											<label class="form-check-label" for="r_1">Dokter Jaga</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="ket" id="r_2" value="dokter_ruangan" >
											<label class="form-check-label" for="r_2">Dokter Ruangan</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" name="ket" id="r_3" value="case_manager" >
											<label class="form-check-label" for="r_3">Case Manager</label>
										</div>
									</div>
								</div>
...
<script>
	...
	$(document).ready(function() {
		...
		serviceUrl: site+'/iri/ricpendaftaran/data_dokter_autocomp_ver2',
