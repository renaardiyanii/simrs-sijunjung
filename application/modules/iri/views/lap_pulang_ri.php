...
<div class="card p-4">
	<div class="card-body">
		<div class="row">
			<form action="<?php echo base_url();?>iri/riclaporan/lap_pulang_ri" method="post" accept-charset="utf-8">
				<div class="col-lg-12">
...
<div class="card p-4">
	<div class="card-header">
		<div style="text-align:center;font-size:16px">
			<h4>Laporan Pasien Pulang Rawat Inap<br>Tanggal <?php echo $date_title; ?></h4>
		</div>
	</div>
	<div class="card-body">
			...
			<?php
				...
				foreach($data_kunjungan as $r) { ?>
                    <tr>
						...
						<td> <?php echo isset($r['tgldaftarri'])?date('H:i:s',strtotime($r['tgldaftarri'])):'';?></td>
						<td> <?php echo isset($r['wkt_masuk_rg'])?date('H:i:s',strtotime($r['wkt_masuk_rg'])):'';?></td>
						<td><?php echo $r['tgl_masuk'];?></td>
                        <td><?php echo $r['tgl_rencana_pulang'];?></td>
	...
	<div class="form-inline" align="right">
		<div class="form-group">
			<a target="_blank" href="<?php echo site_url('iri/riclaporan/excel_lappulang_iri/');?><?php echo $date.'/'.$tampil;?>"><input type="button" class="btn btn-primary" value="Cetak Laporan Excel"></a>
		</div>
	</div>
</div>
