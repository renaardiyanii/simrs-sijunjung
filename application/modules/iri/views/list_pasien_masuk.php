...
<div class="row">
		<div class="col-md-12">
			<div class="card card-outline-info">
					...
					<form action="<?php echo base_url();?>iri/ricmedrec/list_pasien_masuk_by_medrec" method="post" accept-charset="utf-8">
						...
						<br>
						 <center><h4 class="box-title">Daftar Pasien Masuk Tanggal <b><?php echo date('d F Y', strtotime('-30 days')).' s/d '.date('d F Y');?></b></h4></center>
						<br>
