...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			...
			<?php echo form_open('iri/Riclaporan/lap_wilayah_diagnosa');?>
        ...
        <div class="card">
            <div class="card-block">
				...
				<div class="card-title" align="center" >
						...
						?>
					<h4 align="center">Laporan Kunjungan Wilayah Berdasarkan Diagnosa 
								<?php echo $layananya ?> <?php echo $judul ?> Di Rumah 
								Sakit Otak DR. Drs. M. Hatta Bukittinggi </h4>
				</div>
