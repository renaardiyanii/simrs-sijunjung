<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
  ...
  class M_diet extends CI_Model {
    ...
    private function _get_datatables_query()  {
            ...
            $this->db->select('gizi_permintaan_diet.id,gizi_permintaan_diet.standar,gizi_permintaan_diet.bentuk,master_bentuk_makanan.nama as nm_bentuk,gizi_permintaan_diet.catatan,gizi_permintaan_diet.created_at,gizi_permintaan_diet.created_by'); 
            $this->db->from('gizi_permintaan_diet'); 
            $this->db->join('master_bentuk_makanan', 'gizi_permintaan_diet.bentuk = master_bentuk_makanan.kode','inner');   
