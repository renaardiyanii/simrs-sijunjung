  ...
  <div class="row">
      <?php foreach ($ruangan as $row) { ?>
        ...
        <div class="col-lg-3 col-md-12">
          <a href="<?php echo site_url('gizi/ruangan/'.$row->lokasi); ?>">
            <div class="card card-inverse card-info">
              <div class="card-body">
                <?php foreach ($notif as $key) { ?>
                <?php if ($key->lokasi==$row->lokasi) { ?>
                  <span class="label label-danger pull-right" id="notif">New</span>  
                <?php } } ?>
                <div class="d-flex">
                  <div class="m-r-20 align-self-center">
                      <h1 class="text-white"><i class="fa fa-building"></i></h1>
                  </div>
                  <div>
