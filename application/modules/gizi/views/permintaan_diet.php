      ...
      <div class="card card-outline-info">
          <div class="card-body">
            <center class="m-t-30"> 
              ...
              <h5>No. Register : <?php echo $data_pasien->no_ipd; ?></h5>
            </center>
          </div>
          <div><hr></div>
          <div class="card-block"> 
            <h6 class="text-muted">Ruangan</h6>
            <h5 class="m-b-15"><?php echo $data_pasien->nmruang; ?></h5> 
            <h6 class="text-muted">Tgl. Masuk</h6>
            <h5 class="m-b-15"><?php echo $data_pasien->tgl_masuk; ?></h5> 
    ...
    <div class="modal-content">
      <form class="form-horizontal" method="POST" id="form_permintaan_diet_edit">
        <div class="modal-header">
            <h4 class="modal-title" id="title-pendidikan">Edit Permintaan</h4>
  ...
  $(document).ready(function() {  
    ...
    $("#form_permintaan_diet").submit(function(event) {
      ...
      $.ajax({
          ...
          dataType: "JSON",
          data: {"no_ipd" : "<?php echo $data_pasien->no_ipd; ?>","bed" : "<?php echo $data_pasien->bed; ?>","standar_diet" : $("#standar_diet").val().toString(),"catatan" : $("#catatan").val(),"bentuk_makanan" : $("#bentuk_makanan").val(),"tgl_permintaan" : $("#tgl_permintaan").val(),"jam_permintaan" : $("#jam_permintaan").val()},
          success: function(result) {   
            document.getElementById("btn-submit").innerHTML = '<i class="fa fa-floppy-o"></i> Simpan';
            if (result.metadata.code == '200') {
              table_history.ajax.reload(); 
              show_permintaan_diet('<?php echo $data_pasien->no_ipd; ?>');
              new swal("Sukses", "Permintaan Diet Berhasil Disimpan.", "success");
              ...
              new swal("Gagal Menyimpan Permintaan", "Silahkan COba Lagi.", "error");            
            }
          },
    ...
    $("#asCheckbox").on("click", function(){
      if($(this).is(":checked")){
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/asuhan/1",
          success: function(result){
            if (result.metadata.code == '200') {
         ...
         $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/asuhan/0",
          success: function(result){
            if (result.metadata.code == '200') {
    ...
    $("#edCheckbox").on("click", function(){
      if($(this).is(":checked")){
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/edukasi/1",
          success: function(result){
            if (result.metadata.code == '200') {
        ...
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/edukasi/0",
          success: function(result){
            if (result.metadata.code == '200') {
    ...
    $("#screnCheckbox").on("click", function(){
      if($(this).is(":checked")){
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/screening/1",
          success: function(result){
            if (result.metadata.code == '200') {
        ...
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/screening/0",
          success: function(result){
            if (result.metadata.code == '200') {
    ...
    $("#monCheckbox").on("click", function(){
      if($(this).is(":checked")){
        $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/monitoring/1",
          success: function(result){
            if (result.metadata.code == '200') {
         ...
         $.ajax({
          type: "POST",
          dataType: "JSON",
          url: "<?php echo base_url().'gizi/insert_ceklis_ahli_gizi/'; ?>"+"<?php echo $data_pasien->no_ipd;?>"+"/monitoring/0",
          success: function(result){
            if (result.metadata.code == '200') {
