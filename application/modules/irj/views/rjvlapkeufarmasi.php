...
function search(){	
	...
	window.open("<?php echo base_url('irj/rjclaporan/lapkeufarmasi')?>/"+startDate+"/"+endDate+"/"+userid,"_self");		
}	
</script>
	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">		
				<h4  class="text-white" align="center">Laporan Keuangan Farmasi</h4>
			</div>
			<div class="card-block">
				<div class="row">
					<div class="form-group">
						<!-- <form action="<?php echo base_url().'irj/rjclaporan/lapkeufarmasi' ?>" method="post"> -->
							<!-- Date range -->
				...
				<div class="row">
			                    ...
			                    <table id="tabel_keuangan" class="table display table-bordered table-striped">
									...
									<tbody>
										<?php 
											...
											$total_biaya = (int)$row2->biaya_obat;
										?>
											<tr>
												<td><?php echo $i++; ?></td>
												...
												<td><?php echo $row2->biaya_obat; ?></td>
						...
						?>
						<!-- <a href="<?php echo site_url('irj/rjclaporan/excel_lapkeufarmasi/'.$param);?>"><input type="button" class="btn 
						" style="background-color: lime;color:white;" value="Excel"></a> -->
						&nbsp;
						<a href="<?php echo site_url('irj/rjclaporan/pdf_lapkeufarmasi/'.$param);?>" target="_blank"><input type="button" class="btn 
