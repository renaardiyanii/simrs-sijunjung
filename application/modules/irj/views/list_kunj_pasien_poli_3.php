			...
			<div class="inline">
				<div class="row">
					<div class="form-inline">
						<form action="<?php echo base_url();?>irj/rjclaporan/lap_poli_irj_gaada_tiga" method="post" accept-charset="utf-8">
						<div class="col-lg-12">
							<div class="form-inline">
								...
								<div class="">
                                    ...
                                    <select id="id_poli" name="id_poli" class="form-control" required  onchange="ajaxdokter(this.value)"> 
		...
		<section class="content">
				<div class="row">
						<div class="card card-outline-info">
							<div class="card-header text-white" align="center" >Laporan Kunjungan Data Pasien Rawat Darurat <br> 
							Per <?php echo $tgl; ?>
							</div>
					...
					<!-- <tr>
						...
						<div class="form-inline" align="right">
							<div class="form-group">
								...
								<?php
								if($tampil_per != "") { ?>
									<a target="_blank" href="<?php echo site_url('irj/Rjclaporan/excel_lap_poli_irj_gaada_tiga');?><?php echo '/'.$tampil_per.'/'.$id_poli.'/'.$tgl;?>"><input type="button" class="btn 
									btn-primary" value="Cetak Laporan Excel"></a>
								<?php
								} else if($tampil_per == "") { ?>
									<a target="_blank" href="<?php echo site_url('irj/Rjclaporan/excel_lap_poli_irj_gaada_tiga_today');?><?php echo '/'.$tgl;?>"><input type="button" class="btn 
									btn-primary" value="Cetak Laporan Excel"></a>
								<?php
								}
								?>
