	...
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			<div class="card-block">
                <?php echo form_open('irj/rjclaporan/list_tindakan');?>
                <p>Tanggal/Bulan kunjungan pasien</p>
                    <div class="row p-t-0">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="id_poli" id="id_poli" class="form-control select2">
        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan Tindakan Rawat Jalan <b><?php echo $date_title; echo $nm_poli;?></b></h4></div>					
                    ...
                    <a href="<?php echo base_url('irj/rjclaporan/excel_list_tindakan/'.$date.'/'.$tampil.'/'.$poli);?>" class="btn btn-danger">Excel</a>				
				</div>
			</div>
		</div>	 	
	</div>	 	
