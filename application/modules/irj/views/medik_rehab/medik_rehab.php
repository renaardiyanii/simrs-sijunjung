...
var surveyJSONMedikRehab = <?php echo file_get_contents(__DIR__ ."/medik_rehab.json");?>;



function sendDataToServerMedikRehab(survey) {
    ...
    var survey_medik_rehab = new Survey.Model(surveyJSONMedikRehab);
    

    <?php if($pengkajian_rehab_medik->num_rows()){ ?>
		survey_medik_rehab.data = <?= $pengkajian_rehab_medik->row()->formjson; ?>
	<?php }else{ ?>
        survey_medik_rehab.data =
...
// survey.css = myCss;
$("#SurveyMedikRehab").Survey({
    model: survey_medik_rehab,
    onComplete: sendDataToServerMedikRehab
});
</script>