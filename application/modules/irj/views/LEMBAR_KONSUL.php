...
<html>
                      ...
                      <td colspan="5">
                        ...
                        <div style="min-height:30px">
                            <p>2. Pengobatan yang telah dilakukan</p>
                                <!-- isian pengobatan -->
                            <p style="margin-left:25px"><?= isset($data->pengobatan)?$data->pengobatan:'' ?></p>
                        </div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox"  style="margin-left:30px" name="" id="" <?php echo isset($data->opsi_konsul)?$data->opsi_konsul == 'konsultasi_sekali'?'checked':'disabled':'disabled'  ?>></td>
                            </tr>
                        </table>
                        ...
                        <p>
                            ...
                            <span style="margin-left:200px">Jam    : <?= isset($data->tanggal_konsul)?date('H:i:s',strtotime($data->tanggal_konsul)):'' ?></span>
                        </p><br>
                        ...
                        <?php $ttd_kirim = $this->rjmpelayanan->get_ttd_dokter($data->id_dokter_asal)->row(); ?>

                        <img src="<?php echo isset($ttd_kirim->ttd)?$ttd_kirim->ttd:''; ?>" alt="" style="float: right;width: 150px;height: 80px;">
    ...
    <div class="A4 sheet  padding-fix-10mm">
            ...
            <div style="font-size:12px">
                ...
                <div style="min-height:60px">
                    <p>2. Kesan</p>
                    <p><?= isset($data->kesan_jawaban)?$data->kesan_jawaban:'' ?></p>
                </div>

                <div style="min-height:60px">
                    <p>3. Anjuran</p>
                    <p><?= isset($data->anjuran_jawaban)?$data->anjuran_jawaban:'' ?></p>
                </div>
                ...
                <p>
                    <span>Tanggal       :<?= isset($data->tanggal_konsul)?' '.date('d-m-Y',strtotime($data->tanggal_konsul)):'' ?></span>
                    <span style="margin-left:200px">Jam    : <?= isset($data->tgl_jawaban_konsul)?' '.date('H:i:s',strtotime($data->tgl_jawaban_konsul)):'' ?></span>
                </p><br>
                ...
                <?php $ttd_tarima = $this->rjmpelayanan->get_ttd_dokter($data->id_dokter_akhir)->row(); ?>

                <img src="<?php echo isset($ttd_tarima->ttd)?$ttd_tarima->ttd:''; ?>" alt="" style="float: right;width: 200px;height: 100px;">
