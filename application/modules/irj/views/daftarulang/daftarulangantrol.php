    ...
    <div class="card-block p-b-0">
        ...
        <div class="tab-content">
			...
			<div id="daftar_ulang" class="tab-pane active" role="tabpanel">
                <?php echo form_open('irj/rjcregistrasi/insert_daftar_ulang_new_antrol', array('class' => 'form-horizontal')); ?>
                    <div class="col-lg-10" style="margin: 0 auto;">
                        <br>
                        <br>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-inline control-label pull-left">
                                    <!-- added untuk antrol -->
                                    <input type="hidden" class="form-control" value="<?php echo $antrol;?>" name="antrol" id="antrol">
                                    <input type="hidden" class="form-control" name="nik" id="nik">
                                    <input type="hidden" class="form-control" name="norm" id="norm">
