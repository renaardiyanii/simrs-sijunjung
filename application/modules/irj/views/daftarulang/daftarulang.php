                ...
                <?php echo form_open('irj/rjcregistrasi/insert_daftar_ulang_new', array('class' => 'form-horizontal')); ?>
                    <div class="col-lg-10" style="margin: 0 auto;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control"  value= "<?= $data_pasien->no_cm ?>" readonly>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-success" type="button" onclick="getsuratkontrolfromvclaim($('#no_kartu_bpjs').val())"><i class="fa fa-eye"></i> Lihat Surat Kontrol</button>
                                        </span>
                                    </div>
                                </div>
