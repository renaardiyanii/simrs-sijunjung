                ...
                <div class="col-lg-10" style="margin: 0 auto;">
                    ...
                    <form method="POST"  id="form_biodata" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="hidden" class="form-control" value="<?php echo $no_medrec;?>" name="no_medrec" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control"  id="no_hpval" name="no_hp">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <?php echo form_open('irj/rjcregistrasi/insert_daftar_ulang_new', array('class' => 'form-horizontal')); ?>
                    <div class="col-lg-10" style="margin: 0 auto;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-inline control-label pull-left">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $noreg_asal_konsul;?>"  name="noreg_asal_konsul">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="cm_baru" id="cm_baru">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-sm-3 control-label col-form-label">Tgl. Kunjungann</label>
                            <div class="col-sm-8">
                            ...
                            <div class="col-sm-8">
                                <div class="form-inline">
                                    <select id="cara_bayar" class="custom-select form-control select2" style="width: 100%" name="cara_bayar" onchange="pilih_cara_bayar_kontraktor(this.value)" required>
                                        ...
                                        <option value="BPJS">JKN-KIS (BPJS)</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select id="cara_datang" class="custom-select form-control select2" style="width: 100%" name="cara_dtg" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select id="cara_kunj" class="custom-select form-control select2" style="width: 100%" name="cara_kunj" required onchange="handleCaraKunj(this.value)">
                        ...
                        <div class="form-group row div_bpjs">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn waves-effect waves-light btn-danger" id="btn-rujukan-kartu-new"><i class="fa fa-eye"></i> Data Rujukan</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="div_rujukan" class="div_bpjs_thp">
                            ...
                            <div class="form-group row div_bpjs">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="radio" id="tujuan_kunj_konsul" name="tujuan_kunj" value="2" checked>
                            ...
                            <div class="form-group row div_bpjs">
                                ...
                                <div class="col-sm-8">
                                    <input type="radio" id="prosedur_tidak_berkelanjutan" name="flag_procedure" value="0" disabled>
                                    <label for="prosedur_tidak_berkelanjutan">Prosedur Tidak Berkelanjutan</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" id="prosedur_berkelanjutan" name="flag_procedure" value="1" disabled>
                            ...
                            <div class="form-group row div_bpjs">
                                ...
                                <div class="col-sm-8">
                                    <select id="kode_penunjang" class="custom-select form-control" style="width: 100%" name="kd_penunjang" disabled>
                            ...
                            <div class="form-group row div_bpjs">
                                ...
                                <div class="col-sm-8">
                                    <select id="assesment_pel" class="custom-select form-control" style="width: 100%" name="assesment_pel">
                                        ...
                                        <option value="5" selected>Tujuan Kontrol</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="nosurat_skdp_sep" id="no_surat_kontrol_skdp" value="<?= $suratkontrol->noSuratKontrol ?>">
                                        <span class="input-group-btn">
                                    ...
                                    <div class="input-group">
                                        <div class="form-inline" style="width:100%;">
                                            <select id="dpjp_suratkontrol" class="form-control select2" style="width: 100%" name="dpjp_suratkontrol" >
                                                ...
                                                <option value="<?= $suratkontrol->kodeDokter ?>" selected><?= $suratkontrol->namaDokter ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-8">
                            <div class="form-inline">
                                    <select id="dokter_bpjs" class="form-control select2" style="width: 100%" name="dokter_bpjs" >
                                        <option value="">-- Pilih Dokter --</option>
                                        <option value="<?= $suratkontrol->kodeDokter.'-'.$suratkontrol->namaDokter ?>" selected><?= $suratkontrol->namaDokter ?></option>
                                    </select>
                            </div>
                        </div>
                    </div>
