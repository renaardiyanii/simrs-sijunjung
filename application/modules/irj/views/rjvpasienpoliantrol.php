    			...
    			<div class="card card-block">
					...
					<a class="btn btn-primary float-end p-b-4" 
						...
						<ul class="nav nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" data-toggle="tab" href="#sudah_checkin">Sudah Berada di RS</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#belum_checkin">Belum Berada di RS</a>
											</li>
										</ul>
										...
										<div class="tab-content">
											<!-- Tab Sudah Checkin -->
											<div id="sudah_checkin" class="tab-pane active">
												<div class="table-responsive m-t-0">
													<table id="example1" class="display nowrap table table-hover table-bordered table-striped">
													<thead>
														<tr>
														...
														<tbody>
															<?php foreach ($pasien_sudah_checkin as $row) {
																$id = $row->id;		
																
																?>
																<!-- Baris tabel sama seperti sebelumnya -->
																<tr class="<?php
											...
											<!-- Tab Belum Checkin -->
											<div id="belum_checkin" class="tab-pane">
												<div class="table-responsive m-t-0">
													<table id="example2" class="display nowrap table table-hover table-bordered table-striped">
														<thead>
															<tr>
																<th class="text-center">Aksi</th>
																<th>No Antrian</th>
														...
														<tbody>
															<?php foreach ($pasien_belum_checkin as $row) {
																$id = $row->id;
