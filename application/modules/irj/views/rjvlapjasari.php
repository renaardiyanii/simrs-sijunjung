		...
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">	
				<?php if($carabayar == 'SEMUA'){ ?>
					<h4  class="text-white" align="center">Laporan Jasa Rawat Inap BPJS dan UMUM</h4>
				<?php }else if($carabayar != 'SEMUA' && $carabayar !=''){ ?>
					<h4  class="text-white" align="center">Laporan Jasa Rawat Inap <?= $carabayar ?></h4>
				<?php }else{ ?>
					<h4  class="text-white" align="center">Laporan Jasa Rawat Inap</h4>
				<?php } ?>	
			...
			<div class="row">
    			<form action="<?php echo base_url();?>irj/rjclaporan/lapkeu_jasa_iri" method="post" accept-charset="utf-8">
				...
				<a href="<?php echo site_url('irj/rjclaporan/excel_lap_jasa_iri/'.$tgl.'/'.$tgl1.'/'.$carabayar);?>"><input type="button" class="btn 
