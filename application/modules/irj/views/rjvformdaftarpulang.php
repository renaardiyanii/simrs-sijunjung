		...
		<div class="row">			
			...
			<div class="card card-outline-info">
					<div class="card-header">
						<center><h4 class="text-white"> Daftar Pasien IRJ Tanggal <b><?php echo date('d-m-Y', strtotime("-4 days")) ?></b> s/d <b><?php echo  date('d-m-Y') ?></b></h4></div>
							...
							<thead>
							  ...
							  <tbody><?php //if($search_per=='nama' || $search_per=='alamat') { ?>
								...
								?>
									<tr>
										<td>
											<a href="<?php echo site_url("irj/rjcpelayanan/pelayanan_tindakan/".$row->id_poli."/".$no_register);?>" class="btn btn-danger btn-xs" target='_blank'>Tindak (Perawat)</a>
											<a href="<?php echo site_url("irj/rjcpelayananfdokter/pelayanan_tindakan/".$row->id_poli."/".$no_register);?>" class="btn btn-success btn-xs" target='_blank'>Tindak (Dokter)</a>
											...
											<!-- <a href="<?php echo site_url("irj/Rjcsjp/cetak_sjp/".$no_register);?>" target="_blank" class="btn btn-success btn-xs">Tracer</a> -->
										</td>
										<td><?php echo $i++ ; ?></td>
