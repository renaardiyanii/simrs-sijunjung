...
<div class="card card-outline-info">
    ...
    <div class="card-block p-b-15">	
		...
		<form method="POST" id="form_daful" class="form-horizontal">
						<br>
						<br>
						<?php
								foreach($detail_pasien as $row){
						...
						<div class="col-lg-10" style="margin: 0 auto;">																		
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="date" class="form-control" placeholder="" id="tgl_rujukan" name="tgl_rujukan" value="<?php if($row->tgl_rujukan!=''){echo date("Y-m-d", strtotime($row->tgl_rujukan));} ?>" required>
								</div>
							</div>					
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<div class="form-inline">
											<select id="operatorTindakan" class="form-control select2" style="width: 100%" name="id_dokter" required>
                    ...
                    <div class="col-md-12">
                         <div class="row">
                             <div class="col-md-12 text-center">
								...
								<button type="submit" class="btn waves-effect waves-light btn-primary" id="btn-daful-submit">Simpan</button>
...
<script>
		$(document).on("submit","#form_daful",function(e){
			e.preventDefault();
			document.getElementById("btn-daful-submit").innerHTML = '<i class="fa fa-spinner fa-spin" ></i> Menyimpan...';
			$.ajax({  
				url:"<?php echo base_url(); ?>irj/rjcregistrasi/insert_pasien_bpjs/",                         
				method:"POST",  
				...
				{ 
					document.getElementById("form_daful").reset();
					swal({
									title: "Selesai",
				...
				error:function(event, textStatus, errorThrown) {
					...
					document.getElementById("btn-daful-submit").innerHTML = 'Simpan';
