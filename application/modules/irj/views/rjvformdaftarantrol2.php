...
<div class="card card-outline-info">
    ...
    <!-- <?php echo form_open_multipart('irj/rjcregistrasi/insert_data_pasien_antrol_v2/'.$id.'/'.$loket);?>	 -->
    				<form method="POST" onsubmit="return validate(this)" action="<?php echo base_url('irj/rjcregistrasi/insert_data_pasien_antrol_v2/'.$id.'/'.$loket)?>">
						...
						<div class="col-lg-10" style="margin: 0 auto;">	
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" name="no_hp" onkeypress="return inputNumbersOnly(event)" maxlength="13" required >
								</div>
							</div>
