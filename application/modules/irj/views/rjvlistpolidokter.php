...
$(function(){
	...
	<div class="row">
	<?php echo form_open('irj/rjcpelayananfdokter/pasien_poli');?>
		<div class="col-lg-12">
			<div class="input-group">
				<select name="poli" id="poli" class="form-control">
					<option value="">Pilih Poli</option>
					<?php foreach($poli as $item){ ?>
						<option value="<?php echo $item->id_poli?>"><?php echo $item->nm_poli ?></option>
					<?php } ?>					
				</select>				
		...
		<div class="card-block">
			...
			<?php 
					...
					?>
						<tr>
							<td>
								<a href="<?php echo site_url('irj/rjcpelayananfdokter/kunj_pasien_poli/'.$row->id_poli)?>">
									<?php
