	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">		
					...
					<h4  class="text-white" align="center">Laporan Per Item Obat</h4>

			</div>
			<div class="card-block">
				<div class="row">
					<form action="<?php echo base_url();?>irj/rjclaporan/lap_per_item_obat" method="post" accept-charset="utf-8">
						<div class="form-group row">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<select name="id_obat" id="id_obat" class="form-control">
										<option value= "SEMUA">-- Pilih Obat --</option>
										<?php 
										foreach($data_obat as $obat){ ?>
											<option value="<?php echo $obat->id_obat ?>"><?php echo $obat->nm_obat ?></option>
										<?php }
										?>
									</select>
								</div>
							...
							<!-- <div class="col-md-2">
								<a href="<?php echo site_url('irj/rjclaporan/excel_lap_jasa_irj_tind_detail/'.$tgl.'/'.$tgl1.'/'.$id_obat);?>"><input type="button" class="btn 
				...
				<div style="overflow:auto;">
						...
						<p style="font-weight:bold">Total Obat = <?= $total ?></p>
				</div>
