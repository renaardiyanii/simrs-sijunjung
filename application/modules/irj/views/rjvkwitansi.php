					...
					<div class="col-md-5">
						...
						<div class="form-group row">
							<div style="width: 80%;margin-left: 15px;">											
								<input type="date" id="date_picker" class="form-control" placeholder="Tanggal Kunjungan" name="tgl">
							</div>
					...
					<table id="tabel_kwitansi" class="display table table-hover table-bordered table-striped" cellspacing="0" width="100%">
						...
						?>
							<tr  class="bebas">
								<td>
									<?php if($url=='') {?>
									<a href="<?php echo site_url('irj/rjckwitansi/kwitansi_pasien_all/'.$no_register); ?>" class="btn btn-default btn-sm"><i class="fa fa-book"></i></a>
									<?php } else {?>
