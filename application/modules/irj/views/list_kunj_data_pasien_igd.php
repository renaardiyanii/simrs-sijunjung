			...
			<div class="inline">
				<div class="row">
					<div class="form-inline">
						<form action="<?php echo base_url();?>irj/rjclaporan/lap_kunj_data_pasien_igd" method="post" accept-charset="utf-8">
						<div class="col-lg-12">
							<div class="form-inline">
					...
					<!-- <tr>
						...
						<div class="form-inline" align="right">
							<div class="form-group">
								...
								<?php
								if($tampil_per != "") { ?>
									<a target="_blank" href="<?php echo site_url('irj/Rjclaporan/excel_lap_kunj_data_pasien_igd');?><?php echo '/'.$tampil_per.'/'.$tgl;?>"><input type="button" class="btn 
									btn-primary" value="Cetak Laporan Excel"></a>
								<?php
								} else if($tampil_per == "") { ?>
									<a target="_blank" href="<?php echo site_url('irj/Rjclaporan/excel_lap_kunj_data_pasien_igd_today');?><?php echo '/'.$tgl;?>"><input type="button" class="btn 
									btn-primary" value="Cetak Laporan Excel"></a>
								<?php
								}
								?>
