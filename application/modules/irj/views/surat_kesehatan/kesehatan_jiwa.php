...
<link rel="stylesheet" href="<?= base_url('assets/css/paper.css') ?>">
    ...
    <div class="A4 sheet  padding-fix-10mm"><br>
        ...
        <center>
            <u><span style="font-size:17px;font-weight:bold;">SURAT KETERANGAN KESEHATAN JIWA</span></u><br>
        ...
        <div style="font-size:12px;margin:25px">
            ...
            <table width="100%" style="margin:30px">
                ...
                <tr>
                    <td width="18%"><p>Alamat</p></td>
                    <td width="2%"><p>:</p></td>
                    <td width="80%"><p><?= isset($data_permintaan->alamat)?$data_permintaan->alamat:'' ?></p></td>
                </tr>

                <tr>
                    <td width="18%">Pemeriksaan</td>
                    <td width="2%">:</td>
                    <td width="80%"><?= isset($data_suket_kesehatan->pemeriksaan_jiwa)?$data_suket_kesehatan->pemeriksaan_jiwa:'' ?></td>
                </tr>

                <tr>
                    <td width="18%"><p>Tanggal</p></td>
                    <td width="2%"><p>:</p></td>
                    <td width="80%"><p><?= isset($data_suket_kesehatan->tgl_hasil_jiwa)?date('d-m-Y',strtotime($data_suket_kesehatan->tgl_hasil_jiwa)):'' ?></p></td>
                </tr>

                <tr>
                    <td width="18%">Hasil</td>
                    <td width="2%">:</td>
                    <td width="80%"><?= isset($data_suket_kesehatan->hasil_pem_jiwa)?$data_suket_kesehatan->hasil_pem_jiwa:'' ?>
                        <!-- <span>
                        <b>Sehat Rohani / Sehat Jiwa, sesuai dengan Undang-Undang Kesehatan Jiwa Nomor 18 Tahun 2014.</b> 
                        (individu menyadari kemampuan sendiri, dapat mengatasi tekanan, 
                        dapat bekerja secara produktif dan mampu memberikan kontribusi untuk komunitasnya).
                        </span><br><br>
                        <span><b>
                        Pada saat ini tidak ditemukan adanya gejala dan tanda gangguan jiwa yang bermakna, 
                        yang mengganggu aktifitas dan fungsi sehari-hari.
                        </b></span> -->
                    </td>
                </tr>
            </table><br>
            ...
            <p>Surat keterangan ini berlaku 1 (satu) bulan semenjak diterbitkan, 
            dan tidak dapat digunakan untuk kepentingan hukum lainnya.</p>
            <p>Surat keterangan dipergunakan untuk : <?= isset($data_suket_kesehatan->surat_untuk)?$data_suket_kesehatan->surat_untuk:'' ?></p>
            </div>
        </div>
