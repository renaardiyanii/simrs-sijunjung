...
<form method="POST" id="insert_form_medik_perawat" class="form-horizontal"> 
    <div class="form-group row">
        ...
        <div class="col">
            ...
            <!-- added this for fisioterapi -->
            <div class="col">
                <div class="row">
                    <div class="col form-group">
                        <label for="tangan_kiri">Tangan Kiri</label>
                        <input type="text" class="form-control" id="tangan_kiri" name="tangan_kiri">
                     </div>
                     <div class="col form-group">
                        <label for="tangan_kanan">Tangan Kanan</label>
                        <input type="text" class="form-control" id="tangan_kanan" name="tangan_kanan">
                     </div>
                </div>
                <div class="row">
                    <div class="col form-group">
                        <label for="kaki_kiri">Kaki Kiri</label>
                        <input type="text" class="form-control" id="kaki_kiri" name="kaki_kiri">
                     </div>
                     <div class="col form-group">
                        <label for="kaki_kanan">Kaki Kanan</label>
                        <input type="text" class="form-control" id="kaki_kanan" name="kaki_kanan">
                     </div>
                </div>
            </div>
            <!-- end added -->
    ...
    <input type="hidden" name="id_pemeriksa" class="form-control" value="<?= $this->load->get_var("user_info")->userid;?>">
