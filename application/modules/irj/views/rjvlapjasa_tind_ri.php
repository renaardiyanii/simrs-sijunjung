	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">		
					...
					<h4  class="text-white" align="center">Laporan Jasa Tindakan Rawat Inap</h4>

			</div>
			<div class="card-block">
				<div class="row">
					<form action="<?php echo base_url();?>irj/rjclaporan/lapkeu_jasa_tind_ranap" method="post" accept-charset="utf-8">
						<div class="form-group row">
								...
								<div class="form-group">
									<select name="id_ruang" id="id_ruang" class="form-control">
										...
										foreach($ruangan as $ruang){ ?>
											<option value="<?php echo $ruang->kelompok ?>"><?php echo $ruang->kelompok ?></option>
										<?php }
										?>
									</select>
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-2">
									<a href="<?php echo site_url('irj/rjclaporan/excel_lap_jasa_iri_tind_detail/'.$tgl.'/'.$tgl1.'/'.$id_dokter.'/'.$cara_bayar.'/'.$id_ruang);?>"><input type="button" class="btn 
