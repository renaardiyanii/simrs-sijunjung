		...
		<section class="content">
				<div class="row">
						<div class="card card-outline-info">
							<div class="card-header text-white" align="center" >Data Kunjungan Pasien Kontrol 
							</div>
				...
				<?php
					...
					<tr>
						...
						<td><?php echo date("d-m-Y", strtotime($r->tgl_input));?></td>
						<td><?php echo $r->nm_poli;?></td>					
						<td>
							<a target="_blank" href="<?php echo site_url('emedrec/C_emedrec/lembar_kontrol_pasien/'.$r->no_register.'/'.$r->no_cm.'/'.$r->no_medrec);?>"><input type="button" class="btn 
							btn-primary" value="Cetak Lembar Kontrol"></a>
							<a target="_blank" href="<?php echo site_url('irj/rjcregistrasi/daftarulangnew/'.$r->no_medrec);?>"><input type="button" class="btn 
