...
<script type='text/javascript'>
	...
	function search(){	
		...
		window.open("<?php echo base_url('irj/rjclaporan/lapkeuperkasir')?>/"+startDate+"/"+endDate+"/"+userid,"_self");		
	}	
</script>
	...
	<div class="row">
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			<div class="card-header">		
				<h4  class="text-white" align="center">Laporan Keuangan Per-Kasir</h4>
			</div>
			<div class="card-block">
				<div class="row">
					<div class="form-group">
						<!-- <form action="<?php echo base_url().'irj/rjclaporan/lapkeuperkasir' ?>" method="post"> -->
							<!-- Date range -->
							...
							<div class="input-group">
									<div class="input-group-addon">
										...
										<input type="text" class="form-control" id="tanggal_laporan" name="tanggal_laporan" autocomplete="off">&nbsp;
				...
				<div class="row">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><?php echo $row2->biaya_tindakan; ?></td>
												<td><?php echo $row2->biaya_adm; ?></td>
												<td><?php echo $row2->biaya_kartu; ?></td>
						...
						?>
						<!-- <a href="<?php echo site_url('irj/rjclaporan/excel_lapkeuperkasir/'.$param);?>"><input type="button" class="btn 
						" style="background-color: lime;color:white;" value="Excel"></a> -->
						&nbsp;
						<a href="<?php echo site_url('irj/rjclaporan/pdf_lapkeuperkasir/'.$param);?>" target="_blank"><input type="button" class="btn 
