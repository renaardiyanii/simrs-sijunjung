...
<script type='text/javascript'>
	...
	function search(){	
		...
		window.open("<?php echo base_url('irj/rjclaporan/lapkeukerjasamari')?>/"+startDate+"/"+endDate+"/"+id_kontraktor,"_self");		
	}	
</script>
		...
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			...
			<div class="card-block">
				...
				<div class="row">
			                    ...
			                    <table id="tabel_keuangan" class="nowrap table display table-bordered table-striped">
									...
									<tbody>
										...
										?>
											<tr>
												<td><?php echo $i++; ?></td>
												<td><?php echo $row2->nm_ruang; ?></td>
												<td><?php echo $row2->no_kwitansi; ?></td>
												<td><?php echo $row2->no_ipd; ?></td>
						...
						?>
						<!-- <a href="<?php echo site_url('irj/rjclaporan/excel_lapkeukerjasamari/'.$param);?>"><input type="button" class="btn 
						" style="background-color: lime;color:white;" value="Excel"></a> -->
						&nbsp;
						<a href="<?php echo site_url('irj/rjclaporan/pdf_lapkeukerjasamari/'.$param);?>" target="_blank"><input type="button" class="btn 
