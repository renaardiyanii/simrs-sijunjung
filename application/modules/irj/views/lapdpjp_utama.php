        ...
        <div class="card">
            <div class="card-block">
				<div class="card-title" align="center" >
					<h4 align="center">Laporan DPJP Utama Rawat Jalan</h4></div>					
                                ...
                                <table id="example" class="display nowrap table table-hover table-bordered table-striped" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nama DPJP</th>
                                            <th>IGD</th>
                                            <th>Kebidanan/Kandungan</th>
                                            <th>UMUM</th>
                                            <th>UMUM 24 Jam</th>
                                            <th>Penyakit Dalam(INTERNE)</th>
                                            <th>Saraf(NEUROLOGI)</th>
                                            <th>Anak</th>
                                            <th>MCU</th>
                                            <th>Paru</th>
                                            <th>Fungsi Luhur</th>
                                            ...
                                            <th>Neuropsikiatri</th>
                                            <th>THT</th>
                                            <th>Akupuntur</th>
                                            <th>Fisioterapi</th>
                                            <th>Ortetik Prostetik</th>
                                            <th>Okupasi Terapi</th>
                                            <th>Neurointervensi</th>
                                            <th>Mata</th>
...
function down_excel(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>irj/rjclaporan/excel_lap_dpjp_utama_tgl/"+date+"/"+ppa;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>irj/rjclaporan/excel_lap_dpjp_utama/"+month+"/"+ppa;
    }
...
function get_bln(){
    ...
    if(tampil === 'TGL') {
        var url = "<?php echo base_url();?>irj/rjclaporan/lap_dpjp_exe_tgl/"+date+"/"+ppa;
    } else if(tampil === 'BLN') {
        var url = "<?php echo base_url();?>irj/rjclaporan/lap_dpjp_exe/"+month+"/"+ppa;
    }
