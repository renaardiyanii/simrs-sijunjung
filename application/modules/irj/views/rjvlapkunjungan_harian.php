			...
			<table class="table table-hover table-striped table-bordered" border="1" style="padding:2px">
				<thead>
					<tr>
						...
						<th width="5%"><b>Selisih Daftar Ulang Penyerahan Obat</b></th>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php 
							if($row2->cara_bayar == 'BPJS') {
								if($row2->ket_pulang == 'BATAL_PELAYANAN_POLI' || $row2->ket_pulang == 'DIRUJUK_RAWATINAP') {
									echo '-';
								} else {
									if($row2->no_sep == NULL) {
						...
						//}else if($row2->cara_bayar=='KERJASAMA'){
							//echo $row2->kontraktor;
						//}else 
						echo $row2->cara_bayar;?></td>
						<td><?php echo $row2->kontraktor; ?></td>
						...
						<td><?php echo $row2->xdaftar ?></td>
						<td><?php echo $row2->nm_dokter ?></td>
						<td><?php
							$date = new DateTime($row2->tgl_kunjungan, new DateTimeZone('UTC'));
						...
						?></td>
						<td><?php echo isset($row2->wkt_penyerahan_obat)?date('H:i:s',strtotime($row2->wkt_penyerahan_obat)):'' ?></td>

						<td><?php
								if($row2->tgl_kunjungan != null && $row2->wkt_penyerahan_obat != null){
									$waktu_daftar_ulang = date_create($row2->tgl_kunjungan);
									$waktu_penyerahan_obat = date_create($row2->wkt_penyerahan_obat);
					...
					?>
					<tr>
						<td colspan="8"><p align="right"><b>Total</b></p></td>
		...
		<table class="table table-hover table-striped table-bordered" border="1" style="padding:2px">
			<thead>
				<tr>
					...
					<th width="5%"><b>Waktu Tindak Dokter</b></th>
					<th width="5%"><b>Waktu Penyerahan Obat</b></th>
					<th width="5%"><b>Selisih daftarulang Penyerahan Obat</b></th>
					<th width="5%"><b>Selisih Perawat Dokter</b></th>
					<th width="5%"><b>Selisih DaftarUlang Dokter</b></th>
					<th width="5%"><b>No Register</b></th>
					<th width="5%"><b>Keterangan</b></th>
