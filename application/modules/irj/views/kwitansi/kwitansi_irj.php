			    ...
			    <table border="1" style="padding:2px" width="100%" >
                   ...
                   // $jumlah_vtot =  $vtottind;
			        $jumlah_vtot_1 =  $jumlah_vtot - $diskon; ?>
						...
						//if($cash != 0 && $noncash != 0){ ?>
						<tr>
							<th colspan="4"><p align="right" style="font-size:11px"><b>Tunai   </b></p></th>
							<th><p align="right" style="font-size:11px"><?= number_format( $cash, 2 , ',' , '.' )?></p></th>
						</tr>

						<tr>
							<th colspan="4"><p align="right" style="font-size:11px"><b>Non-Tunai   </b></p></th>
							<th><p align="right" style="font-size:11px"><?= number_format( $noncash, 2 , ',' , '.' )?></p></th>
						</tr>
						<?php // }
						?> -->
						<tr>
