					...
					<div class="col-md-8">
						<?php echo form_open('irj/rjclaporan/kunj_pasien');?>
							<div class="form-group ">
								<input type="text" id="date_picker1" class="form-control" placeholder="Tanggal Awal" name="date0" autocomplete="off">
								<input type="text" id="date_picker2" class="form-control" placeholder="Tanggal Akhir" name="date1" autocomplete="off">
