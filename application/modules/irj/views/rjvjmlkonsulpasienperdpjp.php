...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="card card-outline-info">
			...
			<?php echo form_open('irj/Rjclaporan/lap_jml_konsultasi_dpjp');?>
								...
								<table class="table table-hover table-striped table-bordered data-table" id="dataTables-example">
									...
									<!-- 				<tr>
													...
													<tr>
														...
														<td><?php echo $r['tanggal_konsul'];?></td>
                                                        <td><?php echo $r['opsi'];?></td>
							...
							<div class="form-inline" align="right">
								<div class="form-group">
									...
									if(($tampil_per == 'TGL') || ($tampil_per == 'BLN') || ($tampil_per == 'THN')) { ?>
										<a href="<?php echo site_url('irj/rjclaporan/excel_lapjml_konsul_dpjp');?><?php echo '/'.$tampil_per.'/'.$id_poli.'/'.$tgl.'/'.$id_dokter;?>"><input type="button" class="btn 
										" style="background-color: lime;color:white;" value="EXCEL"></a>
										&nbsp;
									<?php
									} else if($tampil_per == 'TRIWULAN') { ?>
										<a href="<?php echo site_url('irj/rjclaporan/excel_lapjml_konsul_dpjp_triwulan');?><?php echo '/'.$tampil_per.'/'.$id_poli.'/'.$tgl.'/'.$bulan_akhir.'/'.$id_dokter;?>"><input type="button" class="btn 
										" style="background-color: lime;color:white;" value="EXCEL"></a>
										&nbsp;
									<?php
									} else if($tampil_per == "") { ?>
										<a href="<?php echo site_url('irj/rjclaporan/excel_lapjml_konsul_dpjp_today');?><?php echo '/'.$tgl;?>"><input type="button" class="btn 
										" style="background-color: lime;color:white;" value="EXCEL"></a>
										&nbsp;
									<?php
									}
