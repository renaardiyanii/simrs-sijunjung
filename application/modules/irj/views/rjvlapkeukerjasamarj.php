		...
		<div class="card card-outline-info" style="width:97%;margin:0 auto">
			...
			<div class="card-block">
				...
				<div class="row">
						...
						?>
						<!-- <a href="<?php echo site_url('irj/rjclaporan/excel_lapkeukerjasamarj/'.$param);?>"><input type="button" class="btn 
						" style="background-color: lime;color:white;" value="Excel"></a> -->
						&nbsp;
						<a href="<?php echo site_url('irj/rjclaporan/pdf_lapkeukerjasamarj/'.$param);?>" target="_blank"><input type="button" class="btn 
