...
// var_dump($pengobatan->pengobatan);die();
?>
<style>
...
function sendDataToServerPengantarRawatInap(survey) {
        ...
        $.ajax({
            type: "POST",
            url: '<?= base_url('irj/rjcpelayananfdokter/pengantar_ranap/') ?>',
            data: {
	...
	<?php  }else{ ?>
        survey_pengantar_ranap.data = {
            ...
            "terapi": <?= json_encode(isset($pengobatan->pengobatan) ? $pengobatan->pengobatan : '') ?>
