...
<div >
	...
	<!-- 				<tr>
					...
					<tr>
						...
						<td><?php echo date("d-m-Y", strtotime($r->tanggal_konsul));?></td>
						...
						<td>
							<button type="button" title="Edit" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal" onclick="edit('<?php echo $r->id;?>')"><i class="fa fa-edit"></i></button>
                        </td>							
					</tr>
				<?php
						}
